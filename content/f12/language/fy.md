---
title: "fy-Western Frisian (Frysk) - translation progress for f12"
...
Language progress for Western Frisian (fy) in Fedora f12 is:

* 42.12% when we only look on started packages for this language.
* 0.39% when we compare to every single translatable string in Fedora f12.

Possible scripts are: Latn

* Total translatable string in Fedora f12: 6312652
* Source words to translate in started packages: 58591
* Translated words: 24677
...
* [fy generated stats (1.1 kB)]({{% resource url="/f12/fy.csv" %}})
