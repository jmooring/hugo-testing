---
title: "ht-Haitian Creole (Kreyòl ayisyen) - translation progress for f12"
...
Language progress for Haitian Creole (ht) in Fedora f12 is:

* 44.37% when we only look on started packages for this language.
* 0.30% when we compare to every single translatable string in Fedora f12.

Possible scripts are: Latn

* Total translatable string in Fedora f12: 6312652
* Source words to translate in started packages: 42951
* Translated words: 19058
...
* [ht generated stats (2.0 kB)]({{% resource url="/f12/ht.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [etoys]({{< ref "/f12/package/etoys.md" >}}) | 18049 | 27689 | 65.2 | LANGUAGE <LL@li.org> | 
 | [sugar]({{< ref "/f12/package/sugar.md" >}}) | 182 | 319 | 57.1 | LANGUAGE <LL@li.org> | 
 | [pootle]({{< ref "/f12/package/pootle.md" >}}) | 206 | 2123 | 9.7 | LANGUAGE <LL@li.org> | 
 | [homebank]({{< ref "/f12/package/homebank.md" >}}) | 103 | 1507 | 6.8 | Haitian; Haitian Creole <ht@li.org> | 
 | [sugar-calculator]({{< ref "/f12/package/sugar-calculator.md" >}}) | 15 | 564 | 2.7 | LANGUAGE <LL@li.org> | 
