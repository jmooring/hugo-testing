---
title: "qu-Quechua (Runasimi) - translation progress for f12"
...
Language progress for Quechua (qu) in Fedora f12 is:

* 0.09% when we only look on started packages for this language.
* 0.00% when we compare to every single translatable string in Fedora f12.

Possible scripts are: Latn

* Total translatable string in Fedora f12: 6312652
* Source words to translate in started packages: 2297
* Translated words: 2
...
* [qu generated stats (1.6 kB)]({{% resource url="/f12/qu.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [sugar]({{< ref "/f12/package/sugar.md" >}}) | 0 | 234 | 0.0 | LANGUAGE <LL@li.org> | 
...
|---------|--------------------------|-------------|------|
 | [sugar-calculator]({{< ref "/f12/package/sugar-calculator.md" >}}) | /mnt/stockage/packages/f12/sugar-calculator/po/qu.po | error-os |  | 
{.sortable}
