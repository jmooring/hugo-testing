---
title: "tt-Tatar (Татар) - translation progress for f12"
...
Language progress for Tatar (tt) in Fedora f12 is:

* 15.33% when we only look on started packages for this language.
* 0.15% when we compare to every single translatable string in Fedora f12.

Possible scripts are: CyrlLatn

* Total translatable string in Fedora f12: 6312652
* Source words to translate in started packages: 61481
* Translated words: 9422
...
* [tt generated stats (1.4 kB)]({{% resource url="/f12/tt.csv" %}})
