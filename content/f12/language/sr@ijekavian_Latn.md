---
title: "sr@ijekavian_Latn-Serbian (Српски) - translation progress for f12"
...
territories:
 ...
 - XK
polib_error_count: 0
could_not_process_count: 540
---

Language progress for Serbian (sr@ijekavian_Latn) in Fedora f12 is:

* 99.97% when we only look on started packages for this language.
* 4.22% when we compare to every single translatable string in Fedora f12.

Possible scripts are: CyrlLatn

* Total translatable string in Fedora f12: 6312652
* Source words to translate in started packages: 266188
* Translated words: 266099
...
* [sr@ijekavian_Latn generated stats (767 Bytes)]({{% resource url="/f12/sr@ijekavian_Latn.csv" %}})
