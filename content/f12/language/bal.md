---
title: "bal-Baluchi (بلۆچی) - translation progress for f12"
...
Language progress for Baluchi (bal) in Fedora f12 is:

* 5.46% when we only look on started packages for this language.
...
* Source words to translate in started packages: 16396
* Translated words: 895
...
* [bal generated stats (1.1 kB)]({{% resource url="/f12/bal.csv" %}})
