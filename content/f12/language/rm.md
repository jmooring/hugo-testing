---
title: "rm-Romansh (Rumantsch) - translation progress for f12"
...
Language progress for Romansh (rm) in Fedora f12 is:
...
* [rm generated stats (512 Bytes)]({{% resource url="/f12/rm.csv" %}})
