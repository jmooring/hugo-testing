---
title: "ff-Fula (Pulaar) - translation progress for f12"
...
Language progress for Fula (ff) in Fedora f12 is:

* 61.22% when we only look on started packages for this language.
* 0.06% when we compare to every single translatable string in Fedora f12.

Possible scripts are: LatnAdlm

* Total translatable string in Fedora f12: 6312652
* Source words to translate in started packages: 5715
* Translated words: 3499
...
* [ff generated stats (1.7 kB)]({{% resource url="/f12/ff.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [pootle]({{< ref "/f12/package/pootle.md" >}}) | 3497 | 3497 | 100.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-browse]({{< ref "/f12/package/sugar-browse.md" >}}) | 0 | 46 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-calculator]({{< ref "/f12/package/sugar-calculator.md" >}}) | 0 | 563 | 0.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-read]({{< ref "/f12/package/sugar-read.md" >}}) | 0 | 25 | 0.0 | LANGUAGE <LL@li.org> | 
