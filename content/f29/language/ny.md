---
title: "ny-Nyanja (Nyanja) - translation progress for f29"
...
Language progress for Nyanja (ny) in Fedora f29 is:
...
* Source words to translate in started packages: 18856
* Translated words: 0
...
* [ny generated stats (2.8 kB)]({{% resource url="/f29/ny.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chewa; Chichewa; Nyanja <ny@li.org> | 
