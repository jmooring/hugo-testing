---
title: "rn-Rundi (Ikirundi) - translation progress for f29"
...
Language progress for Rundi (rn) in Fedora f29 is:
...
* [rn generated stats (2.8 kB)]({{% resource url="/f29/rn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Rundi <rn@li.org> | 
