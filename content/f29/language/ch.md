---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f29"
...
Language progress for Chamorro (ch) in Fedora f29 is:
...
* [ch generated stats (2.9 kB)]({{% resource url="/f29/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f29/package/iso-codes.md" >}}) | 31 | 986 | 3.1 | Chamorro <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ch/> | 
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chamorro <ch@li.org> | 
