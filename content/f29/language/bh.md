---
title: "bh- () - translation progress for f29"
...
Language progress for  (bh) in Fedora f29 is:
...
* [bh generated stats (2.9 kB)]({{% resource url="/f29/bh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f29/package/stellarium.md" >}}) | 2 | 26769 | 0.0 | Bihari <bh@li.org> | 
