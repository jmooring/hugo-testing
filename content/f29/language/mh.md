---
title: "mh-Marshallese (Kajin M̧ajeļ) - translation progress for f29"
...
Language progress for Marshallese (mh) in Fedora f29 is:
...
* Source words to translate in started packages: 21326
* Translated words: 0
...
* [mh generated stats (2.9 kB)]({{% resource url="/f29/mh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Marshallese <mh@li.org> | 
