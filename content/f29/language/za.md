---
title: "za-Zhuang (Vahcuengh) - translation progress for f29"
...
Language progress for Zhuang (za) in Fedora f29 is:

* 26.33% when we only look on started packages for this language.
...
* Source words to translate in started packages: 26376
...
* [za generated stats (2.9 kB)]({{% resource url="/f29/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f29/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
