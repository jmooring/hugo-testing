---
title: "ss-Swati (siSwati) - translation progress for f29"
...
Language progress for Swati (ss) in Fedora f29 is:

* 26.21% when we only look on started packages for this language.
...
* Source words to translate in started packages: 117503
* Translated words: 30799
...
* [ss generated stats (2.9 kB)]({{% resource url="/f29/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f29/package/libreoffice.md" >}}) | 30799 | 98647 | 31.2 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Swati <ss@li.org> | 
