---
title: "cr- () - translation progress for f29"
...
Language progress for  (cr) in Fedora f29 is:
...
* [cr generated stats (2.8 kB)]({{% resource url="/f29/cr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Cree <cr@li.org> | 
