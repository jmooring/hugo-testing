---
title: "lu-Luba-Katanga (Tshiluba) - translation progress for f29"
...
Language progress for Luba-Katanga (lu) in Fedora f29 is:
...
* [lu generated stats (2.8 kB)]({{% resource url="/f29/lu.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Luba-Katanga <lu@li.org> | 
