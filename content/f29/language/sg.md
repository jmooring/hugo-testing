---
title: "sg-Sango (Sängö) - translation progress for f29"
...
Language progress for Sango (sg) in Fedora f29 is:
...
* [sg generated stats (2.8 kB)]({{% resource url="/f29/sg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Sango <sg@li.org> | 
