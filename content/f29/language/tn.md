---
title: "tn-Tswana (Setswana) - translation progress for f29"
...
Language progress for Tswana (tn) in Fedora f29 is:

* 19.49% when we only look on started packages for this language.
* 0.15% when we compare to every single translatable string in Fedora f29.

Possible scripts are: Latn

* Total translatable string in Fedora f29: 15476118
* Source words to translate in started packages: 117502
* Translated words: 22902
...
* [tn generated stats (2.9 kB)]({{% resource url="/f29/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice](/f29/package/libreoffice) | 22902 | 98640 | 23.2 | LANGUAGE <LL@li.org> | 
