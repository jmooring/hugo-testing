---
title: "mt-Maltese (Malti) - translation progress for f29"
...
Language progress for Maltese (mt) in Fedora f29 is:

* 3.07% when we only look on started packages for this language.
...
* Source words to translate in started packages: 213198
* Translated words: 6555
...
* [mt generated stats (5.1 kB)]({{% resource url="/f29/mt.csv" %}})
