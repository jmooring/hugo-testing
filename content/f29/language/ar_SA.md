---
title: "ar_SA-Arabic (Saudi Arabia) (العربية (المملكة العربية السعودية)) - translation progress for f29"
...
Language progress for Arabic (Saudi Arabia) (ar_SA) in Fedora f29 is:

* 19.69% when we only look on started packages for this language.
...
* Source words to translate in started packages: 54091
* Translated words: 10651
...
* [ar_SA generated stats (1.0 kB)]({{% resource url="/f29/ar_SA.csv" %}})
