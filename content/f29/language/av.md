---
title: "av-Avaric (Авар мацӀ) - translation progress for f29"
...
Language progress for Avaric (av) in Fedora f29 is:
...
* Source words to translate in started packages: 45625
* Translated words: 1
...
* [av generated stats (2.9 kB)]({{% resource url="/f29/av.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f29/package/stellarium.md" >}}) | 1 | 26769 | 0.0 | Avaric <av@li.org> | 
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Avaric <av@li.org> | 
