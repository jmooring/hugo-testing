---
title: "ik-Inupiaq (Iñupiatun) - translation progress for f29"
...
Language progress for Inupiaq (ik) in Fedora f29 is:
...
* [ik generated stats (2.8 kB)]({{% resource url="/f29/ik.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Inupiaq <ik@li.org> | 
