---
title: "nl_BE-Dutch (Belgium) (Nederlands (België)) - translation progress for f29"
...
Language progress for Dutch (Belgium) (nl_BE) in Fedora f29 is:

* 36.67% when we only look on started packages for this language.
* 0.16% when we compare to every single translatable string in Fedora f29.

Possible scripts are: Latn

* Total translatable string in Fedora f29: 15476118
* Source words to translate in started packages: 68296
* Translated words: 25042
...
* [nl_BE generated stats (1.1 kB)]({{% resource url="/f29/nl_BE.csv" %}})
