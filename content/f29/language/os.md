---
title: "os-Ossetic (Ирон) - translation progress for f29"
...
Language progress for Ossetic (os) in Fedora f29 is:

* 14.89% when we only look on started packages for this language.
...
* [os generated stats (3.3 kB)]({{% resource url="/f29/os.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [slick-greeter]({{< ref "/f29/package/slick-greeter.md" >}}) | 161 | 211 | 76.3 | Ossetian <os@li.org> | 
 | [python2-django1.11]({{< ref "/f29/package/python2-django1.11.md" >}}) | 2177 | 3424 | 63.6 | Ossetic (http://www.transifex.com/django/django/language/os/) | 
 | [python-django]({{< ref "/f29/package/python-django.md" >}}) | 2137 | 3488 | 61.3 | Ossetic (http://www.transifex.com/django/django/language/os/) | 
 | [python-django-formtools]({{< ref "/f29/package/python-django-formtools.md" >}}) | 5 | 32 | 15.6 | Ossetic (http://www.transifex.com/projects/p/django-formtools/language/os/) | 
 | [exaile]({{< ref "/f29/package/exaile.md" >}}) | 1 | 4068 | 0.0 | Ossetian <os@li.org> | 
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Ossetian <os@li.org> | 
