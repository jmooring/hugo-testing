---
title: "ab-Abkhazian (Аԥсшәа) - translation progress for f29"
...
Language progress for Abkhazian (ab) in Fedora f29 is:

* 40.09% when we only look on started packages for this language.
* 0.37% when we compare to every single translatable string in Fedora f29.

Possible scripts are: Cyrl

* Total translatable string in Fedora f29: 15476118
* Source words to translate in started packages: 144249
* Translated words: 57824
...
* [ab generated stats (3.2 kB)]({{% resource url="/f29/ab.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [blender]({{< ref "/f29/package/blender.md" >}}) | 202 | 202 | 100.0 | Abkhaz language team <daniel.abzakh@gmail.com> | 
 | [libreoffice]({{< ref "/f29/package/libreoffice.md" >}}) | 57619 | 98639 | 58.4 | LANGUAGE <LL@li.org> | 
 | [openerp]({{< ref "/f29/package/openerp.md" >}}) | 3 | 23720 | 0.0 |  | 
 ...
 | [gscan2pdf]({{< ref "/f29/package/gscan2pdf.md" >}}) | 0 | 1840 | 0.0 | Abkhazian <ab@li.org> | 
 | [harvey]({{< ref "/f29/package/harvey.md" >}}) | 0 | 57 | 0.0 | none | 
 | [iso-codes]({{< ref "/f29/package/iso-codes.md" >}}) | 0 | 986 | 0.0 | Abkhazian <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ab/> | 
 ...
 | [vocal]({{< ref "/f29/package/vocal.md" >}}) | 0 | 377 | 0.0 | Abkhazian <ab@li.org> | 
