---
title: "aa-Afar (Qafar) - translation progress for f29"
...
Language progress for Afar (aa) in Fedora f29 is:
...
* [aa generated stats (2.9 kB)]({{% resource url="/f29/aa.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [stellarium]({{< ref "/f29/package/stellarium.md" >}}) | 0 | 26769 | 0.0 | Afar <aa@li.org> | 
