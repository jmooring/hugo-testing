---
title: "son- () - translation progress for f13"
...
Language progress for  (son) in Fedora f13 is:

* 46.59% when we only look on started packages for this language.
* 0.09% when we compare to every single translatable string in Fedora f13.
...
* [son generated stats (441 Bytes)]({{% resource url="/f13/son.csv" %}})
