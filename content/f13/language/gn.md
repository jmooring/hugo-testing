---
title: "gn-Guarani (Avañe’ẽ) - translation progress for f13"
...
Language progress for Guarani (gn) in Fedora f13 is:
...
* [gn generated stats (265 Bytes)]({{% resource url="/f13/gn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [lxmenu-data]({{< ref "/f13/package/lxmenu-data.md" >}}) | 53 | 97 | 54.6 |  | 
 | [gnome-menus]({{< ref "/f13/package/gnome-menus.md" >}}) | 71 | 133 | 53.4 |  | 
{.sortable}
