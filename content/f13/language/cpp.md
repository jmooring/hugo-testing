---
title: "cpp- () - translation progress for f13"
...
Language progress for  (cpp) in Fedora f13 is:
...
* Source words to translate in started packages: 2261
* Translated words: 12
...
* [cpp generated stats (1.2 kB)]({{% resource url="/f13/cpp.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [kde-i18n]({{< ref "/f13/package/kde-i18n.md" >}}) | 10 | 10 | 100.0 | Chinese (traditional) <zh-l10n@linux.org.tw> | 
