---
title: "ha-Hausa (Hausa) - translation progress for f23"
...
Language progress for Hausa (ha) in Fedora f23 is:

* 24.30% when we only look on started packages for this language.
* 0.13% when we compare to every single translatable string in Fedora f23.

Possible scripts are: LatnArab

* Total translatable string in Fedora f23: 13805956
* Source words to translate in started packages: 76259
...
* [ha generated stats (6.5 kB)]({{% resource url="/f23/ha.csv" %}})
