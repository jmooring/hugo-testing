---
title: "es_DO-Spanish (Dominican Republic) (Español (República Dominicana)) - translation progress for f23"
...
Language progress for Spanish (Dominican Republic) (es_DO) in Fedora f23 is:

* 29.64% when we only look on started packages for this language.
* 0.16% when we compare to every single translatable string in Fedora f23.

Possible scripts are: Latn

* Total translatable string in Fedora f23: 13805956
* Source words to translate in started packages: 73317
* Translated words: 21734
...
* [es_DO generated stats (1.1 kB)]({{% resource url="/f23/es_DO.csv" %}})
