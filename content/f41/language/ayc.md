---
title: "ayc-Southern Aymara (Aymar aru) - translation progress for f41"
...
Language progress for Southern Aymara (ayc) in Fedora f41 is:

* 92.41% when we only look on started packages for this language.
* 0.04% when we compare to every single translatable string in Fedora f41.

Possible scripts are: LatnHang

* Total translatable string in Fedora f41: 21691764
* Source words to translate in started packages: 8248
* Translated words: 7622
...
* [ayc generated stats (2.1 kB)]({{% resource url="/f41/ayc.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [sugar-turtleart]({{< ref "/f41/package/sugar-turtleart.md" >}}) | 1574 | 1574 | 100.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-finance]({{< ref "/f41/package/sugar-finance.md" >}}) | 256 | 258 | 99.2 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-toolkit-gtk3]({{< ref "/f41/package/sugar-toolkit-gtk3.md" >}}) | 161 | 213 | 75.6 | LANGUAGE <LL@li.org> | 
