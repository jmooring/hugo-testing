---
title: "bn_IN-Bangla (India) (বাংলা (ভারত)) - translation progress for f41"
...
territories:
 - IN
polib_error_count: 0
could_not_process_count: 797
---

Language progress for Bangla (India) (bn_IN) in Fedora f41 is:

* 40.75% when we only look on started packages for this language.
* 3.36% when we compare to every single translatable string in Fedora f41.

Possible scripts are: Beng

* Total translatable string in Fedora f41: 21691764
* Source words to translate in started packages: 1787677
* Translated words: 728491
...
* [bn_IN generated stats (38.6 kB)]({{% resource url="/f41/bn_IN.csv" %}})
