---
title: "en@pirate-English (English) - translation progress for f41"
...
Language progress for English (en@pirate) in Fedora f41 is:
...
* [en@pirate generated stats (289 Bytes)]({{% resource url="/f41/en@pirate.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [godot3]({{< ref "/f41/package/godot3.md" >}}) | 388 | 22592 | 1.7 | Pirate <https://hosted.weblate.org/projects/godot-engine/godot/pr/> | 
{.sortable}
