---
title: "kr-Kanuri (Kanuri) - translation progress for f31"
...
Language progress for Kanuri (kr) in Fedora f31 is:

* 31.37% when we only look on started packages for this language.
* 0.08% when we compare to every single translatable string in Fedora f31.

Possible scripts are: LatnArab

* Total translatable string in Fedora f31: 16316041
* Source words to translate in started packages: 40221
...
* [kr generated stats (3.3 kB)]({{% resource url="/f31/kr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [phd2]({{< ref "/f31/package/phd2.md" >}}) | 11300 | 11878 | 95.1 |  | 
 | [gettext]({{< ref "/f31/package/gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [golang-github-chai2010-gettext]({{< ref "/f31/package/golang-github-chai2010-gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [mingw-gettext]({{< ref "/f31/package/mingw-gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [origin]({{< ref "/f31/package/origin.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Kanuri <kr@li.org> | 
