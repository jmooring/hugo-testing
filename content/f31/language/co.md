---
title: "co-Corsican (Corsu) - translation progress for f31"
...
Language progress for Corsican (co) in Fedora f31 is:

* 37.88% when we only look on started packages for this language.
* 0.09% when we compare to every single translatable string in Fedora f31.

Possible scripts are: Latn

* Total translatable string in Fedora f31: 16316041
* Source words to translate in started packages: 36657
...
* [co generated stats (3.2 kB)]({{% resource url="/f31/co.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libfilezilla]({{< ref "/f31/package/libfilezilla.md" >}}) | 402 | 402 | 100.0 | Patriccollu di Santa Maria è Sichè <Patrick.Santa-Maria[AT]laposte.net> | 
 | [poedit]({{< ref "/f31/package/poedit.md" >}}) | 2813 | 2813 | 100.0 | Corsican | 
 | [filezilla]({{< ref "/f31/package/filezilla.md" >}}) | 10671 | 10680 | 99.9 | Patriccollu di Santa Maria è Sichè | 
 ...
 | [lightdm]({{< ref "/f31/package/lightdm.md" >}}) | 0 | 84 | 0.0 | Corsican <co@li.org> | 
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Corsican <co@li.org> | 
