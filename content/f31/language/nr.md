---
title: "nr-South Ndebele (isiNdebele) - translation progress for f31"
...
Language progress for South Ndebele (nr) in Fedora f31 is:

* 24.01% when we only look on started packages for this language.
* 0.19% when we compare to every single translatable string in Fedora f31.

Possible scripts are: Latn

* Total translatable string in Fedora f31: 16316041
* Source words to translate in started packages: 126611
* Translated words: 30394
...
* [nr generated stats (3.0 kB)]({{% resource url="/f31/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [libreoffice]({{< ref "/f31/package/libreoffice.md" >}}) | 29919 | 104207 | 28.7 | LANGUAGE <LL@li.org> | 
