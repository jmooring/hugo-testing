---
title: "ln-Lingala (Lingála) - translation progress for f31"
...
Language progress for Lingala (ln) in Fedora f31 is:

* 32.70% when we only look on started packages for this language.
...
* Source words to translate in started packages: 34738
...
* [ln generated stats (3.7 kB)]({{% resource url="/f31/ln.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gedit]({{< ref "/f31/package/gedit.md" >}}) | 4280 | 4280 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [gnome-books]({{< ref "/f31/package/gnome-books.md" >}}) | 646 | 646 | 100.0 | lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [gnome-characters]({{< ref "/f31/package/gnome-characters.md" >}}) | 155 | 155 | 100.0 | lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [gnome-documents]({{< ref "/f31/package/gnome-documents.md" >}}) | 646 | 646 | 100.0 | lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [gnome-themes-extra]({{< ref "/f31/package/gnome-themes-extra.md" >}}) | 10 | 10 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [gnome-user-share]({{< ref "/f31/package/gnome-user-share.md" >}}) | 52 | 52 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [nautilus]({{< ref "/f31/package/nautilus.md" >}}) | 5489 | 5489 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [nautilus-sendto]({{< ref "/f31/package/nautilus-sendto.md" >}}) | 45 | 45 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [sugar-toolkit-gtk3]({{< ref "/f31/package/sugar-toolkit-gtk3.md" >}}) | 35 | 213 | 16.4 | LANGUAGE <LL@li.org> | 
 ...
 | [lightdm]({{< ref "/f31/package/lightdm.md" >}}) | 0 | 84 | 0.0 | Lingala <ln@li.org> | 
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Lingala <ln@li.org> | 
