---
title: "kg-Kongo (Kongo) - translation progress for f31"
...
Language progress for Kongo (kg) in Fedora f31 is:

* 12.11% when we only look on started packages for this language.
* 0.07% when we compare to every single translatable string in Fedora f31.

Possible scripts are: Latn

* Total translatable string in Fedora f31: 16316041
* Source words to translate in started packages: 88698
...
* [kg generated stats (3.8 kB)]({{% resource url="/f31/kg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [alacarte]({{< ref "/f31/package/alacarte.md" >}}) | 74 | 74 | 100.0 | Kikongo <lundombe01@zaya-dio.com> | 
 | [bzflag]({{< ref "/f31/package/bzflag.md" >}}) | 97 | 97 | 100.0 |  | 
 | [gnome-desktop3]({{< ref "/f31/package/gnome-desktop3.md" >}}) | 384 | 384 | 100.0 | Kikongo, kg <lundombe01@zaya-dio.com> | 
 | [gnome-menus]({{< ref "/f31/package/gnome-menus.md" >}}) | 125 | 125 | 100.0 | Kikongo <lundombe01@zaya-dio.com> | 
 | [xdg-user-dirs-gtk]({{< ref "/f31/package/xdg-user-dirs-gtk.md" >}}) | 81 | 81 | 100.0 | kikongo <lundombe01@zaya-dio.com> | 
 | [cinnamon-desktop]({{< ref "/f31/package/cinnamon-desktop.md" >}}) | 205 | 231 | 88.7 | Kikongo, kg <lundombe01@zaya-dio.com> | 
 | [gtk3]({{< ref "/f31/package/gtk3.md" >}}) | 3245 | 13283 | 24.4 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [gtk4]({{< ref "/f31/package/gtk4.md" >}}) | 3245 | 13283 | 24.4 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [mingw-gtk3]({{< ref "/f31/package/mingw-gtk3.md" >}}) | 3245 | 13283 | 24.4 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [nautilus-sendto]({{< ref "/f31/package/nautilus-sendto.md" >}}) | 39 | 275 | 14.2 | kg (Kikongo) <kongo@kintuadi.org> | 
 | [stellarium]({{< ref "/f31/package/stellarium.md" >}}) | 2 | 26769 | 0.0 | Kongo <kg@li.org> | 
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Kongo <kg@li.org> | 
...
|---------|--------------------------|-------------|------|
 | [bzflag]({{< ref "/f31/package/bzflag.md" >}}) | /mnt/stockage/packages/f31/bzflag/data/l10n/bzflag_kg.po | error-os |  | 
{.sortable}
