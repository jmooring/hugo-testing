---
title: "bh- () - translation progress for f31"
...
Language progress for  (bh) in Fedora f31 is:
...
* [bh generated stats (2.9 kB)]({{% resource url="/f31/bh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f31/package/stellarium.md" >}}) | 2 | 26769 | 0.0 | Bihari <bh@li.org> | 
