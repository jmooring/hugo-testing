---
title: "ss-Swati (siSwati) - translation progress for f31"
...
Language progress for Swati (ss) in Fedora f31 is:

* 24.38% when we only look on started packages for this language.
...
* Source words to translate in started packages: 125020
* Translated words: 30482
...
* [ss generated stats (2.9 kB)]({{% resource url="/f31/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f31/package/libreoffice.md" >}}) | 30482 | 104207 | 29.3 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Swati <ss@li.org> | 
