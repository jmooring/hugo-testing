---
title: "pi- () - translation progress for f31"
...
Language progress for  (pi) in Fedora f31 is:

* 0.87% when we only look on started packages for this language.
...
* Source words to translate in started packages: 21418
...
* [pi generated stats (2.7 kB)]({{% resource url="/f31/pi.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f31/package/iso-codes.md" >}}) | 186 | 982 | 18.9 | Pali <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/pi/> | 
