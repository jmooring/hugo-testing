---
title: "os-Ossetic (Ирон) - translation progress for f31"
...
Language progress for Ossetic (os) in Fedora f31 is:

* 11.52% when we only look on started packages for this language.
...
* Source words to translate in started packages: 39242
...
* [os generated stats (3.5 kB)]({{% resource url="/f31/os.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [slick-greeter]({{< ref "/f31/package/slick-greeter.md" >}}) | 161 | 211 | 76.3 | Ossetian <os@li.org> | 
 | [python2-django1.11]({{< ref "/f31/package/python2-django1.11.md" >}}) | 2177 | 3424 | 63.6 | Ossetic (http://www.transifex.com/django/django/language/os/) | 
 | [python-django]({{< ref "/f31/package/python-django.md" >}}) | 2137 | 3488 | 61.3 | Ossetic (http://www.transifex.com/django/django/language/os/) | 
 | [python-django-formtools]({{< ref "/f31/package/python-django-formtools.md" >}}) | 5 | 32 | 15.6 | Ossetic (http://www.transifex.com/projects/p/django-formtools/language/os/) | 
 | [supertuxkart]({{< ref "/f31/package/supertuxkart.md" >}}) | 41 | 5341 | 0.8 | Ossetic (http://www.transifex.com/supertuxkart/supertuxkart/language/os/) | 
 | [exaile]({{< ref "/f31/package/exaile.md" >}}) | 1 | 4068 | 0.0 | Ossetian <os@li.org> | 
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Ossetian <os@li.org> | 
