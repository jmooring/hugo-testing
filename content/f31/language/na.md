---
title: "na-Nauru (Dorerin Naoero) - translation progress for f31"
...
Language progress for Nauru (na) in Fedora f31 is:

* 0.40% when we only look on started packages for this language.
...
* Source words to translate in started packages: 54638
...
* [na generated stats (4.8 kB)]({{% resource url="/f31/na.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f31/package/iso-codes.md" >}}) | 187 | 982 | 19.0 | Nauru <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/na/> | 
 | [sugar-chat]({{< ref "/f31/package/sugar-chat.md" >}}) | 24 | 137 | 17.5 | LANGUAGE <LL@li.org> | 
 | [stellarium]({{< ref "/f31/package/stellarium.md" >}}) | 6 | 26769 | 0.0 | Nauru <na@li.org> | 
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Nauru <na@li.org> | 
