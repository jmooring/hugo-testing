---
title: "mh-Marshallese (Kajin M̧ajeļ) - translation progress for f31"
...
Language progress for Marshallese (mh) in Fedora f31 is:
...
* Source words to translate in started packages: 23331
* Translated words: 0
...
* [mh generated stats (3.0 kB)]({{% resource url="/f31/mh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Marshallese <mh@li.org> | 
