---
title: "ng-Ndonga (Ndonga) - translation progress for f31"
...
Language progress for Ndonga (ng) in Fedora f31 is:
...
* [ng generated stats (2.8 kB)]({{% resource url="/f31/ng.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Ndonga <ng@li.org> | 
