---
title: "ny-Nyanja (Nyanja) - translation progress for f31"
...
Language progress for Nyanja (ny) in Fedora f31 is:
...
* [ny generated stats (2.8 kB)]({{% resource url="/f31/ny.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chewa; Chichewa; Nyanja <ny@li.org> | 
