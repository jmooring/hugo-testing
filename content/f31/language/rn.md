---
title: "rn-Rundi (Ikirundi) - translation progress for f31"
...
Language progress for Rundi (rn) in Fedora f31 is:
...
* [rn generated stats (2.8 kB)]({{% resource url="/f31/rn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Rundi <rn@li.org> | 
