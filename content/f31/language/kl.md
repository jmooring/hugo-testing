---
title: "kl-Kalaallisut (Kalaallisut) - translation progress for f31"
...
Language progress for Kalaallisut (kl) in Fedora f31 is:

* 1.14% when we only look on started packages for this language.
...
* Source words to translate in started packages: 128162
* Translated words: 1467
...
* [kl generated stats (3.3 kB)]({{% resource url="/f31/kl.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [slick-greeter]({{< ref "/f31/package/slick-greeter.md" >}}) | 54 | 211 | 25.6 | Greenlandic (Kalaallisut) <kl@li.org> | 
 | [libreoffice]({{< ref "/f31/package/libreoffice.md" >}}) | 1413 | 104207 | 1.4 | LANGUAGE <LL@li.org> | 
 ...
 | [iso-codes]({{< ref "/f31/package/iso-codes.md" >}}) | 0 | 982 | 0.0 | Greenlandic <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/kl/> | 
 | [lightdm]({{< ref "/f31/package/lightdm.md" >}}) | 0 | 84 | 0.0 | Greenlandic (Kalaallisut) <kl@li.org> | 
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Greenlandic (Kalaallisut) <kl@li.org> | 
