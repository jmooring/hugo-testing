---
title: "cr- () - translation progress for f31"
...
Language progress for  (cr) in Fedora f31 is:
...
* [cr generated stats (2.8 kB)]({{% resource url="/f31/cr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Cree <cr@li.org> | 
