---
title: "sg-Sango (Sängö) - translation progress for f31"
...
Language progress for Sango (sg) in Fedora f31 is:
...
* [sg generated stats (2.8 kB)]({{% resource url="/f31/sg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f31/package/vocal.md" >}}) | 0 | 377 | 0.0 | Sango <sg@li.org> | 
