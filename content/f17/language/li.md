---
title: "li-Limburgish (Lèmbörgs) - translation progress for f17"
...
Language progress for Limburgish (li) in Fedora f17 is:

* 38.06% when we only look on started packages for this language.
* 0.40% when we compare to every single translatable string in Fedora f17.

Possible scripts are: Latn

* Total translatable string in Fedora f17: 10091855
* Source words to translate in started packages: 104837
* Translated words: 39905
...
* [li generated stats (3.5 kB)]({{% resource url="/f17/li.csv" %}})
