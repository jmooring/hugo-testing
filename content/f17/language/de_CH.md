---
title: "de_CH-German (Switzerland) (Deutsch (Schweiz)) - translation progress for f17"
...
Language progress for German (Switzerland) (de_CH) in Fedora f17 is:

* 52.17% when we only look on started packages for this language.
* 0.38% when we compare to every single translatable string in Fedora f17.

Possible scripts are: Latn

* Total translatable string in Fedora f17: 10091855
* Source words to translate in started packages: 74468
* Translated words: 38850
...
* [de_CH generated stats (2.6 kB)]({{% resource url="/f17/de_CH.csv" %}})
