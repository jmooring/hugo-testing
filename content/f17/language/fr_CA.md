---
title: "fr_CA-French (Canada) (Français (Canada)) - translation progress for f17"
...
Language progress for French (Canada) (fr_CA) in Fedora f17 is:

* 17.78% when we only look on started packages for this language.
* 0.09% when we compare to every single translatable string in Fedora f17.

Possible scripts are: Latn

* Total translatable string in Fedora f17: 10091855
* Source words to translate in started packages: 51583
* Translated words: 9174
...
* [fr_CA generated stats (882 Bytes)]({{% resource url="/f17/fr_CA.csv" %}})
