---
title: "mh-Marshallese (Kajin M̧ajeļ) - translation progress for f26"
...
Language progress for Marshallese (mh) in Fedora f26 is:
...
* [mh generated stats (1.3 kB)]({{% resource url="/f26/mh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Marshallese <mh@li.org> | 
{.sortable}
