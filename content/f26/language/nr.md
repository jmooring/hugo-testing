---
title: "nr-South Ndebele (isiNdebele) - translation progress for f26"
...
Language progress for South Ndebele (nr) in Fedora f26 is:

* 28.10% when we only look on started packages for this language.
* 0.22% when we compare to every single translatable string in Fedora f26.

Possible scripts are: Latn

* Total translatable string in Fedora f26: 14366991
* Source words to translate in started packages: 113000
* Translated words: 31748
...
* [nr generated stats (1.4 kB)]({{% resource url="/f26/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f26/package/libreoffice.md" >}}) | 31273 | 99941 | 31.3 | LANGUAGE <LL@li.org> | 
