---
title: "ny-Nyanja (Nyanja) - translation progress for f26"
...
Language progress for Nyanja (ny) in Fedora f26 is:
...
* [ny generated stats (1.3 kB)]({{% resource url="/f26/ny.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chewa; Chichewa; Nyanja <ny@li.org> | 
{.sortable}
