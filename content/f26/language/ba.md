---
title: "ba-Bashkir (Башҡорт теле) - translation progress for f26"
...
Language progress for Bashkir (ba) in Fedora f26 is:
...
* Source words to translate in started packages: 37264
* Translated words: 16
...
* [ba generated stats (1.3 kB)]({{% resource url="/f26/ba.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f26/package/stellarium.md" >}}) | 16 | 25796 | 0.1 | Bashkir <ba@li.org> | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Bashkir <ba@li.org> | 
{.sortable}
