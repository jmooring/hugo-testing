---
title: "kr-Kanuri (Kanuri) - translation progress for f26"
...
Language progress for Kanuri (kr) in Fedora f26 is:

* 4.26% when we only look on started packages for this language.
...
* Source words to translate in started packages: 15570
...
* [kr generated stats (1.5 kB)]({{% resource url="/f26/kr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gettext]({{< ref "/f26/package/gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [mingw-gettext]({{< ref "/f26/package/mingw-gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [isomaster]({{< ref "/f26/package/isomaster.md" >}}) | 7 | 674 | 1.0 | http://littlesvr.ca/ostd/ | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Kanuri <kr@li.org> | 
{.sortable}
