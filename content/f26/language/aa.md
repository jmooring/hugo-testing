---
title: "aa-Afar (Qafar) - translation progress for f26"
...
Language progress for Afar (aa) in Fedora f26 is:
...
* [aa generated stats (1.3 kB)]({{% resource url="/f26/aa.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [stellarium]({{< ref "/f26/package/stellarium.md" >}}) | 0 | 25796 | 0.0 | Afar <aa@li.org> | 
