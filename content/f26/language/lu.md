---
title: "lu-Luba-Katanga (Tshiluba) - translation progress for f26"
...
Language progress for Luba-Katanga (lu) in Fedora f26 is:
...
* [lu generated stats (1.3 kB)]({{% resource url="/f26/lu.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Luba-Katanga <lu@li.org> | 
{.sortable}
