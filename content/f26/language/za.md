---
title: "za-Zhuang (Vahcuengh) - translation progress for f26"
...
Language progress for Zhuang (za) in Fedora f26 is:

* 36.58% when we only look on started packages for this language.
...
* Source words to translate in started packages: 18988
...
* [za generated stats (1.4 kB)]({{% resource url="/f26/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f26/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
