---
title: "ln-Lingala (Lingála) - translation progress for f26"
...
Language progress for Lingala (ln) in Fedora f26 is:

* 44.50% when we only look on started packages for this language.
...
* Source words to translate in started packages: 24207
...
* [ln generated stats (2.0 kB)]({{% resource url="/f26/ln.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gedit]({{< ref "/f26/package/gedit.md" >}}) | 4280 | 4280 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [gnome-characters]({{< ref "/f26/package/gnome-characters.md" >}}) | 155 | 155 | 100.0 | lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [gnome-documents]({{< ref "/f26/package/gnome-documents.md" >}}) | 646 | 646 | 100.0 | lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [gnome-themes-standard]({{< ref "/f26/package/gnome-themes-standard.md" >}}) | 10 | 10 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [gnome-user-share]({{< ref "/f26/package/gnome-user-share.md" >}}) | 52 | 52 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [nautilus]({{< ref "/f26/package/nautilus.md" >}}) | 5489 | 5489 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [nautilus-sendto]({{< ref "/f26/package/nautilus-sendto.md" >}}) | 45 | 45 | 100.0 | Lingala <ubuntu-cd@lists.ubuntu.com> | 
 | [openerp]({{< ref "/f26/package/openerp.md" >}}) | 57 | 851 | 6.7 | Lingala <ln@li.org> | 
 | [openerp7]({{< ref "/f26/package/openerp7.md" >}}) | 38 | 1127 | 3.4 | Lingala <ln@li.org> | 
 ...
 | [lightdm]({{< ref "/f26/package/lightdm.md" >}}) | 0 | 84 | 0.0 | Lingala <ln@li.org> | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Lingala <ln@li.org> | 
{.sortable}
