---
title: "cr- () - translation progress for f26"
...
Language progress for  (cr) in Fedora f26 is:
...
* [cr generated stats (1.3 kB)]({{% resource url="/f26/cr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Cree <cr@li.org> | 
{.sortable}
