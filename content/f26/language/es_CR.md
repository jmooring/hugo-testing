---
title: "es_CR-Spanish (Costa Rica) (Español (Costa Rica)) - translation progress for f26"
...
Language progress for Spanish (Costa Rica) (es_CR) in Fedora f26 is:

* 73.39% when we only look on started packages for this language.
* 0.62% when we compare to every single translatable string in Fedora f26.
...
* [es_CR generated stats (1.1 kB)]({{% resource url="/f26/es_CR.csv" %}})
