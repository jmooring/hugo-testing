---
title: "dv-Divehi (ދިވެހިބަސް) - translation progress for f26"
...
Language progress for Divehi (dv) in Fedora f26 is:

* 1.01% when we only look on started packages for this language.
...
* Source words to translate in started packages: 44439
* Translated words: 450
...
* [dv generated stats (1.6 kB)]({{% resource url="/f26/dv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gnome-menus]({{< ref "/f26/package/gnome-menus.md" >}}) | 157 | 157 | 100.0 | Divehi <dv@li.org> | 
 | [gnome-do]({{< ref "/f26/package/gnome-do.md" >}}) | 162 | 612 | 26.5 | Divehi <dv@li.org> | 
 | [minetest]({{< ref "/f26/package/minetest.md" >}}) | 116 | 6406 | 1.8 | Dhivehi <https://hosted.weblate.org/projects/minetest/minetest/dv/> | 
 | [stellarium]({{< ref "/f26/package/stellarium.md" >}}) | 15 | 25796 | 0.1 | Divehi <dv@li.org> | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Divehi <dv@li.org> | 
{.sortable}
