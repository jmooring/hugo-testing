---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f26"
...
Language progress for Chamorro (ch) in Fedora f26 is:
...
* [ch generated stats (1.3 kB)]({{% resource url="/f26/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chamorro <ch@li.org> | 
{.sortable}
