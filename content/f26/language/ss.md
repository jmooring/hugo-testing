---
title: "ss-Swati (siSwati) - translation progress for f26"
...
Language progress for Swati (ss) in Fedora f26 is:
...
* Source words to translate in started packages: 111426
* Translated words: 31316
...
* [ss generated stats (1.4 kB)]({{% resource url="/f26/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f26/package/libreoffice.md" >}}) | 31316 | 99958 | 31.3 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Swati <ss@li.org> | 
{.sortable}
