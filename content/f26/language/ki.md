---
title: "ki-Kikuyu (Gikuyu) - translation progress for f26"
...
Language progress for Kikuyu (ki) in Fedora f26 is:
...
* [ki generated stats (1.3 kB)]({{% resource url="/f26/ki.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Kikuyu <ki@li.org> | 
{.sortable}
