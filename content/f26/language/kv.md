---
title: "kv-Komi (Коми кыв) - translation progress for f26"
...
Language progress for Komi (kv) in Fedora f26 is:
...
* Source words to translate in started packages: 11468
...
* [kv generated stats (1.3 kB)]({{% resource url="/f26/kv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [appcenter]({{< ref "/f26/package/appcenter.md" >}}) | 249 | 681 | 36.6 | Komi <https://weblate.elementary.io/projects/appcenter/appcenter/kv/> | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Komi <kv@li.org> | 
{.sortable}
