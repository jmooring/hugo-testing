---
title: "ik-Inupiaq (Iñupiatun) - translation progress for f26"
...
Language progress for Inupiaq (ik) in Fedora f26 is:
...
* [ik generated stats (1.3 kB)]({{% resource url="/f26/ik.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Inupiaq <ik@li.org> | 
{.sortable}
