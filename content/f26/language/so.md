---
title: "so-Somali (Soomaali) - translation progress for f26"
...
Language progress for Somali (so) in Fedora f26 is:

* 11.65% when we only look on started packages for this language.
...
* Source words to translate in started packages: 47698
* Translated words: 5556
...
* [so generated stats (1.8 kB)]({{% resource url="/f26/so.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [mate-menu]({{< ref "/f26/package/mate-menu.md" >}}) | 241 | 300 | 80.3 | Somali <so@li.org> | 
 | [mintmenu]({{< ref "/f26/package/mintmenu.md" >}}) | 1548 | 6466 | 23.9 | Somali <so@li.org> | 
 | [gcompris]({{< ref "/f26/package/gcompris.md" >}}) | 2167 | 9603 | 22.6 | Somali <mimursal@mimfi-tech.com> | 
 | [iso-codes]({{< ref "/f26/package/iso-codes.md" >}}) | 125 | 1089 | 11.5 | Somali | 
 | [cinnamon-translations]({{< ref "/f26/package/cinnamon-translations.md" >}}) | 1475 | 18521 | 8.0 | Somali <so@li.org> | 
 ...
 | [libmatekbd]({{< ref "/f26/package/libmatekbd.md" >}}) | 0 | 251 | 0.0 | Somali (http://www.transifex.com/mate/MATE/language/so/) | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Somali <so@li.org> | 
{.sortable}
