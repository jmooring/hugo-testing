---
title: "oj- () - translation progress for f26"
...
Language progress for  (oj) in Fedora f26 is:
...
* Source words to translate in started packages: 38869
...
* [oj generated stats (1.4 kB)]({{% resource url="/f26/oj.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint](/f26/package/tuxpaint) | 179 | 1591 | 11.3 | Ed <edm@rocketmail.com> | 
 | [stellarium](/f26/package/stellarium) | 33 | 25810 | 0.1 | Ojibwe <oj@li.org> | 
 ...
 | [vocal](/f26/package/vocal) | 0 | 377 | 0.0 | Ojibwe <oj@li.org> | 
{.sortable}
