---
title: "sg-Sango (Sängö) - translation progress for f26"
...
Language progress for Sango (sg) in Fedora f26 is:
...
* [sg generated stats (1.3 kB)]({{% resource url="/f26/sg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal](/f26/package/vocal) | 0 | 377 | 0.0 | Sango <sg@li.org> | 
{.sortable}
