---
title: "rn-Rundi (Ikirundi) - translation progress for f26"
...
Language progress for Rundi (rn) in Fedora f26 is:
...
* [rn generated stats (1.3 kB)]({{% resource url="/f26/rn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Rundi <rn@li.org> | 
{.sortable}
