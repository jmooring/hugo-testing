---
title: "bm-Bambara (Bamanakan) - translation progress for f26"
...
Language progress for Bambara (bm) in Fedora f26 is:

* 11.67% when we only look on started packages for this language.
...
* Source words to translate in started packages: 12983
...
* [bm generated stats (1.3 kB)]({{% resource url="/f26/bm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f26/package/tuxpaint.md" >}}) | 1515 | 1515 | 100.0 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Bambara <bm@li.org> | 
{.sortable}
