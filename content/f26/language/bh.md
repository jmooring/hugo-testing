---
title: "bh- () - translation progress for f26"
...
Language progress for  (bh) in Fedora f26 is:
...
* [bh generated stats (1.3 kB)]({{% resource url="/f26/bh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f26/package/stellarium.md" >}}) | 11 | 25796 | 0.0 | Bihari <bh@li.org> | 
