---
title: "tn-Tswana (Setswana) - translation progress for f26"
...
Language progress for Tswana (tn) in Fedora f26 is:

* 20.26% when we only look on started packages for this language.
* 0.16% when we compare to every single translatable string in Fedora f26.

Possible scripts are: Latn

* Total translatable string in Fedora f26: 14366991
* Source words to translate in started packages: 111420
* Translated words: 22573
...
* [tn generated stats (1.4 kB)]({{% resource url="/f26/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f26/package/libreoffice.md" >}}) | 22573 | 99952 | 22.6 | LANGUAGE <LL@li.org> | 
