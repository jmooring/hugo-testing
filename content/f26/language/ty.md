---
title: "ty-Tahitian (Reo Tahiti) - translation progress for f26"
...
Language progress for Tahitian (ty) in Fedora f26 is:
...
* [ty generated stats (1.3 kB)]({{% resource url="/f26/ty.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Tahitian <ty@li.org> | 
{.sortable}
