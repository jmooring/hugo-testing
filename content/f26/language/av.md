---
title: "av-Avaric (Авар мацӀ) - translation progress for f26"
...
Language progress for Avaric (av) in Fedora f26 is:
...
* [av generated stats (1.3 kB)]({{% resource url="/f26/av.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f26/package/stellarium.md" >}}) | 1 | 25796 | 0.0 | Avaric <av@li.org> | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Avaric <av@li.org> | 
{.sortable}
