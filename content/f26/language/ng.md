---
title: "ng-Ndonga (Ndonga) - translation progress for f26"
...
Language progress for Ndonga (ng) in Fedora f26 is:

* 4.88% when we only look on started packages for this language.
...
* Source words to translate in started packages: 12056
...
* [ng generated stats (1.3 kB)]({{% resource url="/f26/ng.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [aircrack-ng]({{< ref "/f26/package/aircrack-ng.md" >}}) | 588 | 588 | 100.0 |  | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Ndonga <ng@li.org> | 
{.sortable}
