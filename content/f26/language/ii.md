---
title: "ii-Sichuan Yi (ꆈꌠꉙ) - translation progress for f26"
...
Language progress for Sichuan Yi (ii) in Fedora f26 is:
...
* Source words to translate in started packages: 11631
* Translated words: 4
...
* [ii generated stats (1.4 kB)]({{% resource url="/f26/ii.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [cinnamon-translations]({{< ref "/f26/package/cinnamon-translations.md" >}}) | 4 | 163 | 2.5 | Sichuan Yi <ii@li.org> | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Sichuan Yi <ii@li.org> | 
{.sortable}
