---
title: "ve-Venda (Tshivenḓa) - translation progress for f26"
...
Language progress for Venda (ve) in Fedora f26 is:

* 11.28% when we only look on started packages for this language.
* 0.24% when we compare to every single translatable string in Fedora f26.

Possible scripts are: Latn

* Total translatable string in Fedora f26: 14366991
* Source words to translate in started packages: 301128
* Translated words: 33970
...
* [ve generated stats (1.7 kB)]({{% resource url="/f26/ve.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f26/package/libreoffice.md" >}}) | 31233 | 99959 | 31.2 | LANGUAGE <LL@li.org> | 
 | [tuxpaint]({{< ref "/f26/package/tuxpaint.md" >}}) | 475 | 1591 | 29.9 | LANGUAGE <LL@li.org> | 
 | [koffice-kivio]({{< ref "/f26/package/koffice-kivio.md" >}}) | 1896 | 8417 | 22.5 | <en@li.org> | 
 | [iso-codes]({{< ref "/f26/package/iso-codes.md" >}}) | 319 | 22392 | 1.4 | Venda <venda@translate.org.za> | 
 | [calibre]({{< ref "/f26/package/calibre.md" >}}) | 47 | 157301 | 0.0 | Venda (http://www.transifex.com/calibre/calibre/language/ve/) | 
 ...
 | [vocal]({{< ref "/f26/package/vocal.md" >}}) | 0 | 377 | 0.0 | Venda <ve@li.org> | 
{.sortable}
