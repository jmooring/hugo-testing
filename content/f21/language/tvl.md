---
title: "tvl- () - translation progress for f21"
...
Language progress for  (tvl) in Fedora f21 is:
...
* Source words to translate in started packages: 9342
* Translated words: 23
...
* [tvl generated stats (2.4 kB)]({{% resource url="/f21/tvl.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-write](/f21/package/sugar-write) | 20 | 121 | 16.5 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-turtleart](/f21/package/sugar-turtleart) | 0 | 3075 | 0.0 | LANGUAGE <LL@li.org> | 
