---
title: "tyv-Tuvinian (Тыва дыл) - translation progress for f21"
...
Language progress for Tuvinian (tyv) in Fedora f21 is:

* 0.24% when we only look on started packages for this language.
...
* Source words to translate in started packages: 5890
* Translated words: 14
...
* [tyv generated stats (1.6 kB)]({{% resource url="/f21/tyv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [terminator]({{< ref "/f21/package/terminator.md" >}}) | 9 | 726 | 1.2 | Tuvinian <tyv@li.org> | 
 | [sugar-finance]({{< ref "/f21/package/sugar-finance.md" >}}) | 1 | 143 | 0.7 | LANGUAGE <LL@li.org> | 
 | [gnome-do]({{< ref "/f21/package/gnome-do.md" >}}) | 4 | 612 | 0.7 | Tuvinian <tyv@li.org> | 
 ...
 | [sugar-measure]({{< ref "/f21/package/sugar-measure.md" >}}) | 0 | 155 | 0.0 | LANGUAGE <LL@li.org> | 
