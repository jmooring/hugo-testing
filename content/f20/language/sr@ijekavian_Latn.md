---
title: "sr@ijekavian_Latn-Serbian (Српски) - translation progress for f20"
...
territories:
 ...
 - XK
polib_error_count: 0
could_not_process_count: 812
---

Language progress for Serbian (sr@ijekavian_Latn) in Fedora f20 is:

* 97.47% when we only look on started packages for this language.
* 3.74% when we compare to every single translatable string in Fedora f20.

Possible scripts are: CyrlLatn

* Total translatable string in Fedora f20: 12425872
* Source words to translate in started packages: 477130
* Translated words: 465070
...
* [sr@ijekavian_Latn generated stats (6.2 kB)]({{% resource url="/f20/sr@ijekavian_Latn.csv" %}})
