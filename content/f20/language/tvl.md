---
title: "tvl- () - translation progress for f20"
...
Language progress for  (tvl) in Fedora f20 is:

* 0.27% when we only look on started packages for this language.
* 0.00% when we compare to every single translatable string in Fedora f20.

Possible scripts are: 

* Total translatable string in Fedora f20: 12425872
* Source words to translate in started packages: 9289
* Translated words: 25
...
* [tvl generated stats (2.3 kB)]({{% resource url="/f20/tvl.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-write]({{< ref "/f20/package/sugar-write.md" >}}) | 20 | 121 | 16.5 | LANGUAGE <LL@li.org> | 
 | [sugar-chat]({{< ref "/f20/package/sugar-chat.md" >}}) | 1 | 55 | 1.8 | LANGUAGE <LL@li.org> | 
 | [sugar-read]({{< ref "/f20/package/sugar-read.md" >}}) | 1 | 114 | 0.9 | LANGUAGE <LL@li.org> | 
 | [sugar-calculator]({{< ref "/f20/package/sugar-calculator.md" >}}) | 1 | 871 | 0.1 | LANGUAGE <LL@li.org> | 
 | [sugar-turtleart]({{< ref "/f20/package/sugar-turtleart.md" >}}) | 2 | 3077 | 0.1 | LANGUAGE <LL@li.org> | 
 | [sugar]({{< ref "/f20/package/sugar.md" >}}) | 0 | 1625 | 0.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-story]({{< ref "/f20/package/sugar-story.md" >}}) | 0 | 24 | 0.0 | LANGUAGE <LL@li.org> | 
