---
title: "es_CL-Spanish (Chile) (Español (Chile)) - translation progress for f20"
date: 2026-01-17T11:29:47+00:00
code: es_CL
...
* 22.25% when we only look on started packages for this language.
* 0.14% when we compare to every single translatable string in Fedora f20.

Possible scripts are: Latn

* Total translatable string in Fedora f20: 12425872
* Source words to translate in started packages: 80185
* Translated words: 17843
...
* [es_CL generated stats (2.2 kB)]({{% resource url="/f20/es_CL.csv" %}})
