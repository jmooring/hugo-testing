---
title: "es_VE-Spanish (Venezuela) (Español (Venezuela)) - translation progress for f20"
...
Language progress for Spanish (Venezuela) (es_VE) in Fedora f20 is:

* 38.56% when we only look on started packages for this language.
...
* Source words to translate in started packages: 120361
* Translated words: 46408
...
* [es_VE generated stats (1.4 kB)]({{% resource url="/f20/es_VE.csv" %}})
