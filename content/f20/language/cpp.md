---
title: "cpp- () - translation progress for f20"
...
Language progress for  (cpp) in Fedora f20 is:
...
* Source words to translate in started packages: 7508
* Translated words: 12
...
* [cpp generated stats (2.2 kB)]({{% resource url="/f20/cpp.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [kde-i18n](/f20/package/kde-i18n) | 10 | 10 | 100.0 | Chinese (traditional) <zh-l10n@linux.org.tw> | 
 ...
 | [sugar-chat](/f20/package/sugar-chat) | 0 | 52 | 0.0 | LANGUAGE <LL@li.org> | 
