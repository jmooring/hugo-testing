---
title: "bn_BD-Bangla (Bangladesh) (বাংলা (বাংলাদেশ)) - translation progress for f20"
...
Language progress for Bangla (Bangladesh) (bn_BD) in Fedora f20 is:

* 53.33% when we only look on started packages for this language.
* 0.16% when we compare to every single translatable string in Fedora f20.

Possible scripts are: Beng

* Total translatable string in Fedora f20: 12425872
* Source words to translate in started packages: 37048
* Translated words: 19757
...
* [bn_BD generated stats (1.5 kB)]({{% resource url="/f20/bn_BD.csv" %}})
