---
title: "bi-Bislama (Bislama) - translation progress for f40"
...
Language progress for Bislama (bi) in Fedora f40 is:

* 9.35% when we only look on started packages for this language.
...
* Source words to translate in started packages: 17587
...
* [bi generated stats (2.0 kB)]({{% resource url="/f40/bi.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar]({{< ref "/f40/package/sugar.md" >}}) | 1552 | 2305 | 67.3 | LANGUAGE <LL@li.org> | 
 | [sugar-toolkit-gtk3]({{< ref "/f40/package/sugar-toolkit-gtk3.md" >}}) | 76 | 213 | 35.7 | LANGUAGE <LL@li.org> | 
 | [sugar-physics]({{< ref "/f40/package/sugar-physics.md" >}}) | 5 | 48 | 10.4 | LANGUAGE <LL@li.org> | 
 | [sugar-browse]({{< ref "/f40/package/sugar-browse.md" >}}) | 4 | 334 | 1.2 | LANGUAGE <LL@li.org> | 
 | [sugar-speak]({{< ref "/f40/package/sugar-speak.md" >}}) | 2 | 227 | 0.9 | LANGUAGE <LL@li.org> | 
 | [sugar-write]({{< ref "/f40/package/sugar-write.md" >}}) | 1 | 121 | 0.8 | LANGUAGE <LL@li.org> | 
 | [sugar-calculator]({{< ref "/f40/package/sugar-calculator.md" >}}) | 3 | 866 | 0.3 | LANGUAGE <LL@li.org> | 
 ...
 | [iso-codes]({{< ref "/f40/package/iso-codes.md" >}}) | 0 | 989 | 0.0 | Bislama <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/bi/> | 
 ...
 | [sugar-implode]({{< ref "/f40/package/sugar-implode.md" >}}) | 0 | 78 | 0.0 | LANGUAGE <LL@li.org> | 
