---
title: "ba-Bashkir (Башҡорт теле) - translation progress for f40"
...
Language progress for Bashkir (ba) in Fedora f40 is:
...
* [ba generated stats (1.2 kB)]({{% resource url="/f40/ba.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [iso-codes]({{< ref "/f40/package/iso-codes.md" >}}) | 0 | 989 | 0.0 | Bashkir <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ba/> | 
