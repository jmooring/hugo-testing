---
title: "oj- () - translation progress for f40"
...
Language progress for  (oj) in Fedora f40 is:
...
* Source words to translate in started packages: 10851
* Translated words: 0
...
* [oj generated stats (1.2 kB)]({{% resource url="/f40/oj.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [stellarium]({{< ref "/f40/package/stellarium.md" >}}) | 0 | 25 | 0.0 | Ojibwe <oj@li.org> | 
