---
title: "pi- () - translation progress for f40"
...
Language progress for  (pi) in Fedora f40 is:

* 1.57% when we only look on started packages for this language.
...
* Source words to translate in started packages: 11815
...
* [pi generated stats (1.2 kB)]({{% resource url="/f40/pi.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f40/package/iso-codes.md" >}}) | 185 | 989 | 18.7 | Pali <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/pi/> | 
 ...
 | [elementary-code]({{< ref "/f40/package/elementary-code.md" >}}) | 0 | 1572 | 0.0 |  | 
 | [elementary-files]({{< ref "/f40/package/elementary-files.md" >}}) | 0 | 2538 | 0.0 |  | 
 ...
 | [elementary-music]({{< ref "/f40/package/elementary-music.md" >}}) | 0 | 207 | 0.0 |  | 
