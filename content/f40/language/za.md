---
title: "za-Zhuang (Vahcuengh) - translation progress for f40"
...
Language progress for Zhuang (za) in Fedora f40 is:

* 37.22% when we only look on started packages for this language.
...
* Source words to translate in started packages: 18663
...
* [za generated stats (1.3 kB)]({{% resource url="/f40/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f40/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
