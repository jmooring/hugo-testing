---
title: "ayc-Southern Aymara (Aymar aru) - translation progress for f40"
...
Language progress for Southern Aymara (ayc) in Fedora f40 is:

* 92.56% when we only look on started packages for this language.
...
* Source words to translate in started packages: 8410
* Translated words: 7784
...
* [ayc generated stats (2.2 kB)]({{% resource url="/f40/ayc.csv" %}})
