---
title: "ve-Venda (Tshivenḓa) - translation progress for f40"
...
Language progress for Venda (ve) in Fedora f40 is:

* 8.04% when we only look on started packages for this language.
* 0.15% when we compare to every single translatable string in Fedora f40.

Possible scripts are: Latn

* Total translatable string in Fedora f40: 20827170
* Source words to translate in started packages: 384084
* Translated words: 30885
...
* [ve generated stats (1.6 kB)]({{% resource url="/f40/ve.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [koffice-kivio]({{< ref "/f40/package/koffice-kivio.md" >}}) | 1896 | 8417 | 22.5 | <en@li.org> | 
 | [libreoffice]({{< ref "/f40/package/libreoffice.md" >}}) | 28624 | 171085 | 16.7 | LANGUAGE <LL@li.org> | 
 | [iso-codes]({{< ref "/f40/package/iso-codes.md" >}}) | 318 | 22789 | 1.4 | Venda <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ve/> | 
 | [calibre]({{< ref "/f40/package/calibre.md" >}}) | 47 | 170967 | 0.0 | Venda (http://www.transifex.com/calibre/calibre/language/ve/) | 
