---
title: "sn-Shona (ChiShona) - translation progress for f40"
...
Language progress for Shona (sn) in Fedora f40 is:
...
* Source words to translate in started packages: 11712
* Translated words: 0
...
* [sn generated stats (1.2 kB)]({{% resource url="/f40/sn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [cinnamon-translations]({{< ref "/f40/package/cinnamon-translations.md" >}}) | 0 | 886 | 0.0 | Shona <sn@li.org> | 
