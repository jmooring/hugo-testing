---
title: "tn-Tswana (Setswana) - translation progress for f40"
...
Language progress for Tswana (tn) in Fedora f40 is:

* 11.82% when we only look on started packages for this language.
* 0.10% when we compare to every single translatable string in Fedora f40.

Possible scripts are: Latn

* Total translatable string in Fedora f40: 20827170
* Source words to translate in started packages: 182228
* Translated words: 21544
...
* [tn generated stats (1.3 kB)]({{% resource url="/f40/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f40/package/libreoffice.md" >}}) | 21544 | 171085 | 12.6 | LANGUAGE <LL@li.org> | 
