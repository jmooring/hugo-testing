---
title: "iu-Inuktitut (ᐃᓄᒃᑎᑐᑦ) - translation progress for f40"
...
Language progress for Inuktitut (iu) in Fedora f40 is:
...
* Source words to translate in started packages: 16767
* Translated words: 32
...
* [iu generated stats (1.4 kB)]({{% resource url="/f40/iu.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f40/package/iso-codes.md" >}}) | 32 | 989 | 3.2 | Inuktitut <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/iu/> | 
 | [bookworm]({{< ref "/f40/package/bookworm.md" >}}) | 0 | 795 | 0.0 |  | 
 | [coin]({{< ref "/f40/package/coin.md" >}}) | 0 | 252 | 0.0 | none | 
 | [deluge]({{< ref "/f40/package/deluge.md" >}}) | 0 | 4340 | 0.0 | Inuktitut <iu@li.org> | 
 ...
 | [gnome-do]({{< ref "/f40/package/gnome-do.md" >}}) | 0 | 612 | 0.0 | Inuktitut <iu@li.org> | 
