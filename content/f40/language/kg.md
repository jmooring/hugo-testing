---
title: "kg-Kongo (Kongo) - translation progress for f40"
...
Language progress for Kongo (kg) in Fedora f40 is:

* 30.18% when we only look on started packages for this language.
* 0.07% when we compare to every single translatable string in Fedora f40.

Possible scripts are: Latn

* Total translatable string in Fedora f40: 20827170
* Source words to translate in started packages: 46108
* Translated words: 13916
...
* [kg generated stats (2.0 kB)]({{% resource url="/f40/kg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [alacarte]({{< ref "/f40/package/alacarte.md" >}}) | 74 | 74 | 100.0 | Kikongo <lundombe01@zaya-dio.com> | 
 | [bzflag]({{< ref "/f40/package/bzflag.md" >}}) | 97 | 97 | 100.0 |  | 
 | [gnome-desktop3]({{< ref "/f40/package/gnome-desktop3.md" >}}) | 384 | 384 | 100.0 | Kikongo, kg <lundombe01@zaya-dio.com> | 
 | [gnome-menus]({{< ref "/f40/package/gnome-menus.md" >}}) | 125 | 125 | 100.0 | Kikongo <lundombe01@zaya-dio.com> | 
 | [xdg-user-dirs-gtk]({{< ref "/f40/package/xdg-user-dirs-gtk.md" >}}) | 81 | 81 | 100.0 | kikongo <lundombe01@zaya-dio.com> | 
 | [cinnamon-desktop]({{< ref "/f40/package/cinnamon-desktop.md" >}}) | 205 | 231 | 88.7 | Kikongo, kg <lundombe01@zaya-dio.com> | 
 | [gtk4]({{< ref "/f40/package/gtk4.md" >}}) | 3230 | 3862 | 83.6 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [mingw-gtk4]({{< ref "/f40/package/mingw-gtk4.md" >}}) | 3230 | 3862 | 83.6 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [gtk3]({{< ref "/f40/package/gtk3.md" >}}) | 3245 | 13283 | 24.4 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [mingw-gtk3]({{< ref "/f40/package/mingw-gtk3.md" >}}) | 3245 | 13283 | 24.4 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
...
|---------|--------------------------|-------------|------|
 | [bzflag]({{< ref "/f40/package/bzflag.md" >}}) | /mnt/stockage/packages/f40/bzflag/data/l10n/bzflag_kg.po | error-os |  | 
{.sortable}
