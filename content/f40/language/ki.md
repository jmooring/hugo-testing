---
title: "ki-Kikuyu (Gikuyu) - translation progress for f40"
...
Language progress for Kikuyu (ki) in Fedora f40 is:
...
* [ki generated stats (1.3 kB)]({{% resource url="/f40/ki.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f40/package/iso-codes.md" >}}) | 144 | 989 | 14.6 | Gikuyu <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ki/> | 
