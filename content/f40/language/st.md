---
title: "st-Southern Sotho (Sesotho) - translation progress for f40"
...
Language progress for Southern Sotho (st) in Fedora f40 is:

* 15.47% when we only look on started packages for this language.
* 0.14% when we compare to every single translatable string in Fedora f40.

Possible scripts are: Latn

* Total translatable string in Fedora f40: 20827170
* Source words to translate in started packages: 185049
* Translated words: 28632
...
* [st generated stats (1.5 kB)]({{% resource url="/f40/st.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkspell3](/f40/package/gtkspell3) | 8 | 16 | 50.0 | Sotho <info@mosekolatranslation.co.za> | 
 | [libreoffice](/f40/package/libreoffice) | 28618 | 171085 | 16.7 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar](/f40/package/sugar) | 0 | 2305 | 0.0 | LANGUAGE <LL@li.org> | 
