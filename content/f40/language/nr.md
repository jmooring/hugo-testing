---
title: "nr-South Ndebele (isiNdebele) - translation progress for f40"
...
Language progress for South Ndebele (nr) in Fedora f40 is:

* 15.61% when we only look on started packages for this language.
...
* Source words to translate in started packages: 181911
* Translated words: 28392
...
* [nr generated stats (1.2 kB)]({{% resource url="/f40/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f40/package/libreoffice.md" >}}) | 28392 | 171085 | 16.6 | LANGUAGE <LL@li.org> | 
