---
title: "nv-Navajo (Diné Bizaad) - translation progress for f40"
...
Language progress for Navajo (nv) in Fedora f40 is:
...
* [nv generated stats (1.2 kB)]({{% resource url="/f40/nv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f40/package/iso-codes.md" >}}) | 110 | 989 | 11.1 | Navaho <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/nv/> | 
