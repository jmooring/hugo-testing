---
title: "xh-Xhosa (IsiXhosa) - translation progress for f40"
...
Language progress for Xhosa (xh) in Fedora f40 is:

* 18.77% when we only look on started packages for this language.
* 1.10% when we compare to every single translatable string in Fedora f40.

Possible scripts are: Latn

* Total translatable string in Fedora f40: 20827170
* Source words to translate in started packages: 1218107
* Translated words: 228620
...
* [xh generated stats (27.9 kB)]({{% resource url="/f40/xh.csv" %}})
