---
title: "ss-Swati (siSwati) - translation progress for f40"
...
Language progress for Swati (ss) in Fedora f40 is:

* 15.90% when we only look on started packages for this language.
...
* [ss generated stats (1.2 kB)]({{% resource url="/f40/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f40/package/libreoffice.md" >}}) | 28922 | 171085 | 16.9 | LANGUAGE <LL@li.org> | 
