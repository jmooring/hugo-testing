---
title: "kv-Komi (Коми кыв) - translation progress for f40"
...
Language progress for Komi (kv) in Fedora f40 is:

* 5.50% when we only look on started packages for this language.
...
* Source words to translate in started packages: 21491
...
* [kv generated stats (1.4 kB)]({{% resource url="/f40/kv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes](/f40/package/iso-codes) | 132 | 989 | 13.3 | Komi <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/kv/> | 
 | [minetest](/f40/package/minetest) | 1049 | 9676 | 10.8 | Komi <https://hosted.weblate.org/projects/minetest/minetest/kv/> | 
