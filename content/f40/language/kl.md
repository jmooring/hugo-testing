---
title: "kl-Kalaallisut (Kalaallisut) - translation progress for f40"
...
Language progress for Kalaallisut (kl) in Fedora f40 is:

* 0.71% when we only look on started packages for this language.
...
* Source words to translate in started packages: 191425
* Translated words: 1368
...
* [kl generated stats (1.7 kB)]({{% resource url="/f40/kl.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [slick-greeter]({{< ref "/f40/package/slick-greeter.md" >}}) | 54 | 216 | 25.0 | Greenlandic (Kalaallisut) <kl@li.org> | 
 | [libreoffice]({{< ref "/f40/package/libreoffice.md" >}}) | 1314 | 171085 | 0.8 | LANGUAGE <LL@li.org> | 
 ...
 | [iso-codes]({{< ref "/f40/package/iso-codes.md" >}}) | 0 | 989 | 0.0 | Greenlandic <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/kl/> | 
 | [lightdm]({{< ref "/f40/package/lightdm.md" >}}) | 0 | 84 | 0.0 | Greenlandic (Kalaallisut) <kl@li.org> | 
