---
title: "bm-Bambara (Bamanakan) - translation progress for f40"
...
Language progress for Bambara (bm) in Fedora f40 is:
...
* Source words to translate in started packages: 11039
* Translated words: 23
...
* [bm generated stats (1.2 kB)]({{% resource url="/f40/bm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-toolkit-gtk3]({{< ref "/f40/package/sugar-toolkit-gtk3.md" >}}) | 23 | 213 | 10.8 | LANGUAGE <LL@li.org> | 
