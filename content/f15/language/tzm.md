---
title: "tzm-Central Atlas Tamazight (Tamaziɣt n laṭlaṣ) - translation progress for f15"
...
Language progress for Central Atlas Tamazight (tzm) in Fedora f15 is:
...
* Source words to translate in started packages: 908
* Translated words: 0
...
* [tzm generated stats (683 Bytes)]({{% resource url="/f15/tzm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [sugar-clock]({{< ref "/f15/package/sugar-clock.md" >}}) | 0 | 8 | 0.0 | LANGUAGE <LL@li.org> | 
