---
title: "ia-Interlingua (Interlingua) - translation progress for f15"
...
Language progress for Interlingua (ia) in Fedora f15 is:

* 34.99% when we only look on started packages for this language.
* 0.36% when we compare to every single translatable string in Fedora f15.

Possible scripts are: Latn

* Total translatable string in Fedora f15: 10988392
* Source words to translate in started packages: 113886
* Translated words: 39847
...
* [ia generated stats (1.2 kB)]({{% resource url="/f15/ia.csv" %}})
