---
title: "an-Aragonese (Aragonés) - translation progress for f15"
...
Language progress for Aragonese (an) in Fedora f15 is:

* 40.10% when we only look on started packages for this language.
...
* Source words to translate in started packages: 15049
* Translated words: 6035
...
* [an generated stats (1.4 kB)]({{% resource url="/f15/an.csv" %}})
