---
title: "dv-Divehi (ދިވެހިބަސް) - translation progress for f37"
...
Language progress for Divehi (dv) in Fedora f37 is:

* 5.55% when we only look on started packages for this language.
...
* Source words to translate in started packages: 16928
...
* [dv generated stats (914 Bytes)]({{% resource url="/f37/dv.csv" %}})
