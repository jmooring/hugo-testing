---
title: "nds-Low German (Neddersass’sch) - translation progress for f37"
...
territories:
 ...
 - NL
polib_error_count: 0
could_not_process_count: 1167
---

Language progress for Low German (nds) in Fedora f37 is:

* 40.79% when we only look on started packages for this language.
* 3.72% when we compare to every single translatable string in Fedora f37.

Possible scripts are: Latn

* Total translatable string in Fedora f37: 19534076
* Source words to translate in started packages: 1782611
* Translated words: 727061
...
* [nds generated stats (42.7 kB)]({{% resource url="/f37/nds.csv" %}})
