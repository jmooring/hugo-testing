---
title: "szl-Silesian (Ślōnski) - translation progress for f37"
...
Language progress for Silesian (szl) in Fedora f37 is:

* 48.26% when we only look on started packages for this language.
* 0.49% when we compare to every single translatable string in Fedora f37.

Possible scripts are: Latn

* Total translatable string in Fedora f37: 19534076
* Source words to translate in started packages: 199821
* Translated words: 96440
...
* [szl generated stats (1.3 kB)]({{% resource url="/f37/szl.csv" %}})
