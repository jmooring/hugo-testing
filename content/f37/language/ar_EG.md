---
title: "ar_EG-Arabic (Egypt) (العربية (مصر)) - translation progress for f37"
...
Language progress for Arabic (Egypt) (ar_EG) in Fedora f37 is:

* 92.71% when we only look on started packages for this language.
...
* Source words to translate in started packages: 32917
* Translated words: 30516
...
* [ar_EG generated stats (1.2 kB)]({{% resource url="/f37/ar_EG.csv" %}})
