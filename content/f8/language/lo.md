---
title: "lo-Lao (ລາວ) - translation progress for f8"
...
Language progress for Lao (lo) in Fedora f8 is:

* 0.54% when we only look on started packages for this language.
* 0.05% when we compare to every single translatable string in Fedora f8.

Possible scripts are: Laoo

* Total translatable string in Fedora f8: 3855649
* Source words to translate in started packages: 390201
* Translated words: 2099
...
* [lo generated stats (2.4 kB)]({{% resource url="/f8/lo.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [amarok]({{< ref "/f8/package/amarok.md" >}}) | 783 | 13192 | 5.9 | Korean | 
 | [system-config-netboot]({{< ref "/f8/package/system-config-netboot.md" >}}) | 10 | 1088 | 0.9 | none | 
 | [pidgin]({{< ref "/f8/package/pidgin.md" >}}) | 16 | 15654 | 0.1 | LANGUAGE <LL@li.org> | 
 ...
 | [compiz]({{< ref "/f8/package/compiz.md" >}}) | 0 | 2357 | 0.0 | Lao <i18n@suse.de> | 
 ...
 | [rhpxl]({{< ref "/f8/package/rhpxl.md" >}}) | 0 | 136 | 0.0 | none | 
 ...
 | [specspo]({{< ref "/f8/package/specspo.md" >}}) | 0 | 305286 | 0.0 | none | 
 ...
 | [system-config-date]({{< ref "/f8/package/system-config-date.md" >}}) | 0 | 997 | 0.0 | none | 
