---
title: "nv-Navajo (Diné Bizaad) - translation progress for f38"
...
Language progress for Navajo (nv) in Fedora f38 is:
...
* [nv generated stats (1.0 kB)]({{% resource url="/f38/nv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f38/package/iso-codes.md" >}}) | 110 | 989 | 11.1 | Navaho <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/nv/> | 
