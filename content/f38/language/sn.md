---
title: "sn-Shona (ChiShona) - translation progress for f38"
...
Language progress for Shona (sn) in Fedora f38 is:
...
* Source words to translate in started packages: 13450
* Translated words: 0
...
* [sn generated stats (1.0 kB)]({{% resource url="/f38/sn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [cinnamon-translations]({{< ref "/f38/package/cinnamon-translations.md" >}}) | 0 | 886 | 0.0 | Shona <sn@li.org> | 
 ...
 | [onboard]({{< ref "/f38/package/onboard.md" >}}) | 0 | 2318 | 0.0 | Shona <sn@li.org> | 
