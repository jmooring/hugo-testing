---
title: "tn-Tswana (Setswana) - translation progress for f38"
...
Language progress for Tswana (tn) in Fedora f38 is:

* 12.15% when we only look on started packages for this language.
* 0.11% when we compare to every single translatable string in Fedora f38.

Possible scripts are: Latn

* Total translatable string in Fedora f38: 20287117
* Source words to translate in started packages: 179498
* Translated words: 21807
...
* [tn generated stats (1.1 kB)]({{% resource url="/f38/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f38/package/libreoffice.md" >}}) | 21807 | 168935 | 12.9 | LANGUAGE <LL@li.org> | 
