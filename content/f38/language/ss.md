---
title: "ss-Swati (siSwati) - translation progress for f38"
...
Language progress for Swati (ss) in Fedora f38 is:
...
* Source words to translate in started packages: 179181
* Translated words: 29212
...
* [ss generated stats (1.0 kB)]({{% resource url="/f38/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f38/package/libreoffice.md" >}}) | 29212 | 168935 | 17.3 | LANGUAGE <LL@li.org> | 
