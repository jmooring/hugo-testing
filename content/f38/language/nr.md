---
title: "nr-South Ndebele (isiNdebele) - translation progress for f38"
...
Language progress for South Ndebele (nr) in Fedora f38 is:

* 15.87% when we only look on started packages for this language.
* 0.14% when we compare to every single translatable string in Fedora f38.

Possible scripts are: Latn

* Total translatable string in Fedora f38: 20287117
* Source words to translate in started packages: 182944
* Translated words: 29027
...
* [nr generated stats (1.1 kB)]({{% resource url="/f38/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f38/package/libreoffice.md" >}}) | 28674 | 168935 | 17.0 | LANGUAGE <LL@li.org> | 
 | [tuxpaint]({{< ref "/f38/package/tuxpaint.md" >}}) | 353 | 3763 | 9.4 | LANGUAGE <LL@li.org> | 
