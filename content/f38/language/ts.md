---
title: "ts-Tsonga (Xitsonga) - translation progress for f38"
...
Language progress for Tsonga (ts) in Fedora f38 is:

* 15.60% when we only look on started packages for this language.
...
* Source words to translate in started packages: 196229
* Translated words: 30620
...
* [ts generated stats (2.0 kB)]({{% resource url="/f38/ts.csv" %}})
