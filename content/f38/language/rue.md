---
title: "rue- () - translation progress for f38"
...
Language progress for  (rue) in Fedora f38 is:

* 33.02% when we only look on started packages for this language.
* 0.05% when we compare to every single translatable string in Fedora f38.

Possible scripts are: 

* Total translatable string in Fedora f38: 20287117
* Source words to translate in started packages: 27710
* Translated words: 9151
...
* [rue generated stats (1.2 kB)]({{% resource url="/f38/rue.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [folder-color-switcher]({{< ref "/f38/package/folder-color-switcher.md" >}}) | 65 | 65 | 100.0 | Rusyn <rue@li.org> | 
 | [cinnamon-translations]({{< ref "/f38/package/cinnamon-translations.md" >}}) | 8999 | 17337 | 51.9 | Rusyn <rue@li.org> | 
 | [elementary-code]({{< ref "/f38/package/elementary-code.md" >}}) | 82 | 1614 | 5.1 | Rusyn <rue@li.org> | 
 | [granite]({{< ref "/f38/package/granite.md" >}}) | 5 | 498 | 1.0 | Rusyn <rue@li.org> | 
 ...
 | [granite-7]({{< ref "/f38/package/granite-7.md" >}}) | 0 | 300 | 0.0 | Rusyn <rue@li.org> | 
