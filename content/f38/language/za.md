---
title: "za-Zhuang (Vahcuengh) - translation progress for f38"
...
Language progress for Zhuang (za) in Fedora f38 is:

* 38.41% when we only look on started packages for this language.
...
* Source words to translate in started packages: 18083
...
* [za generated stats (1.0 kB)]({{% resource url="/f38/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f38/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
