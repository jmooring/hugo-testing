---
title: "oj- () - translation progress for f38"
...
Language progress for  (oj) in Fedora f38 is:
...
* Source words to translate in started packages: 14038
...
* [oj generated stats (1.0 kB)]({{% resource url="/f38/oj.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f38/package/tuxpaint.md" >}}) | 176 | 3763 | 4.7 | Ed <edm@rocketmail.com> | 
 ...
 | [stellarium]({{< ref "/f38/package/stellarium.md" >}}) | 0 | 29 | 0.0 | Ojibwe <oj@li.org> | 
