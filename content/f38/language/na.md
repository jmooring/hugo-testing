---
title: "na-Nauru (Dorerin Naoero) - translation progress for f38"
...
Language progress for Nauru (na) in Fedora f38 is:
...
* Source words to translate in started packages: 11515
...
* [na generated stats (1.2 kB)]({{% resource url="/f38/na.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f38/package/iso-codes.md" >}}) | 186 | 989 | 18.8 | Nauru <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/na/> | 
 | [sugar-chat]({{< ref "/f38/package/sugar-chat.md" >}}) | 24 | 137 | 17.5 | LANGUAGE <LL@li.org> | 
