---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f38"
...
Language progress for Chamorro (ch) in Fedora f38 is:
...
* [ch generated stats (1.0 kB)]({{% resource url="/f38/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f38/package/iso-codes.md" >}}) | 30 | 989 | 3.0 | Chamorro <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ch/> | 
