---
title: "na-Nauru (Dorerin Naoero) - translation progress for f24"
...
Language progress for Nauru (na) in Fedora f24 is:

* 0.11% when we only look on started packages for this language.
...
* Source words to translate in started packages: 28515
* Translated words: 32
...
* [na generated stats (1.9 kB)]({{% resource url="/f24/na.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-chat]({{< ref "/f24/package/sugar-chat.md" >}}) | 24 | 137 | 17.5 | LANGUAGE <LL@li.org> | 
 | [stellarium]({{< ref "/f24/package/stellarium.md" >}}) | 8 | 23532 | 0.0 | Nauru <na@li.org> | 
