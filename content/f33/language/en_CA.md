---
title: "en_CA-English (Canada) (English (Canada)) - translation progress for f33"
...
territories:
 - CA
polib_error_count: 0
could_not_process_count: 449
---

Language progress for English (Canada) (en_CA) in Fedora f33 is:

* 39.73% when we only look on started packages for this language.
* 2.61% when we compare to every single translatable string in Fedora f33.

Possible scripts are: Latn

* Total translatable string in Fedora f33: 16986782
* Source words to translate in started packages: 1114481
* Translated words: 442818
...
* [en_CA generated stats (29.4 kB)]({{% resource url="/f33/en_CA.csv" %}})
