---
title: "ps-Pashto (پښتو) - translation progress for f9"
...
Language progress for Pashto (ps) in Fedora f9 is:

* 27.26% when we only look on started packages for this language.
* 0.29% when we compare to every single translatable string in Fedora f9.

Possible scripts are: Arab

* Total translatable string in Fedora f9: 4102915
* Source words to translate in started packages: 44057
* Translated words: 12008
...
* [ps generated stats (948 Bytes)]({{% resource url="/f9/ps.csv" %}})
