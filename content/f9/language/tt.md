---
title: "tt-Tatar (Татар) - translation progress for f9"
...
Language progress for Tatar (tt) in Fedora f9 is:

* 14.28% when we only look on started packages for this language.
* 0.19% when we compare to every single translatable string in Fedora f9.

Possible scripts are: CyrlLatn

* Total translatable string in Fedora f9: 4102915
* Source words to translate in started packages: 55359
* Translated words: 7903
...
* [tt generated stats (1.1 kB)]({{% resource url="/f9/tt.csv" %}})
