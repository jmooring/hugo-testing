---
title: "mai-Maithili (मैथिली) - translation progress for f9"
...
Language progress for Maithili (mai) in Fedora f9 is:

* 70.94% when we only look on started packages for this language.
* 0.40% when we compare to every single translatable string in Fedora f9.

Possible scripts are: DevaTirh

* Total translatable string in Fedora f9: 4102915
* Source words to translate in started packages: 22901
* Translated words: 16247
...
* [mai generated stats (1.2 kB)]({{% resource url="/f9/mai.csv" %}})
