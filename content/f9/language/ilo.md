---
title: "ilo-Iloko (Ti Pagsasao nga Iloco) - translation progress for f9"
...
Language progress for Iloko (ilo) in Fedora f9 is:

* 1.97% when we only look on started packages for this language.
* 0.15% when we compare to every single translatable string in Fedora f9.

Possible scripts are: Latn

* Total translatable string in Fedora f9: 4102915
* Source words to translate in started packages: 321963
* Translated words: 6358
...
* [ilo generated stats (903 Bytes)]({{% resource url="/f9/ilo.csv" %}})
