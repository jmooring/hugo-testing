---
title: "ss-Swati (siSwati) - translation progress for f27"
...
territories:
 ...
 - ZA
polib_error_count: 0
could_not_process_count: 332
---

Language progress for Swati (ss) in Fedora f27 is:

* 25.88% when we only look on started packages for this language.
* 0.19% when we compare to every single translatable string in Fedora f27.

Possible scripts are: Latn

* Total translatable string in Fedora f27: 14971951
* Source words to translate in started packages: 110734
* Translated words: 28663
...
* [ss generated stats (2.6 kB)]({{% resource url="/f27/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f27/package/libreoffice.md" >}}) | 28663 | 96541 | 29.7 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Swati <ss@li.org> | 
