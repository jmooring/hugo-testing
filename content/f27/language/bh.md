---
title: "bh- () - translation progress for f27"
...
Language progress for  (bh) in Fedora f27 is:
...
* [bh generated stats (2.6 kB)]({{% resource url="/f27/bh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f27/package/stellarium.md" >}}) | 2 | 26769 | 0.0 | Bihari <bh@li.org> | 
