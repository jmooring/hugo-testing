---
title: "ng-Ndonga (Ndonga) - translation progress for f27"
...
Language progress for Ndonga (ng) in Fedora f27 is:

* 3.98% when we only look on started packages for this language.
...
* Source words to translate in started packages: 14781
* Translated words: 588
...
* [ng generated stats (2.6 kB)]({{% resource url="/f27/ng.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [aircrack-ng]({{< ref "/f27/package/aircrack-ng.md" >}}) | 588 | 588 | 100.0 |  | 
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Ndonga <ng@li.org> | 
