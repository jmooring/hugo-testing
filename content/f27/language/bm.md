---
title: "bm-Bambara (Bamanakan) - translation progress for f27"
...
Language progress for Bambara (bm) in Fedora f27 is:

* 9.64% when we only look on started packages for this language.
...
* Source words to translate in started packages: 15708
* Translated words: 1515
...
* [bm generated stats (2.6 kB)]({{% resource url="/f27/bm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f27/package/tuxpaint.md" >}}) | 1515 | 1515 | 100.0 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Bambara <bm@li.org> | 
