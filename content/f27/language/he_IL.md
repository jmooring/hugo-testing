---
title: "he_IL-Hebrew (Israel) (עברית (ישראל)) - translation progress for f27"
...
Language progress for Hebrew (Israel) (he_IL) in Fedora f27 is:

* 54.49% when we only look on started packages for this language.
...
* Source words to translate in started packages: 37539
...
* [he_IL generated stats (1.1 kB)]({{% resource url="/f27/he_IL.csv" %}})
