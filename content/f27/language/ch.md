---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f27"
...
Language progress for Chamorro (ch) in Fedora f27 is:
...
* [ch generated stats (2.6 kB)]({{% resource url="/f27/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chamorro <ch@li.org> | 
