---
title: "nr-South Ndebele (isiNdebele) - translation progress for f27"
...
Language progress for South Ndebele (nr) in Fedora f27 is:

* 25.89% when we only look on started packages for this language.
...
* Source words to translate in started packages: 112341
* Translated words: 29081
...
* [nr generated stats (2.7 kB)]({{% resource url="/f27/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [libreoffice]({{< ref "/f27/package/libreoffice.md" >}}) | 28606 | 96525 | 29.6 | LANGUAGE <LL@li.org> | 
