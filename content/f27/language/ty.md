---
title: "ty-Tahitian (Reo Tahiti) - translation progress for f27"
...
Language progress for Tahitian (ty) in Fedora f27 is:
...
* [ty generated stats (2.6 kB)]({{% resource url="/f27/ty.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Tahitian <ty@li.org> | 
