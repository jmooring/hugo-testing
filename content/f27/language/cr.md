---
title: "cr- () - translation progress for f27"
...
Language progress for  (cr) in Fedora f27 is:
...
* [cr generated stats (2.5 kB)]({{% resource url="/f27/cr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Cree <cr@li.org> | 
