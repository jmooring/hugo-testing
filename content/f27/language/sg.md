---
title: "sg-Sango (Sängö) - translation progress for f27"
...
Language progress for Sango (sg) in Fedora f27 is:
...
* [sg generated stats (2.5 kB)]({{% resource url="/f27/sg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Sango <sg@li.org> | 
