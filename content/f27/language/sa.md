---
title: "sa-Sanskrit (संस्कृत भाषा) - translation progress for f27"
...
Language progress for Sanskrit (sa) in Fedora f27 is:

* 49.23% when we only look on started packages for this language.
* 0.52% when we compare to every single translatable string in Fedora f27.

Possible scripts are: DevaSinhSiddShrdNewaGranBhks

* Total translatable string in Fedora f27: 14971951
* Source words to translate in started packages: 159302
* Translated words: 78424
...
* [sa generated stats (3.1 kB)]({{% resource url="/f27/sa.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f27/package/tuxpaint.md" >}}) | 1515 | 1515 | 100.0 |  | 
 | [inkscape]({{< ref "/f27/package/inkscape.md" >}}) | 23515 | 38214 | 61.5 | Hindi <Indlinux> | 
 | [libreoffice]({{< ref "/f27/package/libreoffice.md" >}}) | 53320 | 96532 | 55.2 | LANGUAGE <LL@li.org> | 
 | [slick-greeter]({{< ref "/f27/package/slick-greeter.md" >}}) | 66 | 211 | 31.3 | Sanskrit <sa@li.org> | 
 | [onboard]({{< ref "/f27/package/onboard.md" >}}) | 7 | 2318 | 0.3 | Sanskrit <sa@li.org> | 
 | [cinnamon-translations]({{< ref "/f27/package/cinnamon-translations.md" >}}) | 1 | 6081 | 0.0 | Sanskrit <sa@li.org> | 
 ...
 | [iok]({{< ref "/f27/package/iok.md" >}}) | 0 | 206 | 0.0 | Sanskrit <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | LANGUAGE <LL@li.org> | 
