---
title: "ny-Nyanja (Nyanja) - translation progress for f27"
...
Language progress for Nyanja (ny) in Fedora f27 is:
...
* [ny generated stats (2.6 kB)]({{% resource url="/f27/ny.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chewa; Chichewa; Nyanja <ny@li.org> | 
