---
title: "na-Nauru (Dorerin Naoero) - translation progress for f27"
...
Language progress for Nauru (na) in Fedora f27 is:

* 0.07% when we only look on started packages for this language.
...
* Source words to translate in started packages: 46081
* Translated words: 30
...
* [na generated stats (4.4 kB)]({{% resource url="/f27/na.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-chat]({{< ref "/f27/package/sugar-chat.md" >}}) | 24 | 137 | 17.5 | LANGUAGE <LL@li.org> | 
 | [stellarium]({{< ref "/f27/package/stellarium.md" >}}) | 6 | 26769 | 0.0 | Nauru <na@li.org> | 
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Nauru <na@li.org> | 
