---
title: "za-Zhuang (Vahcuengh) - translation progress for f27"
...
Language progress for Zhuang (za) in Fedora f27 is:

* 31.99% when we only look on started packages for this language.
...
* Source words to translate in started packages: 21713
...
* [za generated stats (2.6 kB)]({{% resource url="/f27/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f27/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
