---
title: "mh-Marshallese (Kajin M̧ajeļ) - translation progress for f27"
...
Language progress for Marshallese (mh) in Fedora f27 is:
...
* [mh generated stats (2.6 kB)]({{% resource url="/f27/mh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Marshallese <mh@li.org> | 
