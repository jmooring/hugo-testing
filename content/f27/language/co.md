---
title: "co-Corsican (Corsu) - translation progress for f27"
...
Language progress for Corsican (co) in Fedora f27 is:

* 45.22% when we only look on started packages for this language.
* 0.08% when we compare to every single translatable string in Fedora f27.

Possible scripts are: Latn

* Total translatable string in Fedora f27: 14971951
* Source words to translate in started packages: 27028
* Translated words: 12221
...
* [co generated stats (2.8 kB)]({{% resource url="/f27/co.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [filezilla]({{< ref "/f27/package/filezilla.md" >}}) | 10075 | 10112 | 99.6 | Patriccollu di Santa Maria è Sichè <Patrick.Santa-Maria[AT]laposte.net> | 
 | [poedit]({{< ref "/f27/package/poedit.md" >}}) | 2146 | 2639 | 81.3 | Corsican | 
 ...
 | [lightdm]({{< ref "/f27/package/lightdm.md" >}}) | 0 | 84 | 0.0 | Corsican <co@li.org> | 
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Corsican <co@li.org> | 
