---
title: "tn-Tswana (Setswana) - translation progress for f27"
...
Language progress for Tswana (tn) in Fedora f27 is:

* 18.53% when we only look on started packages for this language.
* 0.14% when we compare to every single translatable string in Fedora f27.
...
* [tn generated stats (2.7 kB)]({{% resource url="/f27/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f27/package/libreoffice.md" >}}) | 20521 | 96536 | 21.3 | LANGUAGE <LL@li.org> | 
