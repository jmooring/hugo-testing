---
title: "rn-Rundi (Ikirundi) - translation progress for f27"
...
Language progress for Rundi (rn) in Fedora f27 is:
...
* [rn generated stats (2.6 kB)]({{% resource url="/f27/rn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f27/package/vocal.md" >}}) | 0 | 377 | 0.0 | Rundi <rn@li.org> | 
