---
title: "en_AU-English (Australia) (English (Australia)) - translation progress for f7"
date: 2026-01-17T07:12:31+00:00
code: en_AU
...
Language progress for English (Australia) (en_AU) in Fedora f7 is:

* 21.90% when we only look on started packages for this language.
* 0.46% when we compare to every single translatable string in Fedora f7.

Possible scripts are: Latn

* Total translatable string in Fedora f7: 3457836
* Source words to translate in started packages: 73078
* Translated words: 16004
...
* [en_AU generated stats (1.6 kB)]({{% resource url="/f7/en_AU.csv" %}})
