---
title: "ss-Swati (siSwati) - translation progress for f42"
...
Language progress for Swati (ss) in Fedora f42 is:

* 15.30% when we only look on started packages for this language.
...
* Source words to translate in started packages: 189739
* Translated words: 29023
...
* [ss generated stats (1.3 kB)]({{% resource url="/f42/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f42/package/libreoffice.md" >}}) | 29023 | 175879 | 16.5 | LANGUAGE <LL@li.org> | 
