---
title: "to-Tongan (Lea fakatonga) - translation progress for f42"
...
Language progress for Tongan (to) in Fedora f42 is:

* 1.77% when we only look on started packages for this language.
...
* Source words to translate in started packages: 18242
...
* [to generated stats (2.1 kB)]({{% resource url="/f42/to.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-distance]({{< ref "/f42/package/sugar-distance.md" >}}) | 70 | 99 | 70.7 | LANGUAGE <LL@li.org> | 
 | [sugar-toolkit-gtk3]({{< ref "/f42/package/sugar-toolkit-gtk3.md" >}}) | 120 | 213 | 56.3 | LANGUAGE <LL@li.org> | 
 | [sugar-abacus]({{< ref "/f42/package/sugar-abacus.md" >}}) | 11 | 28 | 39.3 | LANGUAGE <LL@li.org> | 
 | [sugar-pippy]({{< ref "/f42/package/sugar-pippy.md" >}}) | 48 | 274 | 17.5 | LANGUAGE <LL@li.org> | 
 | [sugar]({{< ref "/f42/package/sugar.md" >}}) | 71 | 2305 | 3.1 | LANGUAGE <LL@li.org> | 
 | [sugar-memorize]({{< ref "/f42/package/sugar-memorize.md" >}}) | 1 | 142 | 0.7 | LANGUAGE <LL@li.org> | 
 | [sugar-finance]({{< ref "/f42/package/sugar-finance.md" >}}) | 1 | 258 | 0.4 | LANGUAGE <LL@li.org> | 
 | [sugar-browse]({{< ref "/f42/package/sugar-browse.md" >}}) | 1 | 334 | 0.3 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-physics]({{< ref "/f42/package/sugar-physics.md" >}}) | 0 | 48 | 0.0 | LANGUAGE <LL@li.org> | 
