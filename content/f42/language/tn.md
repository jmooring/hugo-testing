---
title: "tn-Tswana (Setswana) - translation progress for f42"
...
Language progress for Tswana (tn) in Fedora f42 is:

* 11.41% when we only look on started packages for this language.
...
* Source words to translate in started packages: 190056
* Translated words: 21677
...
* [tn generated stats (1.3 kB)]({{% resource url="/f42/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f42/package/libreoffice.md" >}}) | 21677 | 175879 | 12.3 | LANGUAGE <LL@li.org> | 
