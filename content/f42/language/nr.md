---
title: "nr-South Ndebele (isiNdebele) - translation progress for f42"
...
Language progress for South Ndebele (nr) in Fedora f42 is:

* 14.78% when we only look on started packages for this language.
...
* Source words to translate in started packages: 195094
* Translated words: 28844
...
* [nr generated stats (1.4 kB)]({{% resource url="/f42/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f42/package/libreoffice.md" >}}) | 28498 | 175879 | 16.2 | LANGUAGE <LL@li.org> | 
 | [tuxpaint]({{< ref "/f42/package/tuxpaint.md" >}}) | 346 | 5355 | 6.5 | LANGUAGE <LL@li.org> | 
