---
title: "st-Southern Sotho (Sesotho) - translation progress for f42"
...
Language progress for Southern Sotho (st) in Fedora f42 is:

* 14.90% when we only look on started packages for this language.
* 0.13% when we compare to every single translatable string in Fedora f42.

Possible scripts are: Latn

* Total translatable string in Fedora f42: 21856334
* Source words to translate in started packages: 192877
* Translated words: 28732
...
* [st generated stats (1.6 kB)]({{% resource url="/f42/st.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkspell3]({{< ref "/f42/package/gtkspell3.md" >}}) | 8 | 16 | 50.0 | Sotho <info@mosekolatranslation.co.za> | 
 | [libreoffice]({{< ref "/f42/package/libreoffice.md" >}}) | 28718 | 175879 | 16.3 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar]({{< ref "/f42/package/sugar.md" >}}) | 0 | 2305 | 0.0 | LANGUAGE <LL@li.org> | 
