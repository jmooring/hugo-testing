---
title: "za-Zhuang (Vahcuengh) - translation progress for f42"
...
Language progress for Zhuang (za) in Fedora f42 is:
...
* Source words to translate in started packages: 21697
...
* [za generated stats (1.3 kB)]({{% resource url="/f42/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f42/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
