---
title: "gd-Scottish Gaelic (Gàidhlig) - translation progress for f42"
...
Language progress for Scottish Gaelic (gd) in Fedora f42 is:

* 38.07% when we only look on started packages for this language.
* 2.53% when we compare to every single translatable string in Fedora f42.

Possible scripts are: Latn

* Total translatable string in Fedora f42: 21856334
* Source words to translate in started packages: 1454364
* Translated words: 553727
...
* [gd generated stats (18.3 kB)]({{% resource url="/f42/gd.csv" %}})
