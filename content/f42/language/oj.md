---
title: "oj- () - translation progress for f42"
...
Language progress for  (oj) in Fedora f42 is:
...
* Source words to translate in started packages: 19240
...
* [oj generated stats (1.3 kB)]({{% resource url="/f42/oj.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f42/package/tuxpaint.md" >}}) | 176 | 5355 | 3.3 | Ed <edm@rocketmail.com> | 
 ...
 | [stellarium]({{< ref "/f42/package/stellarium.md" >}}) | 0 | 25 | 0.0 | Ojibwe <oj@li.org> | 
