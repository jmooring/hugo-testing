---
title: "nv-Navajo (Diné Bizaad) - translation progress for f42"
...
Language progress for Navajo (nv) in Fedora f42 is:
...
* [nv generated stats (1.3 kB)]({{% resource url="/f42/nv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f42/package/iso-codes.md" >}}) | 110 | 989 | 11.1 | Navaho <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/nv/> | 
