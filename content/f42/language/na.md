---
title: "na-Nauru (Dorerin Naoero) - translation progress for f42"
...
Language progress for Nauru (na) in Fedora f42 is:
...
* Source words to translate in started packages: 15129
...
* [na generated stats (1.5 kB)]({{% resource url="/f42/na.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f42/package/iso-codes.md" >}}) | 186 | 989 | 18.8 | Nauru <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/na/> | 
