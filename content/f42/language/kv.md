---
title: "kv-Komi (Коми кыв) - translation progress for f42"
...
Language progress for Komi (kv) in Fedora f42 is:

* 4.37% when we only look on started packages for this language.
...
* Source words to translate in started packages: 25301
...
* [kv generated stats (1.4 kB)]({{% resource url="/f42/kv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f42/package/iso-codes.md" >}}) | 132 | 989 | 13.3 | Komi <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/kv/> | 
 | [minetest]({{< ref "/f42/package/minetest.md" >}}) | 974 | 10452 | 9.3 | Komi <https://hosted.weblate.org/projects/minetest/minetest/kv/> | 
