---
title: "aa-Afar (Qafar) - translation progress for f42"
...
Language progress for Afar (aa) in Fedora f42 is:
...
* Source words to translate in started packages: 21736
...
* [aa generated stats (1.4 kB)]({{% resource url="/f42/aa.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [folder-color-switcher]({{< ref "/f42/package/folder-color-switcher.md" >}}) | 42 | 65 | 64.6 | Afar <aa@li.org> | 
 | [maliit-keyboard]({{< ref "/f42/package/maliit-keyboard.md" >}}) | 31 | 81 | 38.3 | Afar <aa@li.org> | 
 | [cinnamon-translations]({{< ref "/f42/package/cinnamon-translations.md" >}}) | 164 | 7730 | 2.1 | Afar <aa@li.org> | 
 | [bookworm]({{< ref "/f42/package/bookworm.md" >}}) | 0 | 795 | 0.0 | Afar | 
