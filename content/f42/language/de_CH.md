---
title: "de_CH-German (Switzerland) (Deutsch (Schweiz)) - translation progress for f42"
...
Language progress for German (Switzerland) (de_CH) in Fedora f42 is:

* 29.23% when we only look on started packages for this language.
* 0.08% when we compare to every single translatable string in Fedora f42.

Possible scripts are: Latn

* Total translatable string in Fedora f42: 21856334
* Source words to translate in started packages: 56889
* Translated words: 16629
...
* [de_CH generated stats (3.1 kB)]({{% resource url="/f42/de_CH.csv" %}})
