---
title: "bm-Bambara (Bamanakan) - translation progress for f42"
...
Language progress for Bambara (bm) in Fedora f42 is:

* 21.60% when we only look on started packages for this language.
...
* Source words to translate in started packages: 24938
* Translated words: 5386
...
* [bm generated stats (1.4 kB)]({{% resource url="/f42/bm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [abiword]({{< ref "/f42/package/abiword.md" >}}) | 4251 | 5510 | 77.2 | LANGUAGE <LL@li.org> | 
 | [tuxpaint]({{< ref "/f42/package/tuxpaint.md" >}}) | 1112 | 5355 | 20.8 | LANGUAGE <LL@li.org> | 
 | [sugar-toolkit-gtk3]({{< ref "/f42/package/sugar-toolkit-gtk3.md" >}}) | 23 | 213 | 10.8 | LANGUAGE <LL@li.org> | 
