---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f42"
...
Language progress for Chamorro (ch) in Fedora f42 is:
...
* [ch generated stats (1.3 kB)]({{% resource url="/f42/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f42/package/iso-codes.md" >}}) | 30 | 989 | 3.0 | Chamorro <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ch/> | 
