---
title: "ss-Swati (siSwati) - translation progress for f35"
...
Language progress for Swati (ss) in Fedora f35 is:

* 15.71% when we only look on started packages for this language.
...
* Source words to translate in started packages: 190128
* Translated words: 29864
...
* [ss generated stats (3.1 kB)]({{% resource url="/f35/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f35/package/libreoffice.md" >}}) | 29864 | 165978 | 18.0 | LANGUAGE <LL@li.org> | 
