---
title: "sm-Samoan (Gagana faʻa Sāmoa) - translation progress for f35"
...
Language progress for Samoan (sm) in Fedora f35 is:
...
* Source words to translate in started packages: 24749
* Translated words: 1
...
* [sm generated stats (3.1 kB)]({{% resource url="/f35/sm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-typing-turtle]({{< ref "/f35/package/sugar-typing-turtle.md" >}}) | 1 | 599 | 0.2 | LANGUAGE <LL@li.org> | 
