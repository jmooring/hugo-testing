---
title: "tn-Tswana (Setswana) - translation progress for f35"
...
Language progress for Tswana (tn) in Fedora f35 is:

* 11.65% when we only look on started packages for this language.
* 0.13% when we compare to every single translatable string in Fedora f35.

Possible scripts are: Latn

* Total translatable string in Fedora f35: 16950989
* Source words to translate in started packages: 190445
* Translated words: 22184
...
* [tn generated stats (3.2 kB)]({{% resource url="/f35/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f35/package/libreoffice.md" >}}) | 22184 | 165978 | 13.4 | LANGUAGE <LL@li.org> | 
