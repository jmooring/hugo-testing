---
title: "so-Somali (Soomaali) - translation progress for f35"
...
Language progress for Somali (so) in Fedora f35 is:

* 1.99% when we only look on started packages for this language.
...
* Source words to translate in started packages: 67649
* Translated words: 1345
...
* [so generated stats (3.6 kB)]({{% resource url="/f35/so.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [cinnamon-translations]({{< ref "/f35/package/cinnamon-translations.md" >}}) | 1117 | 17020 | 6.6 | Somali <so@li.org> | 
 | [mate-menu]({{< ref "/f35/package/mate-menu.md" >}}) | 6 | 308 | 1.9 | Somali (http://www.transifex.com/mate/MATE/language/so/) | 
 | [iso-codes]({{< ref "/f35/package/iso-codes.md" >}}) | 200 | 22463 | 0.9 | none | 
 | [mate-control-center]({{< ref "/f35/package/mate-control-center.md" >}}) | 22 | 3326 | 0.7 | Somali (https://www.transifex.com/mate/teams/13566/so/) | 
 ...
 | [libmatekbd]({{< ref "/f35/package/libmatekbd.md" >}}) | 0 | 308 | 0.0 | Somali (http://www.transifex.com/mate/MATE/language/so/) | 
 | [mate-themes]({{< ref "/f35/package/mate-themes.md" >}}) | 0 | 74 | 0.0 | Somali (http://www.transifex.com/mate/MATE/language/so/) | 
