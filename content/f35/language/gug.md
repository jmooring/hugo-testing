---
title: "gug- () - translation progress for f35"
...
Language progress for  (gug) in Fedora f35 is:

* 34.82% when we only look on started packages for this language.
* 0.34% when we compare to every single translatable string in Fedora f35.

Possible scripts are: 

* Total translatable string in Fedora f35: 16950989
* Source words to translate in started packages: 166934
* Translated words: 58133
...
* [gug generated stats (722 Bytes)]({{% resource url="/f35/gug.csv" %}})
