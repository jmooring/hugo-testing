---
title: "st-Southern Sotho (Sesotho) - translation progress for f35"
...
territories:
 ...
 - ZA
polib_error_count: 0
could_not_process_count: 259
---

Language progress for Southern Sotho (st) in Fedora f35 is:

* 15.48% when we only look on started packages for this language.
* 0.17% when we compare to every single translatable string in Fedora f35.

Possible scripts are: Latn

* Total translatable string in Fedora f35: 16950989
* Source words to translate in started packages: 190992
* Translated words: 29569
...
* [st generated stats (3.4 kB)]({{% resource url="/f35/st.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkspell3]({{< ref "/f35/package/gtkspell3.md" >}}) | 8 | 16 | 50.0 | Sotho <info@mosekolatranslation.co.za> | 
 | [mingw-gtkspell3]({{< ref "/f35/package/mingw-gtkspell3.md" >}}) | 8 | 16 | 50.0 | Sotho <info@mosekolatranslation.co.za> | 
 | [libreoffice]({{< ref "/f35/package/libreoffice.md" >}}) | 29547 | 165978 | 17.8 | LANGUAGE <LL@li.org> | 
