---
title: "kg-Kongo (Kongo) - translation progress for f35"
...
Language progress for Kongo (kg) in Fedora f35 is:

* 13.28% when we only look on started packages for this language.
* 0.08% when we compare to every single translatable string in Fedora f35.

Possible scripts are: Latn

* Total translatable string in Fedora f35: 16950989
* Source words to translate in started packages: 105043
...
* [kg generated stats (4.0 kB)]({{% resource url="/f35/kg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [alacarte]({{< ref "/f35/package/alacarte.md" >}}) | 74 | 74 | 100.0 | Kikongo <lundombe01@zaya-dio.com> | 
 | [bzflag]({{< ref "/f35/package/bzflag.md" >}}) | 97 | 97 | 100.0 |  | 
 | [gnome-desktop3]({{< ref "/f35/package/gnome-desktop3.md" >}}) | 384 | 384 | 100.0 | Kikongo, kg <lundombe01@zaya-dio.com> | 
 | [gnome-menus]({{< ref "/f35/package/gnome-menus.md" >}}) | 125 | 125 | 100.0 | Kikongo <lundombe01@zaya-dio.com> | 
 | [xdg-user-dirs-gtk]({{< ref "/f35/package/xdg-user-dirs-gtk.md" >}}) | 81 | 81 | 100.0 | kikongo <lundombe01@zaya-dio.com> | 
 | [cinnamon-desktop]({{< ref "/f35/package/cinnamon-desktop.md" >}}) | 205 | 231 | 88.7 | Kikongo, kg <lundombe01@zaya-dio.com> | 
 | [chromium]({{< ref "/f35/package/chromium.md" >}}) | 3245 | 13283 | 24.4 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [gtk3]({{< ref "/f35/package/gtk3.md" >}}) | 3245 | 13283 | 24.4 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [gtk4]({{< ref "/f35/package/gtk4.md" >}}) | 3245 | 13283 | 24.4 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [mingw-gtk3]({{< ref "/f35/package/mingw-gtk3.md" >}}) | 3245 | 13283 | 24.4 | GNOME kikongo Team <lundombe01@zaya-dio.com> | 
 | [stellarium]({{< ref "/f35/package/stellarium.md" >}}) | 2 | 26769 | 0.0 | Kongo <kg@li.org> | 
...
|---------|--------------------------|-------------|------|
 | [bzflag]({{< ref "/f35/package/bzflag.md" >}}) | /mnt/stockage/packages/f35/bzflag/data/l10n/bzflag_kg.po | error-os |  | 
{.sortable}
