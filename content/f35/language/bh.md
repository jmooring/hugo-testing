---
title: "bh- () - translation progress for f35"
...
Language progress for  (bh) in Fedora f35 is:
...
* [bh generated stats (3.1 kB)]({{% resource url="/f35/bh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f35/package/stellarium.md" >}}) | 2 | 26769 | 0.0 | Bihari <bh@li.org> | 
