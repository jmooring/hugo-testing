---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f35"
...
Language progress for Chamorro (ch) in Fedora f35 is:
...
* [ch generated stats (3.2 kB)]({{% resource url="/f35/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f35/package/iso-codes.md" >}}) | 31 | 982 | 3.2 | Chamorro <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ch/> | 
