---
title: "ve-Venda (Tshivenḓa) - translation progress for f35"
...
Language progress for Venda (ve) in Fedora f35 is:

* 8.17% when we only look on started packages for this language.
...
* Source words to translate in started packages: 393808
* Translated words: 32168
...
* [ve generated stats (3.6 kB)]({{% resource url="/f35/ve.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [koffice-kivio]({{< ref "/f35/package/koffice-kivio.md" >}}) | 1896 | 8417 | 22.5 | <en@li.org> | 
 | [libreoffice]({{< ref "/f35/package/libreoffice.md" >}}) | 29553 | 165978 | 17.8 | LANGUAGE <LL@li.org> | 
 | [tuxpaint]({{< ref "/f35/package/tuxpaint.md" >}}) | 353 | 2286 | 15.4 | LANGUAGE <LL@li.org> | 
 | [iso-codes]({{< ref "/f35/package/iso-codes.md" >}}) | 319 | 22503 | 1.4 | Venda <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ve/> | 
 | [calibre]({{< ref "/f35/package/calibre.md" >}}) | 47 | 170474 | 0.0 | Venda (http://www.transifex.com/calibre/calibre/language/ve/) | 
