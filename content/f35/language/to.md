---
title: "to-Tongan (Lea fakatonga) - translation progress for f35"
...
Language progress for Tongan (to) in Fedora f35 is:
...
* Source words to translate in started packages: 25066
* Translated words: 0
...
* [to generated stats (3.1 kB)]({{% resource url="/f35/to.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [sugar-typing-turtle]({{< ref "/f35/package/sugar-typing-turtle.md" >}}) | 0 | 599 | 0.0 | LANGUAGE <LL@li.org> | 
