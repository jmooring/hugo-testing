---
title: "brx-Bodo (बर’) - translation progress for f32"
...
Language progress for Bodo (brx) in Fedora f32 is:

* 51.13% when we only look on started packages for this language.
* 0.43% when we compare to every single translatable string in Fedora f32.

Possible scripts are: Deva

* Total translatable string in Fedora f32: 15042548
* Source words to translate in started packages: 127860
* Translated words: 65380
...
* [brx generated stats (1.8 kB)]({{% resource url="/f32/brx.csv" %}})
