---
title: "es_PR-Spanish (Puerto Rico) (Español (Puerto Rico)) - translation progress for f32"
...
Language progress for Spanish (Puerto Rico) (es_PR) in Fedora f32 is:

* 3.90% when we only look on started packages for this language.
...
* Source words to translate in started packages: 79052
...
* [es_PR generated stats (3.6 kB)]({{% resource url="/f32/es_PR.csv" %}})
