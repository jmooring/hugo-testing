---
title: "ny-Nyanja (Nyanja) - translation progress for f30"
...
Language progress for Nyanja (ny) in Fedora f30 is:
...
* [ny generated stats (2.7 kB)]({{% resource url="/f30/ny.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f30/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chewa; Chichewa; Nyanja <ny@li.org> | 
