---
title: "nr-South Ndebele (isiNdebele) - translation progress for f30"
...
Language progress for South Ndebele (nr) in Fedora f30 is:

* 26.04% when we only look on started packages for this language.
* 0.20% when we compare to every single translatable string in Fedora f30.

Possible scripts are: Latn

* Total translatable string in Fedora f30: 15235865
* Source words to translate in started packages: 117709
* Translated words: 30650
...
* [nr generated stats (2.9 kB)]({{% resource url="/f30/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f30/package/libreoffice.md" >}}) | 30175 | 99377 | 30.4 | LANGUAGE <LL@li.org> | 
