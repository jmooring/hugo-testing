---
title: "mh-Marshallese (Kajin M̧ajeļ) - translation progress for f30"
...
Language progress for Marshallese (mh) in Fedora f30 is:
...
* Source words to translate in started packages: 16741
* Translated words: 0
...
* [mh generated stats (2.7 kB)]({{% resource url="/f30/mh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f30/package/vocal.md" >}}) | 0 | 377 | 0.0 | Marshallese <mh@li.org> | 
