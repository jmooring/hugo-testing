---
title: "ss-Swati (siSwati) - translation progress for f30"
...
Language progress for Swati (ss) in Fedora f30 is:

* 26.48% when we only look on started packages for this language.
...
* Source words to translate in started packages: 116127
* Translated words: 30746
...
* [ss generated stats (2.8 kB)]({{% resource url="/f30/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f30/package/libreoffice.md" >}}) | 30746 | 99386 | 30.9 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f30/package/vocal.md" >}}) | 0 | 377 | 0.0 | Swati <ss@li.org> | 
