---
title: "kr-Kanuri (Kanuri) - translation progress for f30"
...
Language progress for Kanuri (kr) in Fedora f30 is:

* 36.05% when we only look on started packages for this language.
* 0.08% when we compare to every single translatable string in Fedora f30.

Possible scripts are: LatnArab

* Total translatable string in Fedora f30: 15235865
* Source words to translate in started packages: 34378
* Translated words: 12392
...
* [kr generated stats (3.1 kB)]({{% resource url="/f30/kr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [phd2]({{< ref "/f30/package/phd2.md" >}}) | 11401 | 11821 | 96.4 |  | 
 | [gettext]({{< ref "/f30/package/gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [mingw-gettext]({{< ref "/f30/package/mingw-gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [origin]({{< ref "/f30/package/origin.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f30/package/vocal.md" >}}) | 0 | 377 | 0.0 | Kanuri <kr@li.org> | 
