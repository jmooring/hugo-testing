---
title: "sg-Sango (Sängö) - translation progress for f30"
...
Language progress for Sango (sg) in Fedora f30 is:
...
* [sg generated stats (2.7 kB)]({{% resource url="/f30/sg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f30/package/vocal.md" >}}) | 0 | 377 | 0.0 | Sango <sg@li.org> | 
