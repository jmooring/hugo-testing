---
title: "bm-Bambara (Bamanakan) - translation progress for f30"
...
Language progress for Bambara (bm) in Fedora f30 is:

* 8.30% when we only look on started packages for this language.
...
* Source words to translate in started packages: 18256
...
* [bm generated stats (2.8 kB)]({{% resource url="/f30/bm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f30/package/vocal.md" >}}) | 0 | 377 | 0.0 | Bambara <bm@li.org> | 
