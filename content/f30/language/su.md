---
title: "su-Sundanese (Basa Sunda) - translation progress for f30"
...
Language progress for Sundanese (su) in Fedora f30 is:

* 2.37% when we only look on started packages for this language.
* 0.00% when we compare to every single translatable string in Fedora f30.

Possible scripts are: LatnSundJava

* Total translatable string in Fedora f30: 15235865
* Source words to translate in started packages: 22722
* Translated words: 539
...
* [su generated stats (3.2 kB)]({{% resource url="/f30/su.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f30/package/tuxpaint.md" >}}) | 359 | 1515 | 23.7 | LANGUAGE <LL@li.org> | 
 | [visualboyadvance-m]({{< ref "/f30/package/visualboyadvance-m.md" >}}) | 116 | 2393 | 4.8 | Sundanese (http://www.transifex.com/bgk/vba-m/language/su/) | 
 | [cinnamon-translations]({{< ref "/f30/package/cinnamon-translations.md" >}}) | 23 | 666 | 3.5 | Sundanese <su@li.org> | 
 | [terminator]({{< ref "/f30/package/terminator.md" >}}) | 30 | 1407 | 2.1 | Sundanese <su@li.org> | 
 | [elementary-code]({{< ref "/f30/package/elementary-code.md" >}}) | 11 | 1095 | 1.0 | Sundanese <su@li.org> | 
 ...
 | [java-11-openjdk]({{< ref "/f30/package/java-11-openjdk.md" >}}) | 0 | 0 | 0.0 |  | 
 | [java-latest-openjdk]({{< ref "/f30/package/java-latest-openjdk.md" >}}) | 0 | 0 | 0.0 |  | 
...
|---------|--------------------------|-------------|------|
 | [java-11-openjdk]({{< ref "/f30/package/java-11-openjdk.md" >}}) | /mnt/stockage/packages/f30/java-11-openjdk/test/jdk/sun/nio/cs/tradChinese.po | error-unicode |  | 
 | [java-11-openjdk]({{< ref "/f30/package/java-11-openjdk.md" >}}) | /mnt/stockage/packages/f30/java-11-openjdk/test/jdk/sun/nio/cs/tradChinese.win.po | error-unicode |  | 
 | [java-latest-openjdk]({{< ref "/f30/package/java-latest-openjdk.md" >}}) | /mnt/stockage/packages/f30/java-latest-openjdk/test/jdk/sun/nio/cs/tradChinese.po | error-unicode |  | 
 | [java-latest-openjdk]({{< ref "/f30/package/java-latest-openjdk.md" >}}) | /mnt/stockage/packages/f30/java-latest-openjdk/test/jdk/sun/nio/cs/tradChinese.win.po | error-unicode |  | 
{.sortable}
...
|---------|--------------------------|------|
 | [java-11-openjdk]({{< ref "/f30/package/java-11-openjdk.md" >}}) | /mnt/stockage/packages/f30/java-11-openjdk/test/jdk/sun/nio/cs/tradChinese.po |  | 
 | [java-11-openjdk]({{< ref "/f30/package/java-11-openjdk.md" >}}) | /mnt/stockage/packages/f30/java-11-openjdk/test/jdk/sun/nio/cs/tradChinese.win.po |  | 
 | [java-latest-openjdk]({{< ref "/f30/package/java-latest-openjdk.md" >}}) | /mnt/stockage/packages/f30/java-latest-openjdk/test/jdk/sun/nio/cs/tradChinese.po |  | 
 | [java-latest-openjdk]({{< ref "/f30/package/java-latest-openjdk.md" >}}) | /mnt/stockage/packages/f30/java-latest-openjdk/test/jdk/sun/nio/cs/tradChinese.win.po |  | 
{.sortable}
