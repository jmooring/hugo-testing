---
title: "tn-Tswana (Setswana) - translation progress for f30"
...
Language progress for Tswana (tn) in Fedora f30 is:

* 19.68% when we only look on started packages for this language.
* 0.15% when we compare to every single translatable string in Fedora f30.

Possible scripts are: Latn

* Total translatable string in Fedora f30: 15235865
* Source words to translate in started packages: 116120
* Translated words: 22856
...
* [tn generated stats (2.8 kB)]({{% resource url="/f30/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f30/package/libreoffice.md" >}}) | 22856 | 99379 | 23.0 | LANGUAGE <LL@li.org> | 
