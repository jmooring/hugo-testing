---
title: "tyv-Tuvinian (Тыва дыл) - translation progress for f30"
...
Language progress for Tuvinian (tyv) in Fedora f30 is:
...
* Source words to translate in started packages: 4793
* Translated words: 14
...
* [tyv generated stats (1.6 kB)]({{% resource url="/f30/tyv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gnome-do]({{< ref "/f30/package/gnome-do.md" >}}) | 4 | 612 | 0.7 | Tuvinian <tyv@li.org> | 
 | [terminator]({{< ref "/f30/package/terminator.md" >}}) | 9 | 1407 | 0.6 | Tuvinian <tyv@li.org> | 
 | [sugar-finance]({{< ref "/f30/package/sugar-finance.md" >}}) | 1 | 258 | 0.4 | LANGUAGE <LL@li.org> | 
