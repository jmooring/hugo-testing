---
title: "cr- () - translation progress for f30"
...
Language progress for  (cr) in Fedora f30 is:
...
* [cr generated stats (2.7 kB)]({{% resource url="/f30/cr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f30/package/vocal.md" >}}) | 0 | 377 | 0.0 | Cree <cr@li.org> | 
