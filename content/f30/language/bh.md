---
title: "bh- () - translation progress for f30"
...
Language progress for  (bh) in Fedora f30 is:
...
* [bh generated stats (2.8 kB)]({{% resource url="/f30/bh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f30/package/stellarium.md" >}}) | 2 | 26769 | 0.0 | Bihari <bh@li.org> | 
