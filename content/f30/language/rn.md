---
title: "rn-Rundi (Ikirundi) - translation progress for f30"
...
Language progress for Rundi (rn) in Fedora f30 is:
...
* [rn generated stats (2.7 kB)]({{% resource url="/f30/rn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f30/package/vocal.md" >}}) | 0 | 377 | 0.0 | Rundi <rn@li.org> | 
