---
title: "ve-Venda (Tshivenḓa) - translation progress for f30"
...
Language progress for Venda (ve) in Fedora f30 is:

* 10.79% when we only look on started packages for this language.
* 0.22% when we compare to every single translatable string in Fedora f30.

Possible scripts are: Latn

* Total translatable string in Fedora f30: 15235865
* Source words to translate in started packages: 307534
* Translated words: 33179
...
* [ve generated stats (3.2 kB)]({{% resource url="/f30/ve.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f30/package/libreoffice.md" >}}) | 30440 | 99387 | 30.6 | LANGUAGE <LL@li.org> | 
 | [tuxpaint]({{< ref "/f30/package/tuxpaint.md" >}}) | 475 | 1591 | 29.9 | LANGUAGE <LL@li.org> | 
 | [koffice-kivio]({{< ref "/f30/package/koffice-kivio.md" >}}) | 1896 | 8417 | 22.5 | <en@li.org> | 
 | [iso-codes]({{< ref "/f30/package/iso-codes.md" >}}) | 321 | 22396 | 1.4 | Venda <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ve/> | 
 | [calibre]({{< ref "/f30/package/calibre.md" >}}) | 47 | 159002 | 0.0 | Venda (http://www.transifex.com/calibre/calibre/language/ve/) | 
 ...
 | [vocal]({{< ref "/f30/package/vocal.md" >}}) | 0 | 377 | 0.0 | Venda <ve@li.org> | 
