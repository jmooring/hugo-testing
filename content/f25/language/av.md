---
title: "av-Avaric (Авар мацӀ) - translation progress for f25"
...
Language progress for Avaric (av) in Fedora f25 is:
...
* [av generated stats (1.3 kB)]({{% resource url="/f25/av.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f25/package/stellarium.md" >}}) | 1 | 23532 | 0.0 | Avaric <av@li.org> | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Avaric <av@li.org> | 
{.sortable}
