---
title: "tn-Tswana (Setswana) - translation progress for f25"
...
Language progress for Tswana (tn) in Fedora f25 is:

* 20.73% when we only look on started packages for this language.
* 0.16% when we compare to every single translatable string in Fedora f25.

Possible scripts are: Latn

* Total translatable string in Fedora f25: 14474492
* Source words to translate in started packages: 111917
* Translated words: 23200
...
* [tn generated stats (1.3 kB)]({{% resource url="/f25/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice](/f25/package/libreoffice) | 23200 | 100903 | 23.0 | LANGUAGE <LL@li.org> | 
