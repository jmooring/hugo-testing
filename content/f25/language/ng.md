---
title: "ng-Ndonga (Ndonga) - translation progress for f25"
...
Language progress for Ndonga (ng) in Fedora f25 is:

* 5.07% when we only look on started packages for this language.
...
* Source words to translate in started packages: 11602
...
* [ng generated stats (1.2 kB)]({{% resource url="/f25/ng.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [aircrack-ng]({{< ref "/f25/package/aircrack-ng.md" >}}) | 588 | 588 | 100.0 |  | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Ndonga <ng@li.org> | 
{.sortable}
