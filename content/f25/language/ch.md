---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f25"
...
Language progress for Chamorro (ch) in Fedora f25 is:
...
* [ch generated stats (1.2 kB)]({{% resource url="/f25/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chamorro <ch@li.org> | 
{.sortable}
