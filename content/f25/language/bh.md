---
title: "bh- () - translation progress for f25"
...
Language progress for  (bh) in Fedora f25 is:
...
* [bh generated stats (1.3 kB)]({{% resource url="/f25/bh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f25/package/stellarium.md" >}}) | 11 | 23532 | 0.0 | Bihari <bh@li.org> | 
