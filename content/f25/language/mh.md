---
title: "mh-Marshallese (Kajin M̧ajeļ) - translation progress for f25"
...
Language progress for Marshallese (mh) in Fedora f25 is:
...
* [mh generated stats (1.2 kB)]({{% resource url="/f25/mh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Marshallese <mh@li.org> | 
{.sortable}
