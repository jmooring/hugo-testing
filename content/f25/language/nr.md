---
title: "nr-South Ndebele (isiNdebele) - translation progress for f25"
...
Language progress for South Ndebele (nr) in Fedora f25 is:
...
* Source words to translate in started packages: 113497
* Translated words: 32837
...
* [nr generated stats (1.4 kB)]({{% resource url="/f25/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f25/package/libreoffice.md" >}}) | 32362 | 100892 | 32.1 | LANGUAGE <LL@li.org> | 
 | [tuxpaint]({{< ref "/f25/package/tuxpaint.md" >}}) | 475 | 1591 | 29.9 | LANGUAGE <LL@li.org> | 
