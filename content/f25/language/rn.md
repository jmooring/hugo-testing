---
title: "rn-Rundi (Ikirundi) - translation progress for f25"
...
Language progress for Rundi (rn) in Fedora f25 is:
...
* [rn generated stats (1.2 kB)]({{% resource url="/f25/rn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Rundi <rn@li.org> | 
{.sortable}
