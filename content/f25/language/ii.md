---
title: "ii-Sichuan Yi (ꆈꌠꉙ) - translation progress for f25"
...
Language progress for Sichuan Yi (ii) in Fedora f25 is:
...
* Source words to translate in started packages: 11177
* Translated words: 4
...
* [ii generated stats (1.3 kB)]({{% resource url="/f25/ii.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [cinnamon-translations]({{< ref "/f25/package/cinnamon-translations.md" >}}) | 4 | 163 | 2.5 | Sichuan Yi <ii@li.org> | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Sichuan Yi <ii@li.org> | 
{.sortable}
