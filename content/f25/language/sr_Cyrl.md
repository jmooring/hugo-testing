---
title: "sr_Cyrl-Serbian (Cyrillic) (Српски (Ћирилица)) - translation progress for f25"
...
Language progress for Serbian (Cyrillic) (sr_Cyrl) in Fedora f25 is:

* 17.31% when we only look on started packages for this language.
...
* Source words to translate in started packages: 28178
* Translated words: 4877
...
* [sr_Cyrl generated stats (605 Bytes)]({{% resource url="/f25/sr_Cyrl.csv" %}})
