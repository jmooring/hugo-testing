---
title: "es_PR-Spanish (Puerto Rico) (Español (Puerto Rico)) - translation progress for f25"
...
Language progress for Spanish (Puerto Rico) (es_PR) in Fedora f25 is:

* 28.34% when we only look on started packages for this language.
...
* Source words to translate in started packages: 8712
* Translated words: 2469
...
* [es_PR generated stats (1.1 kB)]({{% resource url="/f25/es_PR.csv" %}})
