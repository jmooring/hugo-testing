---
title: "aa-Afar (Qafar) - translation progress for f25"
...
Language progress for Afar (aa) in Fedora f25 is:
...
* [aa generated stats (1.3 kB)]({{% resource url="/f25/aa.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [stellarium]({{< ref "/f25/package/stellarium.md" >}}) | 0 | 23532 | 0.0 | Afar <aa@li.org> | 
