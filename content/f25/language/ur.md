---
title: "ur-Urdu (اردو) - translation progress for f25"
...
territories:
 ...
 - PK
polib_error_count: 1
could_not_process_count: 712
---

Language progress for Urdu (ur) in Fedora f25 is:

* 17.30% when we only look on started packages for this language.
* 1.09% when we compare to every single translatable string in Fedora f25.

Possible scripts are: Arab

* Total translatable string in Fedora f25: 14474492
* Source words to translate in started packages: 912993
* Translated words: 157965
...
* [ur generated stats (22.1 kB)]({{% resource url="/f25/ur.csv" %}})
