---
title: "ty-Tahitian (Reo Tahiti) - translation progress for f25"
...
Language progress for Tahitian (ty) in Fedora f25 is:
...
* [ty generated stats (1.2 kB)]({{% resource url="/f25/ty.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Tahitian <ty@li.org> | 
{.sortable}
