---
title: "tk-Turkmen (Türkmen dili) - translation progress for f25"
...
Language progress for Turkmen (tk) in Fedora f25 is:

* 13.71% when we only look on started packages for this language.
* 0.15% when we compare to every single translatable string in Fedora f25.

Possible scripts are: LatnCyrlArab

* Total translatable string in Fedora f25: 14474492
* Source words to translate in started packages: 157816
* Translated words: 21633
...
* [tk generated stats (5.8 kB)]({{% resource url="/f25/tk.csv" %}})
