---
title: "sg-Sango (Sängö) - translation progress for f25"
...
Language progress for Sango (sg) in Fedora f25 is:
...
* [sg generated stats (1.2 kB)]({{% resource url="/f25/sg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Sango <sg@li.org> | 
{.sortable}
