---
title: "ba-Bashkir (Башҡорт теле) - translation progress for f25"
...
Language progress for Bashkir (ba) in Fedora f25 is:
...
* Source words to translate in started packages: 34546
* Translated words: 16
...
* [ba generated stats (1.3 kB)]({{% resource url="/f25/ba.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f25/package/stellarium.md" >}}) | 16 | 23532 | 0.1 | Bashkir <ba@li.org> | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Bashkir <ba@li.org> | 
{.sortable}
