---
title: "bm-Bambara (Bamanakan) - translation progress for f25"
...
Language progress for Bambara (bm) in Fedora f25 is:

* 12.09% when we only look on started packages for this language.
...
* Source words to translate in started packages: 12529
...
* [bm generated stats (1.3 kB)]({{% resource url="/f25/bm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f25/package/tuxpaint.md" >}}) | 1515 | 1515 | 100.0 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Bambara <bm@li.org> | 
{.sortable}
