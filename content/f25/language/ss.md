---
title: "ss-Swati (siSwati) - translation progress for f25"
...
Language progress for Swati (ss) in Fedora f25 is:

* 28.97% when we only look on started packages for this language.
* 0.22% when we compare to every single translatable string in Fedora f25.

Possible scripts are: Latn

* Total translatable string in Fedora f25: 14474492
* Source words to translate in started packages: 111923
* Translated words: 32427
...
* [ss generated stats (1.3 kB)]({{% resource url="/f25/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f25/package/libreoffice.md" >}}) | 32427 | 100909 | 32.1 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Swati <ss@li.org> | 
{.sortable}
