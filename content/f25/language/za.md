---
title: "za-Zhuang (Vahcuengh) - translation progress for f25"
...
Language progress for Zhuang (za) in Fedora f25 is:

* 37.48% when we only look on started packages for this language.
...
* Source words to translate in started packages: 18534
...
* [za generated stats (1.3 kB)]({{% resource url="/f25/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f25/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
