---
title: "lu-Luba-Katanga (Tshiluba) - translation progress for f25"
...
Language progress for Luba-Katanga (lu) in Fedora f25 is:
...
* [lu generated stats (1.2 kB)]({{% resource url="/f25/lu.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Luba-Katanga <lu@li.org> | 
{.sortable}
