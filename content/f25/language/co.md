---
title: "co-Corsican (Corsu) - translation progress for f25"
...
Language progress for Corsican (co) in Fedora f25 is:

* 53.02% when we only look on started packages for this language.
* 0.09% when we compare to every single translatable string in Fedora f25.

Possible scripts are: Latn

* Total translatable string in Fedora f25: 14474492
* Source words to translate in started packages: 23702
* Translated words: 12566
...
* [co generated stats (1.4 kB)]({{% resource url="/f25/co.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [poedit]({{< ref "/f25/package/poedit.md" >}}) | 2491 | 2492 | 100.0 | Corsican | 
 | [filezilla]({{< ref "/f25/package/filezilla.md" >}}) | 10075 | 10112 | 99.6 | Patriccollu di Santa Maria è Sichè <Patrick.Santa-Maria[AT]laposte.net> | 
 | [appcenter]({{< ref "/f25/package/appcenter.md" >}}) | 0 | 681 | 0.0 | LANGUAGE <LL@li.org> | 
 | [audience]({{< ref "/f25/package/audience.md" >}}) | 0 | 106 | 0.0 |  | 
 | [lightdm]({{< ref "/f25/package/lightdm.md" >}}) | 0 | 84 | 0.0 | Corsican <co@li.org> | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Corsican <co@li.org> | 
{.sortable}
