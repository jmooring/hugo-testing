---
title: "ki-Kikuyu (Gikuyu) - translation progress for f25"
...
Language progress for Kikuyu (ki) in Fedora f25 is:
...
* [ki generated stats (1.2 kB)]({{% resource url="/f25/ki.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Kikuyu <ki@li.org> | 
{.sortable}
