---
title: "cr- () - translation progress for f25"
...
Language progress for  (cr) in Fedora f25 is:
...
* [cr generated stats (1.2 kB)]({{% resource url="/f25/cr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Cree <cr@li.org> | 
{.sortable}
