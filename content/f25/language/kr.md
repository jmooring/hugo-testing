---
title: "kr-Kanuri (Kanuri) - translation progress for f25"
...
Language progress for Kanuri (kr) in Fedora f25 is:

* 4.39% when we only look on started packages for this language.
...
* Source words to translate in started packages: 15116
...
* [kr generated stats (1.4 kB)]({{% resource url="/f25/kr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gettext]({{< ref "/f25/package/gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [mingw-gettext]({{< ref "/f25/package/mingw-gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [isomaster]({{< ref "/f25/package/isomaster.md" >}}) | 7 | 674 | 1.0 | http://littlesvr.ca/ostd/ | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Kanuri <kr@li.org> | 
{.sortable}
