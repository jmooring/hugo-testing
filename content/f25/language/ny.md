---
title: "ny-Nyanja (Nyanja) - translation progress for f25"
...
Language progress for Nyanja (ny) in Fedora f25 is:
...
* [ny generated stats (1.2 kB)]({{% resource url="/f25/ny.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chewa; Chichewa; Nyanja <ny@li.org> | 
{.sortable}
