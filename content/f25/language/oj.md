---
title: "oj- () - translation progress for f25"
...
Language progress for  (oj) in Fedora f25 is:
...
* Source words to translate in started packages: 36151
* Translated words: 212
...
* [oj generated stats (1.4 kB)]({{% resource url="/f25/oj.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f25/package/tuxpaint.md" >}}) | 179 | 1591 | 11.3 | Ed <edm@rocketmail.com> | 
 | [stellarium]({{< ref "/f25/package/stellarium.md" >}}) | 33 | 23546 | 0.1 | Ojibwe <oj@li.org> | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Ojibwe <oj@li.org> | 
{.sortable}
