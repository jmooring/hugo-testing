---
title: "kab-Kabyle (Taqbaylit) - translation progress for f25"
...
Language progress for Kabyle (kab) in Fedora f25 is:

* 33.55% when we only look on started packages for this language.
* 0.18% when we compare to every single translatable string in Fedora f25.

Possible scripts are: LatnTfngArab

* Total translatable string in Fedora f25: 14474492
* Source words to translate in started packages: 77227
* Translated words: 25906
...
* [kab generated stats (1.4 kB)]({{% resource url="/f25/kab.csv" %}})
