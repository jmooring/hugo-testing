---
title: "ik-Inupiaq (Iñupiatun) - translation progress for f25"
...
Language progress for Inupiaq (ik) in Fedora f25 is:
...
* [ik generated stats (1.2 kB)]({{% resource url="/f25/ik.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal](/f25/package/vocal) | 0 | 377 | 0.0 | Inupiaq <ik@li.org> | 
{.sortable}
