---
title: "na-Nauru (Dorerin Naoero) - translation progress for f25"
...
Language progress for Nauru (na) in Fedora f25 is:
...
* Source words to translate in started packages: 39529
* Translated words: 32
...
* [na generated stats (2.9 kB)]({{% resource url="/f25/na.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-chat]({{< ref "/f25/package/sugar-chat.md" >}}) | 24 | 137 | 17.5 | LANGUAGE <LL@li.org> | 
 | [stellarium]({{< ref "/f25/package/stellarium.md" >}}) | 8 | 23532 | 0.0 | Nauru <na@li.org> | 
 ...
 | [vocal]({{< ref "/f25/package/vocal.md" >}}) | 0 | 377 | 0.0 | Nauru <na@li.org> | 
{.sortable}
