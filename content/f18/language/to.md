---
title: "to-Tongan (Lea fakatonga) - translation progress for f18"
...
Language progress for Tongan (to) in Fedora f18 is:

* 4.98% when we only look on started packages for this language.
...
* Source words to translate in started packages: 1406
* Translated words: 70
...
* [to generated stats (1.1 kB)]({{% resource url="/f18/to.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-pippy]({{< ref "/f18/package/sugar-pippy.md" >}}) | 55 | 109 | 50.5 | LANGUAGE <LL@li.org> | 
 | [sugar-abacus]({{< ref "/f18/package/sugar-abacus.md" >}}) | 11 | 34 | 32.4 | LANGUAGE <LL@li.org> | 
 | [sugar-browse]({{< ref "/f18/package/sugar-browse.md" >}}) | 2 | 134 | 1.5 | LANGUAGE <LL@li.org> | 
 | [sugar-fototoon]({{< ref "/f18/package/sugar-fototoon.md" >}}) | 1 | 77 | 1.3 | LANGUAGE <LL@li.org> | 
