---
title: "es_CR-Spanish (Costa Rica) (Español (Costa Rica)) - translation progress for f18"
...
Language progress for Spanish (Costa Rica) (es_CR) in Fedora f18 is:

* 93.72% when we only look on started packages for this language.
* 0.67% when we compare to every single translatable string in Fedora f18.

Possible scripts are: Latn

* Total translatable string in Fedora f18: 10770053
* Source words to translate in started packages: 77390
* Translated words: 72528
...
* [es_CR generated stats (884 Bytes)]({{% resource url="/f18/es_CR.csv" %}})
