---
title: "es_PA-Spanish (Panama) (Español (Panamá)) - translation progress for f18"
...
Language progress for Spanish (Panama) (es_PA) in Fedora f18 is:

* 89.10% when we only look on started packages for this language.
...
* Source words to translate in started packages: 8104
* Translated words: 7221
...
* [es_PA generated stats (492 Bytes)]({{% resource url="/f18/es_PA.csv" %}})
