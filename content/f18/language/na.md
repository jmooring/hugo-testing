---
title: "na-Nauru (Dorerin Naoero) - translation progress for f18"
...
Language progress for Nauru (na) in Fedora f18 is:

* 0.36% when we only look on started packages for this language.
...
* Source words to translate in started packages: 5042
* Translated words: 18
...
* [na generated stats (1.7 kB)]({{% resource url="/f18/na.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-chat]({{< ref "/f18/package/sugar-chat.md" >}}) | 18 | 52 | 34.6 | LANGUAGE <LL@li.org> | 
