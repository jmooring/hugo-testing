---
title: "lb-Luxembourgish (Lëtzebuergesch) - translation progress for f18"
...
territories:
 - LU
polib_error_count: 0
could_not_process_count: 373
---

Language progress for Luxembourgish (lb) in Fedora f18 is:

* 3.09% when we only look on started packages for this language.
* 0.16% when we compare to every single translatable string in Fedora f18.

Possible scripts are: Latn

* Total translatable string in Fedora f18: 10770053
* Source words to translate in started packages: 563321
* Translated words: 17405
...
* [lb generated stats (978 Bytes)]({{% resource url="/f18/lb.csv" %}})
