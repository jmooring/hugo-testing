---
title: "bo-Tibetan (བོད་སྐད་) - translation progress for f18"
...
Language progress for Tibetan (bo) in Fedora f18 is:

* 71.88% when we only look on started packages for this language.
* 3.86% when we compare to every single translatable string in Fedora f18.

Possible scripts are: Tibt

* Total translatable string in Fedora f18: 10770053
* Source words to translate in started packages: 577779
* Translated words: 415292
...
* [bo generated stats (1.1 kB)]({{% resource url="/f18/bo.csv" %}})
