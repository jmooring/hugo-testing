---
title: "csb-Kashubian (Kaszëbsczi jãzëk) - translation progress for f14"
...
Language progress for Kashubian (csb) in Fedora f14 is:

* 6.41% when we only look on started packages for this language.
...
* Source words to translate in started packages: 43271
...
* [csb generated stats (732 Bytes)]({{% resource url="/f14/csb.csv" %}})
