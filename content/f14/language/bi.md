---
title: "bi-Bislama (Bislama) - translation progress for f14"
...
Language progress for Bislama (bi) in Fedora f14 is:

* 0.07% when we only look on started packages for this language.
* 0.00% when we compare to every single translatable string in Fedora f14.

Possible scripts are: Latn

* Total translatable string in Fedora f14: 10474277
* Source words to translate in started packages: 5738
* Translated words: 4
...
* [bi generated stats (1.7 kB)]({{% resource url="/f14/bi.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-turtleart]({{< ref "/f14/package/sugar-turtleart.md" >}}) | 4 | 1208 | 0.3 | LANGUAGE <walter@sugarlabs.org> | 
 | [olpc-switch-desktop]({{< ref "/f14/package/olpc-switch-desktop.md" >}}) | 0 | 158 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar]({{< ref "/f14/package/sugar.md" >}}) | 0 | 549 | 0.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-chat]({{< ref "/f14/package/sugar-chat.md" >}}) | 0 | 26 | 0.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-memorize]({{< ref "/f14/package/sugar-memorize.md" >}}) | 0 | 50 | 0.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-pippy]({{< ref "/f14/package/sugar-pippy.md" >}}) | 0 | 52 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-playgo]({{< ref "/f14/package/sugar-playgo.md" >}}) | 0 | 85 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-read]({{< ref "/f14/package/sugar-read.md" >}}) | 0 | 28 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-surf]({{< ref "/f14/package/sugar-surf.md" >}}) | 0 | 55 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-tamtam]({{< ref "/f14/package/sugar-tamtam.md" >}}) | 0 | 2077 | 0.0 | LANGUAGE <LL@li.org> | 
