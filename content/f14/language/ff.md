---
title: "ff-Fula (Pulaar) - translation progress for f14"
...
Language progress for Fula (ff) in Fedora f14 is:

* 39.39% when we only look on started packages for this language.
* 0.03% when we compare to every single translatable string in Fedora f14.

Possible scripts are: LatnAdlm

* Total translatable string in Fedora f14: 10474277
* Source words to translate in started packages: 8916
...
* [ff generated stats (1.8 kB)]({{% resource url="/f14/ff.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [pootle]({{< ref "/f14/package/pootle.md" >}}) | 3497 | 3497 | 100.0 | LANGUAGE <LL@li.org> | 
 | [sugar-calculator]({{< ref "/f14/package/sugar-calculator.md" >}}) | 13 | 593 | 2.2 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-read]({{< ref "/f14/package/sugar-read.md" >}}) | 0 | 25 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-surf]({{< ref "/f14/package/sugar-surf.md" >}}) | 0 | 46 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-tamtam]({{< ref "/f14/package/sugar-tamtam.md" >}}) | 0 | 2069 | 0.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-write]({{< ref "/f14/package/sugar-write.md" >}}) | 0 | 69 | 0.0 | LANGUAGE <LL@li.org> | 
{.sortable}
