---
title: "hne-Chhattisgarhi (छत्तीसगढ़ी) - translation progress for f14"
...
Language progress for Chhattisgarhi (hne) in Fedora f14 is:

* 27.85% when we only look on started packages for this language.
* 0.19% when we compare to every single translatable string in Fedora f14.

Possible scripts are: Deva

* Total translatable string in Fedora f14: 10474277
* Source words to translate in started packages: 73107
* Translated words: 20360
...
* [hne generated stats (1.2 kB)]({{% resource url="/f14/hne.csv" %}})
