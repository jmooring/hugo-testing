---
title: "lg-Ganda (Luganda) - translation progress for f14"
...
Language progress for Ganda (lg) in Fedora f14 is:

* 68.65% when we only look on started packages for this language.
* 0.26% when we compare to every single translatable string in Fedora f14.

Possible scripts are: Latn

* Total translatable string in Fedora f14: 10474277
* Source words to translate in started packages: 39626
* Translated words: 27202
...
* [lg generated stats (754 Bytes)]({{% resource url="/f14/lg.csv" %}})
