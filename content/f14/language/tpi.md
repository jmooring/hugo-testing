---
title: "tpi-Tok Pisin (Tok Pisin) - translation progress for f14"
...
Language progress for Tok Pisin (tpi) in Fedora f14 is:
...
* Source words to translate in started packages: 5539
* Translated words: 2
...
* [tpi generated stats (1.8 kB)]({{% resource url="/f14/tpi.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [sugar]({{< ref "/f14/package/sugar.md" >}}) | 0 | 319 | 0.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-connect]({{< ref "/f14/package/sugar-connect.md" >}}) | 0 | 36 | 0.0 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-read]({{< ref "/f14/package/sugar-read.md" >}}) | 0 | 26 | 0.0 | LANGUAGE <LL@li.org> | 
