---
title: "ay-Aymara (Aymar aru) - translation progress for f14"
...
Language progress for Aymara (ay) in Fedora f14 is:
...
* Source words to translate in started packages: 5430
* Translated words: 49
...
* [ay generated stats (1.8 kB)]({{% resource url="/f14/ay.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-base]({{< ref "/f14/package/sugar-base.md" >}}) | 5 | 5 | 100.0 | LANGUAGE <LL@li.org> | 
 | [sugar-memorize]({{< ref "/f14/package/sugar-memorize.md" >}}) | 42 | 50 | 84.0 | OLE Bolivia <amosbatto@yahoo.com> | 
