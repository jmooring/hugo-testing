---
title: "ar_EG-Arabic (Egypt) (العربية (مصر)) - translation progress for f36"
...
Language progress for Arabic (Egypt) (ar_EG) in Fedora f36 is:

* 93.34% when we only look on started packages for this language.
...
* Source words to translate in started packages: 32634
* Translated words: 30462
...
* [ar_EG generated stats (1.0 kB)]({{% resource url="/f36/ar_EG.csv" %}})
