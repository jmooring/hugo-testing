---
title: "oj- () - translation progress for f36"
...
Language progress for  (oj) in Fedora f36 is:

* 0.63% when we only look on started packages for this language.
...
* Source words to translate in started packages: 27942
* Translated words: 176
...
* [oj generated stats (3.2 kB)]({{% resource url="/f36/oj.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f36/package/tuxpaint.md" >}}) | 176 | 3763 | 4.7 | Ed <edm@rocketmail.com> | 
 ...
 | [stellarium]({{< ref "/f36/package/stellarium.md" >}}) | 0 | 29 | 0.0 | Ojibwe <oj@li.org> | 
