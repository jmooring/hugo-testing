---
title: "ro_MD-Romanian (Moldova) (Română (Republica Moldova)) - translation progress for f36"
...
Language progress for Romanian (Moldova) (ro_MD) in Fedora f36 is:

* 17.59% when we only look on started packages for this language.
...
* Source words to translate in started packages: 33283
* Translated words: 5855
...
* [ro_MD generated stats (6.9 kB)]({{% resource url="/f36/ro_MD.csv" %}})
