---
title: "ar_SA-Arabic (Saudi Arabia) (العربية (المملكة العربية السعودية)) - translation progress for f36"
...
Language progress for Arabic (Saudi Arabia) (ar_SA) in Fedora f36 is:

* 58.68% when we only look on started packages for this language.
* 0.26% when we compare to every single translatable string in Fedora f36.

Possible scripts are: Arab

* Total translatable string in Fedora f36: 19217678
* Source words to translate in started packages: 83711
* Translated words: 49122
...
* [ar_SA generated stats (1.1 kB)]({{% resource url="/f36/ar_SA.csv" %}})
