...
layoutEngine
: (`string`) The D2 layout engine to use when automatically arranging diagram elements, one of `dagre`, `elk`, or  `tala`. This value is case-insensitive. Default is `dagre`. See [documentation][] for details.
