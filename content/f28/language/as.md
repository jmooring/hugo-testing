---
title: "as-Assamese (অসমীয়া) - translation progress for f28"
...
territories:
 - IN
polib_error_count: 2
could_not_process_count: 658
---

Language progress for Assamese (as) in Fedora f28 is:

* 60.84% when we only look on started packages for this language.
* 4.59% when we compare to every single translatable string in Fedora f28.

Possible scripts are: Beng

* Total translatable string in Fedora f28: 15305875
* Source words to translate in started packages: 1155372
* Translated words: 702941
...
* [as generated stats (35.1 kB)]({{% resource url="/f28/as.csv" %}})
