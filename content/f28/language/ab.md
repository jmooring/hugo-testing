---
title: "ab-Abkhazian (Аԥсшәа) - translation progress for f28"
...
Language progress for Abkhazian (ab) in Fedora f28 is:

* 19.00% when we only look on started packages for this language.
* 0.26% when we compare to every single translatable string in Fedora f28.

Possible scripts are: Cyrl

* Total translatable string in Fedora f28: 15305875
* Source words to translate in started packages: 207924
* Translated words: 39510
...
* [ab generated stats (3.2 kB)]({{% resource url="/f28/ab.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f28/package/libreoffice.md" >}}) | 39503 | 98045 | 40.3 | LANGUAGE <LL@li.org> | 
 | [openerp]({{< ref "/f28/package/openerp.md" >}}) | 3 | 23720 | 0.0 |  | 
 | [stellarium]({{< ref "/f28/package/stellarium.md" >}}) | 4 | 68196 | 0.0 | Abkhaz (https://www.transifex.com/stellarium/teams/80998/ab/) | 
 ...
 | [gscan2pdf]({{< ref "/f28/package/gscan2pdf.md" >}}) | 0 | 1840 | 0.0 | Abkhazian <ab@li.org> | 
 | [harvey]({{< ref "/f28/package/harvey.md" >}}) | 0 | 57 | 0.0 | none | 
 | [iso-codes]({{< ref "/f28/package/iso-codes.md" >}}) | 0 | 986 | 0.0 | Abkhazian <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ab/> | 
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Abkhazian <ab@li.org> | 
