---
title: "tn-Tswana (Setswana) - translation progress for f28"
...
Language progress for Tswana (tn) in Fedora f28 is:

* 20.57% when we only look on started packages for this language.
* 0.15% when we compare to every single translatable string in Fedora f28.
...
* [tn generated stats (2.9 kB)]({{% resource url="/f28/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f28/package/libreoffice.md" >}}) | 23287 | 98080 | 23.7 | LANGUAGE <LL@li.org> | 
