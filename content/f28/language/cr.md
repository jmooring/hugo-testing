---
title: "cr- () - translation progress for f28"
...
Language progress for  (cr) in Fedora f28 is:
...
* [cr generated stats (2.8 kB)]({{% resource url="/f28/cr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Cree <cr@li.org> | 
