---
title: "co-Corsican (Corsu) - translation progress for f28"
...
Language progress for Corsican (co) in Fedora f28 is:

* 45.04% when we only look on started packages for this language.
* 0.08% when we compare to every single translatable string in Fedora f28.

Possible scripts are: Latn

* Total translatable string in Fedora f28: 15305875
* Source words to translate in started packages: 28862
* Translated words: 13000
...
* [co generated stats (3.0 kB)]({{% resource url="/f28/co.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [filezilla]({{< ref "/f28/package/filezilla.md" >}}) | 10867 | 10873 | 99.9 | Patriccollu di Santa Maria è Sichè <Patrick.Santa-Maria[AT]laposte.net> | 
 | [poedit]({{< ref "/f28/package/poedit.md" >}}) | 2133 | 2774 | 76.9 | Corsican | 
 ...
 | [lightdm]({{< ref "/f28/package/lightdm.md" >}}) | 0 | 84 | 0.0 | Corsican <co@li.org> | 
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Corsican <co@li.org> | 
