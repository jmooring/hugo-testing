---
title: "mh-Marshallese (Kajin M̧ajeļ) - translation progress for f28"
...
Language progress for Marshallese (mh) in Fedora f28 is:
...
* Source words to translate in started packages: 17601
* Translated words: 0
...
* [mh generated stats (2.9 kB)]({{% resource url="/f28/mh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Marshallese <mh@li.org> | 
