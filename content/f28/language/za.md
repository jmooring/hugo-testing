---
title: "za-Zhuang (Vahcuengh) - translation progress for f28"
...
Language progress for Zhuang (za) in Fedora f28 is:

* 30.67% when we only look on started packages for this language.
...
* Source words to translate in started packages: 22651
...
* [za generated stats (2.8 kB)]({{% resource url="/f28/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f28/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
