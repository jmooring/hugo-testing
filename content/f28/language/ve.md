---
title: "ve-Venda (Tshivenḓa) - translation progress for f28"
...
Language progress for Venda (ve) in Fedora f28 is:

* 10.84% when we only look on started packages for this language.
...
* Source words to translate in started packages: 305235
* Translated words: 33092
...
* [ve generated stats (3.3 kB)]({{% resource url="/f28/ve.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f28/package/libreoffice.md" >}}) | 30828 | 98080 | 31.4 | LANGUAGE <LL@li.org> | 
 | [koffice-kivio]({{< ref "/f28/package/koffice-kivio.md" >}}) | 1896 | 8417 | 22.5 | <en@li.org> | 
 | [iso-codes]({{< ref "/f28/package/iso-codes.md" >}}) | 321 | 22383 | 1.4 | Venda <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ve/> | 
 | [calibre]({{< ref "/f28/package/calibre.md" >}}) | 47 | 158760 | 0.0 | Venda (http://www.transifex.com/calibre/calibre/language/ve/) | 
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Venda <ve@li.org> | 
