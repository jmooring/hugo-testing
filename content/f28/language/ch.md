---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f28"
...
Language progress for Chamorro (ch) in Fedora f28 is:
...
* [ch generated stats (2.9 kB)]({{% resource url="/f28/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f28/package/iso-codes.md" >}}) | 31 | 986 | 3.1 | Chamorro <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ch/> | 
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chamorro <ch@li.org> | 
