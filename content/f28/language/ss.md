---
title: "ss-Swati (siSwati) - translation progress for f28"
...
Language progress for Swati (ss) in Fedora f28 is:

* 27.53% when we only look on started packages for this language.
...
* Source words to translate in started packages: 113211
* Translated words: 31169
...
* [ss generated stats (2.8 kB)]({{% resource url="/f28/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f28/package/libreoffice.md" >}}) | 31169 | 98080 | 31.8 | LANGUAGE <LL@li.org> | 
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Swati <ss@li.org> | 
