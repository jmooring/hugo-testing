---
title: "sg-Sango (Sängö) - translation progress for f28"
...
Language progress for Sango (sg) in Fedora f28 is:
...
* [sg generated stats (2.8 kB)]({{% resource url="/f28/sg.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Sango <sg@li.org> | 
