---
title: "bh- () - translation progress for f28"
...
Language progress for  (bh) in Fedora f28 is:
...
* [bh generated stats (2.8 kB)]({{% resource url="/f28/bh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f28/package/stellarium.md" >}}) | 2 | 26769 | 0.0 | Bihari <bh@li.org> | 
