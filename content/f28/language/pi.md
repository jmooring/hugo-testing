---
title: "pi- () - translation progress for f28"
...
Language progress for  (pi) in Fedora f28 is:

* 1.49% when we only look on started packages for this language.
...
* Source words to translate in started packages: 12572
...
* [pi generated stats (2.5 kB)]({{% resource url="/f28/pi.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f28/package/iso-codes.md" >}}) | 187 | 986 | 19.0 | Pali <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/pi/> | 
