---
title: "ny-Nyanja (Nyanja) - translation progress for f28"
...
Language progress for Nyanja (ny) in Fedora f28 is:
...
* [ny generated stats (2.8 kB)]({{% resource url="/f28/ny.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Chewa; Chichewa; Nyanja <ny@li.org> | 
