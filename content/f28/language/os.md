---
title: "os-Ossetic (Ирон) - translation progress for f28"
...
Language progress for Ossetic (os) in Fedora f28 is:

* 4.74% when we only look on started packages for this language.
...
* Source words to translate in started packages: 94494
* Translated words: 4483
...
* [os generated stats (3.4 kB)]({{% resource url="/f28/os.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [slick-greeter]({{< ref "/f28/package/slick-greeter.md" >}}) | 161 | 211 | 76.3 | Ossetian <os@li.org> | 
 | [python2-django1.11]({{< ref "/f28/package/python2-django1.11.md" >}}) | 2177 | 3424 | 63.6 | Ossetic (http://www.transifex.com/django/django/language/os/) | 
 | [python-django]({{< ref "/f28/package/python-django.md" >}}) | 2137 | 3488 | 61.3 | Ossetic (http://www.transifex.com/django/django/language/os/) | 
 | [python-django-formtools]({{< ref "/f28/package/python-django-formtools.md" >}}) | 5 | 32 | 15.6 | Ossetic (http://www.transifex.com/projects/p/django-formtools/language/os/) | 
 | [exaile]({{< ref "/f28/package/exaile.md" >}}) | 1 | 4006 | 0.0 | Ossetian <os@li.org> | 
 | [stellarium]({{< ref "/f28/package/stellarium.md" >}}) | 2 | 68196 | 0.0 | Ossetic (https://www.transifex.com/stellarium/teams/80998/os/) | 
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Ossetian <os@li.org> | 
