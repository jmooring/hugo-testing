---
title: "nr-South Ndebele (isiNdebele) - translation progress for f28"
...
Language progress for South Ndebele (nr) in Fedora f28 is:

* 27.01% when we only look on started packages for this language.
* 0.20% when we compare to every single translatable string in Fedora f28.

Possible scripts are: Latn

* Total translatable string in Fedora f28: 15305875
* Source words to translate in started packages: 113217
* Translated words: 30582
...
* [nr generated stats (2.9 kB)]({{% resource url="/f28/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f28/package/libreoffice.md" >}}) | 30582 | 98080 | 31.2 | LANGUAGE <LL@li.org> | 
