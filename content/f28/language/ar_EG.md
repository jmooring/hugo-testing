---
title: "ar_EG-Arabic (Egypt) (العربية (مصر)) - translation progress for f28"
...
Language progress for Arabic (Egypt) (ar_EG) in Fedora f28 is:

* 94.54% when we only look on started packages for this language.
* 0.23% when we compare to every single translatable string in Fedora f28.

Possible scripts are: Arab

* Total translatable string in Fedora f28: 15305875
* Source words to translate in started packages: 37835
* Translated words: 35769
...
* [ar_EG generated stats (1.1 kB)]({{% resource url="/f28/ar_EG.csv" %}})
