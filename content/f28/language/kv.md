---
title: "kv-Komi (Коми кыв) - translation progress for f28"
...
Language progress for Komi (kv) in Fedora f28 is:

* 4.47% when we only look on started packages for this language.
...
* Source words to translate in started packages: 16123
* Translated words: 720
...
* [kv generated stats (2.9 kB)]({{% resource url="/f28/kv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [appcenter]({{< ref "/f28/package/appcenter.md" >}}) | 587 | 765 | 76.7 | Komi <https://weblate.elementary.io/projects/appcenter/appcenter/kv/> | 
 | [iso-codes]({{< ref "/f28/package/iso-codes.md" >}}) | 133 | 986 | 13.5 | Komi <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/kv/> | 
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Komi <kv@li.org> | 
