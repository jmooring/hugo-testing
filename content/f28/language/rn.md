---
title: "rn-Rundi (Ikirundi) - translation progress for f28"
...
Language progress for Rundi (rn) in Fedora f28 is:
...
* [rn generated stats (2.8 kB)]({{% resource url="/f28/rn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [vocal]({{< ref "/f28/package/vocal.md" >}}) | 0 | 377 | 0.0 | Rundi <rn@li.org> | 
