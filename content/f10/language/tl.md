---
title: "tl-Tagalog (Tagalog) - translation progress for f10"
...
Language progress for Tagalog (tl) in Fedora f10 is:

* 4.45% when we only look on started packages for this language.
* 0.21% when we compare to every single translatable string in Fedora f10.

Possible scripts are: Latn

* Total translatable string in Fedora f10: 5351743
* Source words to translate in started packages: 251112
* Translated words: 11168
...
* [tl generated stats (1.7 kB)]({{% resource url="/f10/tl.csv" %}})
