---
title: "ig-Igbo (Igbo) - translation progress for f10"
...
Language progress for Igbo (ig) in Fedora f10 is:
...
* Source words to translate in started packages: 2072
* Translated words: 9
...
* [ig generated stats (1.2 kB)]({{% resource url="/f10/ig.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar]({{< ref "/f10/package/sugar.md" >}}) | 9 | 242 | 3.7 | Igbo | 
...
|---------|--------------------------|-------------|------|
 | [sugar-calculator]({{< ref "/f10/package/sugar-calculator.md" >}}) | /mnt/stockage/packages/f10/sugar-calculator/po/ig.po | error-os |  | 
{.sortable}
