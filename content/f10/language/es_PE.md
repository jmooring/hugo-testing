---
title: "es_PE-Spanish (Peru) (Español (Perú)) - translation progress for f10"
...
Language progress for Spanish (Peru) (es_PE) in Fedora f10 is:
...
* [es_PE generated stats (490 Bytes)]({{% resource url="/f10/es_PE.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [fuse-encfs]({{< ref "/f10/package/fuse-encfs.md" >}}) | 134 | 1311 | 10.2 | Spanish (Peru) <es_PE@li.org> | 
{.sortable}
