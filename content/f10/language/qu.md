---
title: "qu-Quechua (Runasimi) - translation progress for f10"
...
Language progress for Quechua (qu) in Fedora f10 is:
...
* Source words to translate in started packages: 2064
* Translated words: 0
...
* [qu generated stats (1.2 kB)]({{% resource url="/f10/qu.csv" %}})
...
|---------|--------------------------|-------------|------|
 | [sugar-calculator]({{< ref "/f10/package/sugar-calculator.md" >}}) | /mnt/stockage/packages/f10/sugar-calculator/po/qu.po | error-os |  | 
{.sortable}
