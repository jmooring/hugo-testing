---
title: "fy-Western Frisian (Frysk) - translation progress for f10"
...
Language progress for Western Frisian (fy) in Fedora f10 is:

* 53.13% when we only look on started packages for this language.
* 0.36% when we compare to every single translatable string in Fedora f10.

Possible scripts are: Latn

* Total translatable string in Fedora f10: 5351743
* Source words to translate in started packages: 36289
* Translated words: 19280
...
* [fy generated stats (979 Bytes)]({{% resource url="/f10/fy.csv" %}})
