---
title: "tn-Tswana (Setswana) - translation progress for f39"
...
Language progress for Tswana (tn) in Fedora f39 is:

* 11.89% when we only look on started packages for this language.
* 0.10% when we compare to every single translatable string in Fedora f39.

Possible scripts are: Latn

* Total translatable string in Fedora f39: 20873322
* Source words to translate in started packages: 182600
* Translated words: 21717
...
* [tn generated stats (1.3 kB)]({{% resource url="/f39/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f39/package/libreoffice.md" >}}) | 21717 | 171188 | 12.7 | LANGUAGE <LL@li.org> | 
