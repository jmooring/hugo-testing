---
title: "iu-Inuktitut (ᐃᓄᒃᑎᑐᑦ) - translation progress for f39"
...
Language progress for Inuktitut (iu) in Fedora f39 is:

* 17.71% when we only look on started packages for this language.
...
* Source words to translate in started packages: 24048
* Translated words: 4258
...
* [iu generated stats (1.5 kB)]({{% resource url="/f39/iu.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint-stamps]({{< ref "/f39/package/tuxpaint-stamps.md" >}}) | 3082 | 3249 | 94.9 |  | 
 | [tuxpaint]({{< ref "/f39/package/tuxpaint.md" >}}) | 1144 | 3763 | 30.4 | LANGUAGE <harveyginter@gmail.com> | 
 | [iso-codes]({{< ref "/f39/package/iso-codes.md" >}}) | 32 | 989 | 3.2 | Inuktitut <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/iu/> | 
 | [bookworm]({{< ref "/f39/package/bookworm.md" >}}) | 0 | 795 | 0.0 |  | 
 | [coin]({{< ref "/f39/package/coin.md" >}}) | 0 | 252 | 0.0 | none | 
 | [deluge]({{< ref "/f39/package/deluge.md" >}}) | 0 | 4340 | 0.0 | Inuktitut <iu@li.org> | 
 ...
 | [gnome-do]({{< ref "/f39/package/gnome-do.md" >}}) | 0 | 612 | 0.0 | Inuktitut <iu@li.org> | 
