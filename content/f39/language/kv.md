---
title: "kv-Komi (Коми кыв) - translation progress for f39"
...
Language progress for Komi (kv) in Fedora f39 is:

* 5.43% when we only look on started packages for this language.
...
* Source words to translate in started packages: 21760
* Translated words: 1181
...
* [kv generated stats (1.4 kB)]({{% resource url="/f39/kv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f39/package/iso-codes.md" >}}) | 132 | 989 | 13.3 | Komi <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/kv/> | 
 | [minetest]({{< ref "/f39/package/minetest.md" >}}) | 1049 | 9676 | 10.8 | Komi <https://hosted.weblate.org/projects/minetest/minetest/kv/> | 
