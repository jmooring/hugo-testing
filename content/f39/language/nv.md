---
title: "nv-Navajo (Diné Bizaad) - translation progress for f39"
...
Language progress for Navajo (nv) in Fedora f39 is:

* 0.91% when we only look on started packages for this language.
...
* [nv generated stats (1.3 kB)]({{% resource url="/f39/nv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f39/package/iso-codes.md" >}}) | 110 | 989 | 11.1 | Navaho <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/nv/> | 
