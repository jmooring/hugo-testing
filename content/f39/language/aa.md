---
title: "aa-Afar (Qafar) - translation progress for f39"
...
Language progress for Afar (aa) in Fedora f39 is:
...
* Source words to translate in started packages: 18676
...
* [aa generated stats (1.4 kB)]({{% resource url="/f39/aa.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [folder-color-switcher]({{< ref "/f39/package/folder-color-switcher.md" >}}) | 42 | 65 | 64.6 | Afar <aa@li.org> | 
 | [maliit-keyboard]({{< ref "/f39/package/maliit-keyboard.md" >}}) | 31 | 81 | 38.3 | Afar <aa@li.org> | 
 | [cinnamon-translations]({{< ref "/f39/package/cinnamon-translations.md" >}}) | 164 | 7435 | 2.2 | Afar <aa@li.org> | 
 | [bookworm]({{< ref "/f39/package/bookworm.md" >}}) | 0 | 795 | 0.0 | Afar | 
