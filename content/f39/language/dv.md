---
title: "dv-Divehi (ދިވެހިބަސް) - translation progress for f39"
...
Language progress for Divehi (dv) in Fedora f39 is:

* 3.37% when we only look on started packages for this language.
...
* Source words to translate in started packages: 24275
...
* [dv generated stats (1.6 kB)]({{% resource url="/f39/dv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gnome-menus]({{< ref "/f39/package/gnome-menus.md" >}}) | 157 | 157 | 100.0 | Divehi <dv@li.org> | 
 | [iso-codes]({{< ref "/f39/package/iso-codes.md" >}}) | 275 | 989 | 27.8 | Dhivehi <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/dv/> | 
 | [gnome-do]({{< ref "/f39/package/gnome-do.md" >}}) | 162 | 612 | 26.5 | Divehi <dv@li.org> | 
 | [minetest]({{< ref "/f39/package/minetest.md" >}}) | 206 | 9676 | 2.1 | Dhivehi <https://hosted.weblate.org/projects/minetest/minetest/dv/> | 
 | [pinta]({{< ref "/f39/package/pinta.md" >}}) | 17 | 1746 | 1.0 | Divehi <dv@li.org> | 
