---
title: "oj- () - translation progress for f39"
...
Language progress for  (oj) in Fedora f39 is:
...
* Source words to translate in started packages: 14887
...
* [oj generated stats (1.3 kB)]({{% resource url="/f39/oj.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f39/package/tuxpaint.md" >}}) | 176 | 3763 | 4.7 | Ed <edm@rocketmail.com> | 
 ...
 | [stellarium]({{< ref "/f39/package/stellarium.md" >}}) | 0 | 29 | 0.0 | Ojibwe <oj@li.org> | 
