---
title: "za-Zhuang (Vahcuengh) - translation progress for f39"
...
Language progress for Zhuang (za) in Fedora f39 is:

* 36.69% when we only look on started packages for this language.
...
* Source words to translate in started packages: 18932
...
* [za generated stats (1.3 kB)]({{% resource url="/f39/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f39/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
