---
title: "na-Nauru (Dorerin Naoero) - translation progress for f39"
...
Language progress for Nauru (na) in Fedora f39 is:
...
* Source words to translate in started packages: 12364
...
* [na generated stats (1.4 kB)]({{% resource url="/f39/na.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f39/package/iso-codes.md" >}}) | 186 | 989 | 18.8 | Nauru <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/na/> | 
 | [sugar-chat]({{< ref "/f39/package/sugar-chat.md" >}}) | 24 | 137 | 17.5 | LANGUAGE <LL@li.org> | 
