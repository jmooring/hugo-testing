---
title: "sr_Cyrl-Serbian (Cyrillic) (Српски (Ћирилица)) - translation progress for f39"
...
Language progress for Serbian (Cyrillic) (sr_Cyrl) in Fedora f39 is:

* 10.69% when we only look on started packages for this language.
...
* Source words to translate in started packages: 349988
* Translated words: 37397
...
* [sr_Cyrl generated stats (1.0 kB)]({{% resource url="/f39/sr_Cyrl.csv" %}})
