---
title: "ta-Tamil (தமிழ்) - translation progress for f39"
...
territories:
 ...
 - SG
polib_error_count: 1
could_not_process_count: 1461
---

Language progress for Tamil (ta) in Fedora f39 is:

* 43.12% when we only look on started packages for this language.
* 6.67% when we compare to every single translatable string in Fedora f39.

Possible scripts are: Taml

* Total translatable string in Fedora f39: 20873322
* Source words to translate in started packages: 3230064
* Translated words: 1392884
...
* [ta generated stats (60.1 kB)]({{% resource url="/f39/ta.csv" %}})
