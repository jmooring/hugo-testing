---
title: "nr-South Ndebele (isiNdebele) - translation progress for f39"
...
Language progress for South Ndebele (nr) in Fedora f39 is:

* 15.56% when we only look on started packages for this language.
* 0.14% when we compare to every single translatable string in Fedora f39.

Possible scripts are: Latn

* Total translatable string in Fedora f39: 20873322
* Source words to translate in started packages: 186046
* Translated words: 28940
...
* [nr generated stats (1.3 kB)]({{% resource url="/f39/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f39/package/libreoffice.md" >}}) | 28587 | 171188 | 16.7 | LANGUAGE <LL@li.org> | 
 | [tuxpaint]({{< ref "/f39/package/tuxpaint.md" >}}) | 353 | 3763 | 9.4 | LANGUAGE <LL@li.org> | 
