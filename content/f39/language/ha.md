---
title: "ha-Hausa (Hausa) - translation progress for f39"
...
Language progress for Hausa (ha) in Fedora f39 is:

* 15.15% when we only look on started packages for this language.
* 0.11% when we compare to every single translatable string in Fedora f39.

Possible scripts are: LatnArab

* Total translatable string in Fedora f39: 20873322
* Source words to translate in started packages: 156908
* Translated words: 23770
...
* [ha generated stats (8.1 kB)]({{% resource url="/f39/ha.csv" %}})
