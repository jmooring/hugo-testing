---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f39"
...
Language progress for Chamorro (ch) in Fedora f39 is:
...
* [ch generated stats (1.2 kB)]({{% resource url="/f39/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f39/package/iso-codes.md" >}}) | 30 | 989 | 3.0 | Chamorro <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ch/> | 
