---
title: "ss-Swati (siSwati) - translation progress for f39"
...
Language progress for Swati (ss) in Fedora f39 is:

* 15.98% when we only look on started packages for this language.
...
* Source words to translate in started packages: 182283
* Translated words: 29120
...
* [ss generated stats (1.2 kB)]({{% resource url="/f39/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f39/package/libreoffice.md" >}}) | 29120 | 171188 | 17.0 | LANGUAGE <LL@li.org> | 
