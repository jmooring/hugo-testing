---
title: "bm-Bambara (Bamanakan) - translation progress for f39"
...
Language progress for Bambara (bm) in Fedora f39 is:

* 7.58% when we only look on started packages for this language.
...
* Source words to translate in started packages: 15071
...
* [bm generated stats (1.3 kB)]({{% resource url="/f39/bm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f39/package/tuxpaint.md" >}}) | 1120 | 3763 | 29.8 | LANGUAGE <LL@li.org> | 
 | [sugar-toolkit-gtk3]({{< ref "/f39/package/sugar-toolkit-gtk3.md" >}}) | 23 | 213 | 10.8 | LANGUAGE <LL@li.org> | 
