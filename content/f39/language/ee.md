---
title: "ee-Ewe (Eʋegbe) - translation progress for f39"
...
Language progress for Ewe (ee) in Fedora f39 is:

* 0.23% when we only look on started packages for this language.
...
* Source words to translate in started packages: 12418
* Translated words: 29
...
* [ee generated stats (1.3 kB)]({{% resource url="/f39/ee.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [vdr-skinenigmang]({{< ref "/f39/package/vdr-skinenigmang.md" >}}) | 29 | 334 | 8.7 | <vdr@linuxtv.org> | 
 ...
 | [iso-codes]({{< ref "/f39/package/iso-codes.md" >}}) | 0 | 989 | 0.0 | Ewe <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ee/> | 
