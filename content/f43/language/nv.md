---
title: "nv-Navajo (Diné Bizaad) - translation progress for f43"
...
Language progress for Navajo (nv) in Fedora f43 is:
...
* [nv compendium (44.2 kB)]({{% resource url="/f43/nv.po.gz" %}}) (aggregation of all strings found in po files)


* [nv terminology (13.2 kB)]({{% resource url="/f43/nv.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [nv translation memory (2.0 kB)]({{% resource url="/f43/nv.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [nv generated stats (1.3 kB)]({{% resource url="/f43/nv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f43/package/iso-codes.md" >}}) | 110 | 989 | 11.1 | Navaho <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/nv/> | 
