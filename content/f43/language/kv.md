---
title: "kv-Komi (Коми кыв) - translation progress for f43"
...
Language progress for Komi (kv) in Fedora f43 is:

* 4.35% when we only look on started packages for this language.
...
* Source words to translate in started packages: 25417
* Translated words: 1106


Download:

* [kv compendium (75.1 kB)]({{% resource url="/f43/kv.po.gz" %}}) (aggregation of all strings found in po files)


* [kv terminology (23.0 kB)]({{% resource url="/f43/kv.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [kv translation memory (9.6 kB)]({{% resource url="/f43/kv.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [kv generated stats (1.4 kB)]({{% resource url="/f43/kv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f43/package/iso-codes.md" >}}) | 132 | 989 | 13.3 | Komi <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/kv/> | 
 | [minetest]({{< ref "/f43/package/minetest.md" >}}) | 974 | 10452 | 9.3 | Komi <https://hosted.weblate.org/projects/minetest/minetest/kv/> | 
