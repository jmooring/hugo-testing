---
title: "ho-Hiri Motu (Hiri Motu) - translation progress for f43"
...
Language progress for Hiri Motu (ho) in Fedora f43 is:
...
* [ho compendium (38.1 kB)]({{% resource url="/f43/ho.po.gz" %}}) (aggregation of all strings found in po files)


* [ho terminology (9.8 kB)]({{% resource url="/f43/ho.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ho translation memory (213 Bytes)]({{% resource url="/f43/ho.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ho generated stats (1.2 kB)]({{% resource url="/f43/ho.csv" %}})
