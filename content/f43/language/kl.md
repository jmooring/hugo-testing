---
title: "kl-Kalaallisut (Kalaallisut) - translation progress for f43"
...
Language progress for Kalaallisut (kl) in Fedora f43 is:

* 0.67% when we only look on started packages for this language.
...
* Source words to translate in started packages: 201699
* Translated words: 1360


Download:

* [kl compendium (924.6 kB)]({{% resource url="/f43/kl.po.gz" %}}) (aggregation of all strings found in po files)


* [kl terminology (196.1 kB)]({{% resource url="/f43/kl.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [kl translation memory (13.9 kB)]({{% resource url="/f43/kl.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [kl generated stats (1.8 kB)]({{% resource url="/f43/kl.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [slick-greeter]({{< ref "/f43/package/slick-greeter.md" >}}) | 54 | 216 | 25.0 | Greenlandic (Kalaallisut) <kl@li.org> | 
 | [libreoffice]({{< ref "/f43/package/libreoffice.md" >}}) | 1306 | 178000 | 0.7 | LANGUAGE <LL@li.org> | 
 ...
 | [iso-codes]({{< ref "/f43/package/iso-codes.md" >}}) | 0 | 989 | 0.0 | Greenlandic <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/kl/> | 
 | [lightdm]({{< ref "/f43/package/lightdm.md" >}}) | 0 | 84 | 0.0 | Greenlandic (Kalaallisut) <kl@li.org> | 
