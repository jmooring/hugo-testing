---
title: "ik-Inupiaq (Iñupiatun) - translation progress for f43"
...
Language progress for Inupiaq (ik) in Fedora f43 is:
...
* [ik compendium (38.1 kB)]({{% resource url="/f43/ik.po.gz" %}}) (aggregation of all strings found in po files)


* [ik terminology (9.8 kB)]({{% resource url="/f43/ik.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ik translation memory (213 Bytes)]({{% resource url="/f43/ik.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ik generated stats (1.2 kB)]({{% resource url="/f43/ik.csv" %}})
