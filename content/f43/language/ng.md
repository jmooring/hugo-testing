---
title: "ng-Ndonga (Ndonga) - translation progress for f43"
...
Language progress for Ndonga (ng) in Fedora f43 is:
...
* [ng compendium (38.1 kB)]({{% resource url="/f43/ng.po.gz" %}}) (aggregation of all strings found in po files)


* [ng terminology (9.8 kB)]({{% resource url="/f43/ng.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ng translation memory (213 Bytes)]({{% resource url="/f43/ng.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ng generated stats (1.2 kB)]({{% resource url="/f43/ng.csv" %}})
