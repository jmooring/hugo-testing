---
title: "tn-Tswana (Setswana) - translation progress for f43"
...
Language progress for Tswana (tn) in Fedora f43 is:

* 11.14% when we only look on started packages for this language.
* 0.10% when we compare to every single translatable string in Fedora f43.

Possible scripts are: Latn

* Total translatable string in Fedora f43: 21145798
* Source words to translate in started packages: 192293
* Translated words: 21429


Download:

* [tn compendium (980.7 kB)]({{% resource url="/f43/tn.po.gz" %}}) (aggregation of all strings found in po files)


* [tn terminology (208.1 kB)]({{% resource url="/f43/tn.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [tn translation memory (165.6 kB)]({{% resource url="/f43/tn.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [tn generated stats (1.3 kB)]({{% resource url="/f43/tn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f43/package/libreoffice.md" >}}) | 21429 | 178000 | 12.0 | LANGUAGE <LL@li.org> | 
