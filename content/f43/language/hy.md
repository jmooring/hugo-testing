---
title: "hy-Armenian (Հայերեն) - translation progress for f43"
...
Language progress for Armenian (hy) in Fedora f43 is:

* 43.38% when we only look on started packages for this language.
* 2.23% when we compare to every single translatable string in Fedora f43.

Possible scripts are: Armn

* Total translatable string in Fedora f43: 21145798
* Source words to translate in started packages: 1087546
* Translated words: 471820


Download:

* [hy compendium (4.2 MB)]({{% resource url="/f43/hy.po.gz" %}}) (aggregation of all strings found in po files)


* [hy terminology (977.8 kB)]({{% resource url="/f43/hy.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [hy translation memory (2.3 MB)]({{% resource url="/f43/hy.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [hy generated stats (28.5 kB)]({{% resource url="/f43/hy.csv" %}})
