---
title: "sg-Sango (Sängö) - translation progress for f43"
...
Language progress for Sango (sg) in Fedora f43 is:
...
* [sg compendium (38.1 kB)]({{% resource url="/f43/sg.po.gz" %}}) (aggregation of all strings found in po files)


* [sg terminology (9.8 kB)]({{% resource url="/f43/sg.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [sg translation memory (213 Bytes)]({{% resource url="/f43/sg.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [sg generated stats (1.2 kB)]({{% resource url="/f43/sg.csv" %}})
