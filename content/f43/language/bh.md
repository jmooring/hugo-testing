---
title: "bh- () - translation progress for f43"
...
Language progress for  (bh) in Fedora f43 is:
...
* [bh compendium (38.1 kB)]({{% resource url="/f43/bh.po.gz" %}}) (aggregation of all strings found in po files)


* [bh terminology (9.8 kB)]({{% resource url="/f43/bh.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [bh translation memory (213 Bytes)]({{% resource url="/f43/bh.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [bh generated stats (1.2 kB)]({{% resource url="/f43/bh.csv" %}})
