---
title: "so-Somali (Soomaali) - translation progress for f43"
...
Language progress for Somali (so) in Fedora f43 is:

* 2.33% when we only look on started packages for this language.
...
* Source words to translate in started packages: 60547
* Translated words: 1410


Download:

* [so compendium (252.5 kB)]({{% resource url="/f43/so.po.gz" %}}) (aggregation of all strings found in po files)


* [so terminology (52.4 kB)]({{% resource url="/f43/so.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [so translation memory (11.7 kB)]({{% resource url="/f43/so.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [so generated stats (1.8 kB)]({{% resource url="/f43/so.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-toolkit-gtk3](/f43/package/sugar-toolkit-gtk3) | 48 | 213 | 22.5 | LANGUAGE <LL@li.org> | 
 | [cinnamon-translations](/f43/package/cinnamon-translations) | 1113 | 19859 | 5.6 | Somali <so@li.org> | 
 | [mate-menu](/f43/package/mate-menu) | 6 | 308 | 1.9 | Somali (http://www.transifex.com/mate/MATE/language/so/) | 
 | [iso-codes](/f43/package/iso-codes) | 221 | 22779 | 1.0 | Somali <https://hosted.weblate.org/projects/iso-codes/iso-15924/so/> | 
 | [mate-control-center](/f43/package/mate-control-center) | 22 | 3338 | 0.7 | Somali (https://www.transifex.com/mate/teams/13566/so/) | 
 ...
 | [mate-themes](/f43/package/mate-themes) | 0 | 74 | 0.0 | Somali (http://app.transifex.com/mate/MATE/language/so/) | 
