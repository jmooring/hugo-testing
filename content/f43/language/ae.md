---
title: "ae- () - translation progress for f43"
...
Language progress for  (ae) in Fedora f43 is:
...
* [ae compendium (37.8 kB)]({{% resource url="/f43/ae.po.gz" %}}) (aggregation of all strings found in po files)


* [ae terminology (9.8 kB)]({{% resource url="/f43/ae.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ae translation memory (213 Bytes)]({{% resource url="/f43/ae.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ae generated stats (1.1 kB)]({{% resource url="/f43/ae.csv" %}})
