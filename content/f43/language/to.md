---
title: "to-Tongan (Lea fakatonga) - translation progress for f43"
...
Language progress for Tongan (to) in Fedora f43 is:

* 1.76% when we only look on started packages for this language.
...
* Source words to translate in started packages: 18358
* Translated words: 323


Download:

* [to compendium (55.0 kB)]({{% resource url="/f43/to.po.gz" %}}) (aggregation of all strings found in po files)


* [to terminology (13.8 kB)]({{% resource url="/f43/to.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [to translation memory (3.2 kB)]({{% resource url="/f43/to.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [to generated stats (2.1 kB)]({{% resource url="/f43/to.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [sugar-distance]({{< ref "/f43/package/sugar-distance.md" >}}) | 70 | 99 | 70.7 | LANGUAGE <LL@li.org> | 
 | [sugar-toolkit-gtk3]({{< ref "/f43/package/sugar-toolkit-gtk3.md" >}}) | 120 | 213 | 56.3 | LANGUAGE <LL@li.org> | 
 | [sugar-abacus]({{< ref "/f43/package/sugar-abacus.md" >}}) | 11 | 28 | 39.3 | LANGUAGE <LL@li.org> | 
 | [sugar-pippy]({{< ref "/f43/package/sugar-pippy.md" >}}) | 48 | 274 | 17.5 | LANGUAGE <LL@li.org> | 
 | [sugar]({{< ref "/f43/package/sugar.md" >}}) | 71 | 2305 | 3.1 | LANGUAGE <LL@li.org> | 
 | [sugar-memorize]({{< ref "/f43/package/sugar-memorize.md" >}}) | 1 | 142 | 0.7 | LANGUAGE <LL@li.org> | 
 | [sugar-finance]({{< ref "/f43/package/sugar-finance.md" >}}) | 1 | 258 | 0.4 | LANGUAGE <LL@li.org> | 
 | [sugar-browse]({{< ref "/f43/package/sugar-browse.md" >}}) | 1 | 334 | 0.3 | LANGUAGE <LL@li.org> | 
 ...
 | [sugar-dimensions]({{< ref "/f43/package/sugar-dimensions.md" >}}) | 0 | 161 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-implode]({{< ref "/f43/package/sugar-implode.md" >}}) | 0 | 77 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-physics]({{< ref "/f43/package/sugar-physics.md" >}}) | 0 | 48 | 0.0 | LANGUAGE <LL@li.org> | 
 | [sugar-view-slides]({{< ref "/f43/package/sugar-view-slides.md" >}}) | 0 | 60 | 0.0 | LANGUAGE <LL@li.org> | 
