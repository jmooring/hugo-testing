---
title: "oj- () - translation progress for f43"
...
Language progress for  (oj) in Fedora f43 is:
...
* [oj compendium (38.1 kB)]({{% resource url="/f43/oj.po.gz" %}}) (aggregation of all strings found in po files)


* [oj terminology (9.8 kB)]({{% resource url="/f43/oj.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [oj translation memory (213 Bytes)]({{% resource url="/f43/oj.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [oj generated stats (1.2 kB)]({{% resource url="/f43/oj.csv" %}})
