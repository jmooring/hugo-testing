---
title: "ss-Swati (siSwati) - translation progress for f43"
...
Language progress for Swati (ss) in Fedora f43 is:

* 14.98% when we only look on started packages for this language.
...
* Translated words: 28754


Download:

* [ss compendium (1.0 MB)]({{% resource url="/f43/ss.po.gz" %}}) (aggregation of all strings found in po files)


* [ss terminology (214.5 kB)]({{% resource url="/f43/ss.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ss translation memory (220.1 kB)]({{% resource url="/f43/ss.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ss generated stats (1.3 kB)]({{% resource url="/f43/ss.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f43/package/libreoffice.md" >}}) | 28754 | 178000 | 16.2 | LANGUAGE <LL@li.org> | 
