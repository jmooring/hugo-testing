---
title: "he_IL-Hebrew (Israel) (עברית (ישראל)) - translation progress for f43"
...
Language progress for Hebrew (Israel) (he_IL) in Fedora f43 is:

* 66.13% when we only look on started packages for this language.
...
* Source words to translate in started packages: 112947
* Translated words: 74693


Download:

* [he_IL compendium (272.7 kB)]({{% resource url="/f43/he_IL.po.gz" %}}) (aggregation of all strings found in po files)


* [he_IL terminology (73.6 kB)]({{% resource url="/f43/he_IL.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [he_IL translation memory (164.0 kB)]({{% resource url="/f43/he_IL.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [he_IL generated stats (1.7 kB)]({{% resource url="/f43/he_IL.csv" %}})
