---
title: "dv-Divehi (ދިވެހިބަސް) - translation progress for f43"
...
Language progress for Divehi (dv) in Fedora f43 is:

* 2.81% when we only look on started packages for this language.
...
* Source words to translate in started packages: 27932
* Translated words: 784


Download:

* [dv compendium (82.9 kB)]({{% resource url="/f43/dv.po.gz" %}}) (aggregation of all strings found in po files)


* [dv terminology (25.1 kB)]({{% resource url="/f43/dv.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [dv translation memory (8.6 kB)]({{% resource url="/f43/dv.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [dv generated stats (1.6 kB)]({{% resource url="/f43/dv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gnome-menus]({{< ref "/f43/package/gnome-menus.md" >}}) | 157 | 157 | 100.0 | Divehi <dv@li.org> | 
 | [iso-codes]({{< ref "/f43/package/iso-codes.md" >}}) | 275 | 989 | 27.8 | Dhivehi <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/dv/> | 
 | [gnome-do]({{< ref "/f43/package/gnome-do.md" >}}) | 162 | 612 | 26.5 | Divehi <dv@li.org> | 
 | [minetest]({{< ref "/f43/package/minetest.md" >}}) | 173 | 10452 | 1.7 | Dhivehi <https://hosted.weblate.org/projects/minetest/minetest/dv/> | 
 | [pinta]({{< ref "/f43/package/pinta.md" >}}) | 17 | 1746 | 1.0 | Divehi <dv@li.org> | 
