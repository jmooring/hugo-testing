---
title: "az-Azerbaijani (Azərbaycan) - translation progress for f43"
...
Language progress for Azerbaijani (az) in Fedora f43 is:

* 28.93% when we only look on started packages for this language.
* 2.18% when we compare to every single translatable string in Fedora f43.

Possible scripts are: LatnCyrlArab

* Total translatable string in Fedora f43: 21145798
* Source words to translate in started packages: 1593458
* Translated words: 460940


Download:

* [az compendium (5.4 MB)]({{% resource url="/f43/az.po.gz" %}}) (aggregation of all strings found in po files)


* [az terminology (1.3 MB)]({{% resource url="/f43/az.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [az translation memory (1.9 MB)]({{% resource url="/f43/az.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [az generated stats (44.0 kB)]({{% resource url="/f43/az.csv" %}})
