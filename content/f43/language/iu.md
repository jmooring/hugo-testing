---
title: "iu-Inuktitut (ᐃᓄᒃᑎᑐᑦ) - translation progress for f43"
...
Language progress for Inuktitut (iu) in Fedora f43 is:
...
* Source words to translate in started packages: 19967
* Translated words: 117


Download:

* [iu compendium (58.6 kB)]({{% resource url="/f43/iu.po.gz" %}}) (aggregation of all strings found in po files)


* [iu terminology (16.3 kB)]({{% resource url="/f43/iu.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [iu translation memory (1.8 kB)]({{% resource url="/f43/iu.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [iu generated stats (1.4 kB)]({{% resource url="/f43/iu.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes](/f43/package/iso-codes) | 32 | 989 | 3.2 | Inuktitut <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/iu/> | 
 | [elementary-photos](/f43/package/elementary-photos) | 85 | 2862 | 3.0 | LANGUAGE <LL@li.org> | 
 | [bookworm](/f43/package/bookworm) | 0 | 795 | 0.0 |  | 
 | [deluge](/f43/package/deluge) | 0 | 4390 | 0.0 | Inuktitut <iu@li.org> | 
 ...
 | [gnome-do](/f43/package/gnome-do) | 0 | 612 | 0.0 | Inuktitut <iu@li.org> | 
