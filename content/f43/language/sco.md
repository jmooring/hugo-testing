---
title: "sco-Scots (Scots) - translation progress for f43"
...
Language progress for Scots (sco) in Fedora f43 is:
...
* [sco compendium (143.0 kB)]({{% resource url="/f43/sco.po.gz" %}}) (aggregation of all strings found in po files)


* [sco terminology (36.8 kB)]({{% resource url="/f43/sco.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [sco translation memory (7.9 kB)]({{% resource url="/f43/sco.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [sco generated stats (1.3 kB)]({{% resource url="/f43/sco.csv" %}})
