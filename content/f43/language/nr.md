---
title: "nr-South Ndebele (isiNdebele) - translation progress for f43"
...
Language progress for South Ndebele (nr) in Fedora f43 is:

* 14.71% when we only look on started packages for this language.
...
* Source words to translate in started packages: 191976
* Translated words: 28234


Download:

* [nr compendium (1.0 MB)]({{% resource url="/f43/nr.po.gz" %}}) (aggregation of all strings found in po files)


* [nr terminology (218.8 kB)]({{% resource url="/f43/nr.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [nr translation memory (213.6 kB)]({{% resource url="/f43/nr.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [nr generated stats (1.3 kB)]({{% resource url="/f43/nr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f43/package/libreoffice.md" >}}) | 28234 | 178000 | 15.9 | LANGUAGE <LL@li.org> | 
