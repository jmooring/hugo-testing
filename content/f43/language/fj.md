---
title: "fj-Fijian (Fijian) - translation progress for f43"
...
Language progress for Fijian (fj) in Fedora f43 is:
...
* [fj compendium (38.1 kB)]({{% resource url="/f43/fj.po.gz" %}}) (aggregation of all strings found in po files)


* [fj terminology (9.8 kB)]({{% resource url="/f43/fj.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [fj translation memory (213 Bytes)]({{% resource url="/f43/fj.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [fj generated stats (1.2 kB)]({{% resource url="/f43/fj.csv" %}})
