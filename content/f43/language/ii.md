---
title: "ii-Sichuan Yi (ꆈꌠꉙ) - translation progress for f43"
...
Language progress for Sichuan Yi (ii) in Fedora f43 is:
...
* [ii compendium (38.1 kB)]({{% resource url="/f43/ii.po.gz" %}}) (aggregation of all strings found in po files)


* [ii terminology (9.8 kB)]({{% resource url="/f43/ii.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ii translation memory (213 Bytes)]({{% resource url="/f43/ii.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ii generated stats (1.2 kB)]({{% resource url="/f43/ii.csv" %}})
