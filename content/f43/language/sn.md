---
title: "sn-Shona (ChiShona) - translation progress for f43"
...
Language progress for Shona (sn) in Fedora f43 is:
...
* Source words to translate in started packages: 15355
* Translated words: 128


Download:

* [sn compendium (42.3 kB)]({{% resource url="/f43/sn.po.gz" %}}) (aggregation of all strings found in po files)


* [sn terminology (10.9 kB)]({{% resource url="/f43/sn.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [sn translation memory (1.2 kB)]({{% resource url="/f43/sn.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [sn generated stats (1.5 kB)]({{% resource url="/f43/sn.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [folder-color-switcher]({{< ref "/f43/package/folder-color-switcher.md" >}}) | 47 | 65 | 72.3 | Shona <sn@li.org> | 
 | [lightdm-settings]({{< ref "/f43/package/lightdm-settings.md" >}}) | 79 | 355 | 22.3 | Shona <sn@li.org> | 
 | [xapps]({{< ref "/f43/package/xapps.md" >}}) | 2 | 73 | 2.7 | Shona <sn@li.org> | 
 | [bookworm]({{< ref "/f43/package/bookworm.md" >}}) | 0 | 795 | 0.0 |  | 
 | [cinnamon-translations]({{< ref "/f43/package/cinnamon-translations.md" >}}) | 0 | 886 | 0.0 | Shona <sn@li.org> | 
