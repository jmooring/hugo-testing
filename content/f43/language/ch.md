---
title: "ch-Chamorro (Finu' Chamoru) - translation progress for f43"
...
Language progress for Chamorro (ch) in Fedora f43 is:
...
* [ch compendium (43.1 kB)]({{% resource url="/f43/ch.po.gz" %}}) (aggregation of all strings found in po files)


* [ch terminology (12.2 kB)]({{% resource url="/f43/ch.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ch translation memory (553 Bytes)]({{% resource url="/f43/ch.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ch generated stats (1.3 kB)]({{% resource url="/f43/ch.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f43/package/iso-codes.md" >}}) | 30 | 989 | 3.0 | Chamorro <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ch/> | 
