---
title: "ve-Venda (Tshivenḓa) - translation progress for f43"
...
Language progress for Venda (ve) in Fedora f43 is:

* 7.47% when we only look on started packages for this language.
...
* Source words to translate in started packages: 385732
* Translated words: 28832


Download:

* [ve compendium (1.5 MB)]({{% resource url="/f43/ve.po.gz" %}}) (aggregation of all strings found in po files)


* [ve terminology (335.8 kB)]({{% resource url="/f43/ve.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ve translation memory (220.1 kB)]({{% resource url="/f43/ve.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ve generated stats (1.5 kB)]({{% resource url="/f43/ve.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [libreoffice]({{< ref "/f43/package/libreoffice.md" >}}) | 28467 | 178000 | 16.0 | LANGUAGE <LL@li.org> | 
 | [iso-codes]({{< ref "/f43/package/iso-codes.md" >}}) | 318 | 22789 | 1.4 | Venda <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ve/> | 
 | [calibre]({{< ref "/f43/package/calibre.md" >}}) | 47 | 170967 | 0.0 | Venda (http://www.transifex.com/calibre/calibre/language/ve/) | 
