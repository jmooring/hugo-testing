---
title: "aa-Afar (Qafar) - translation progress for f43"
...
Language progress for Afar (aa) in Fedora f43 is:
...
* Source words to translate in started packages: 21852
* Translated words: 237


Download:

* [aa compendium (64.1 kB)]({{% resource url="/f43/aa.po.gz" %}}) (aggregation of all strings found in po files)


* [aa terminology (17.4 kB)]({{% resource url="/f43/aa.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [aa translation memory (1.9 kB)]({{% resource url="/f43/aa.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [aa generated stats (1.4 kB)]({{% resource url="/f43/aa.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [folder-color-switcher](/f43/package/folder-color-switcher) | 42 | 65 | 64.6 | Afar <aa@li.org> | 
 | [maliit-keyboard](/f43/package/maliit-keyboard) | 31 | 81 | 38.3 | Afar <aa@li.org> | 
 | [cinnamon-translations](/f43/package/cinnamon-translations) | 164 | 7730 | 2.1 | Afar <aa@li.org> | 
 | [bookworm](/f43/package/bookworm) | 0 | 795 | 0.0 | Afar | 
