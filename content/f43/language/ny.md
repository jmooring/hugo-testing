---
title: "ny-Nyanja (Nyanja) - translation progress for f43"
...
Language progress for Nyanja (ny) in Fedora f43 is:
...
* [ny compendium (38.1 kB)]({{% resource url="/f43/ny.po.gz" %}}) (aggregation of all strings found in po files)


* [ny terminology (9.8 kB)]({{% resource url="/f43/ny.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ny translation memory (213 Bytes)]({{% resource url="/f43/ny.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ny generated stats (1.2 kB)]({{% resource url="/f43/ny.csv" %}})
