---
title: "mh-Marshallese (Kajin M̧ajeļ) - translation progress for f43"
...
Language progress for Marshallese (mh) in Fedora f43 is:
...
* [mh compendium (38.1 kB)]({{% resource url="/f43/mh.po.gz" %}}) (aggregation of all strings found in po files)


* [mh terminology (9.8 kB)]({{% resource url="/f43/mh.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [mh translation memory (213 Bytes)]({{% resource url="/f43/mh.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [mh generated stats (1.2 kB)]({{% resource url="/f43/mh.csv" %}})
