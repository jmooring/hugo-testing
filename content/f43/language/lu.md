---
title: "lu-Luba-Katanga (Tshiluba) - translation progress for f43"
...
Language progress for Luba-Katanga (lu) in Fedora f43 is:
...
* [lu compendium (38.1 kB)]({{% resource url="/f43/lu.po.gz" %}}) (aggregation of all strings found in po files)


* [lu terminology (9.8 kB)]({{% resource url="/f43/lu.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [lu translation memory (213 Bytes)]({{% resource url="/f43/lu.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [lu generated stats (1.2 kB)]({{% resource url="/f43/lu.csv" %}})
