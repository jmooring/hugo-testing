---
title: "ki-Kikuyu (Gikuyu) - translation progress for f43"
...
Language progress for Kikuyu (ki) in Fedora f43 is:
...
* [ki compendium (43.5 kB)]({{% resource url="/f43/ki.po.gz" %}}) (aggregation of all strings found in po files)


* [ki terminology (12.6 kB)]({{% resource url="/f43/ki.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ki translation memory (1.5 kB)]({{% resource url="/f43/ki.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ki generated stats (1.3 kB)]({{% resource url="/f43/ki.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes](/f43/package/iso-codes) | 144 | 989 | 14.6 | Gikuyu <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ki/> | 
