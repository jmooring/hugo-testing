---
title: "ak-Akan (Akan) - translation progress for f43"
...
Language progress for Akan (ak) in Fedora f43 is:
...
* Source words to translate in started packages: 32080
* Translated words: 5496


Download:

* [ak compendium (127.2 kB)]({{% resource url="/f43/ak.po.gz" %}}) (aggregation of all strings found in po files)


* [ak terminology (35.2 kB)]({{% resource url="/f43/ak.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ak translation memory (31.9 kB)]({{% resource url="/f43/ak.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ak generated stats (3.0 kB)]({{% resource url="/f43/ak.csv" %}})
