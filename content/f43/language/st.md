---
title: "st-Southern Sotho (Sesotho) - translation progress for f43"
...
Language progress for Southern Sotho (st) in Fedora f43 is:

* 14.59% when we only look on started packages for this language.
* 0.13% when we compare to every single translatable string in Fedora f43.

Possible scripts are: Latn

* Total translatable string in Fedora f43: 21145798
* Source words to translate in started packages: 195114
* Translated words: 28465


Download:

* [st compendium (1.0 MB)]({{% resource url="/f43/st.po.gz" %}}) (aggregation of all strings found in po files)


* [st terminology (218.3 kB)]({{% resource url="/f43/st.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [st translation memory (214.3 kB)]({{% resource url="/f43/st.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [st generated stats (1.6 kB)]({{% resource url="/f43/st.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkspell3]({{< ref "/f43/package/gtkspell3.md" >}}) | 8 | 16 | 50.0 | Sotho <info@mosekolatranslation.co.za> | 
 | [libreoffice]({{< ref "/f43/package/libreoffice.md" >}}) | 28451 | 178000 | 16.0 | LANGUAGE <LL@li.org> | 
