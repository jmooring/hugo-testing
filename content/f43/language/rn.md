---
title: "rn-Rundi (Ikirundi) - translation progress for f43"
...
Language progress for Rundi (rn) in Fedora f43 is:
...
* [rn compendium (38.1 kB)]({{% resource url="/f43/rn.po.gz" %}}) (aggregation of all strings found in po files)


* [rn terminology (9.8 kB)]({{% resource url="/f43/rn.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [rn translation memory (213 Bytes)]({{% resource url="/f43/rn.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [rn generated stats (1.2 kB)]({{% resource url="/f43/rn.csv" %}})
