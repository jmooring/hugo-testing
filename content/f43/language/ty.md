---
title: "ty-Tahitian (Reo Tahiti) - translation progress for f43"
...
Language progress for Tahitian (ty) in Fedora f43 is:
...
* [ty compendium (38.1 kB)]({{% resource url="/f43/ty.po.gz" %}}) (aggregation of all strings found in po files)


* [ty terminology (9.8 kB)]({{% resource url="/f43/ty.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ty translation memory (213 Bytes)]({{% resource url="/f43/ty.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ty generated stats (1.2 kB)]({{% resource url="/f43/ty.csv" %}})
