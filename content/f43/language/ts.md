---
title: "ts-Tsonga (Xitsonga) - translation progress for f43"
...
Language progress for Tsonga (ts) in Fedora f43 is:

* 14.43% when we only look on started packages for this language.
...
* Source words to translate in started packages: 209094
* Translated words: 30168


Download:

* [ts compendium (1.1 MB)]({{% resource url="/f43/ts.po.gz" %}}) (aggregation of all strings found in po files)


* [ts terminology (233.5 kB)]({{% resource url="/f43/ts.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ts translation memory (223.9 kB)]({{% resource url="/f43/ts.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ts generated stats (2.1 kB)]({{% resource url="/f43/ts.csv" %}})
