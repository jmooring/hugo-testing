---
title: "kr-Kanuri (Kanuri) - translation progress for f43"
...
Language progress for Kanuri (kr) in Fedora f43 is:
...
* Source words to translate in started packages: 33128
* Translated words: 11636


Download:

* [kr compendium (111.5 kB)]({{% resource url="/f43/kr.po.gz" %}}) (aggregation of all strings found in po files)


* [kr terminology (26.5 kB)]({{% resource url="/f43/kr.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [kr translation memory (57.4 kB)]({{% resource url="/f43/kr.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [kr generated stats (1.6 kB)]({{% resource url="/f43/kr.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [phd2]({{< ref "/f43/package/phd2.md" >}}) | 10645 | 13336 | 79.8 |  | 
 | [gettext]({{< ref "/f43/package/gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [golang-github-chai2010-gettext]({{< ref "/f43/package/golang-github-chai2010-gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
 | [mingw-gettext]({{< ref "/f43/package/mingw-gettext.md" >}}) | 328 | 1714 | 19.1 | LANGUAGE <LL@li.org> | 
