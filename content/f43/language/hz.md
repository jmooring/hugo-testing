---
title: "hz-Herero (Otjiherero) - translation progress for f43"
...
Language progress for Herero (hz) in Fedora f43 is:
...
* [hz compendium (38.1 kB)]({{% resource url="/f43/hz.po.gz" %}}) (aggregation of all strings found in po files)


* [hz terminology (9.8 kB)]({{% resource url="/f43/hz.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [hz translation memory (213 Bytes)]({{% resource url="/f43/hz.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [hz generated stats (1.2 kB)]({{% resource url="/f43/hz.csv" %}})
