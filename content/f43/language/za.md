---
title: "za-Zhuang (Vahcuengh) - translation progress for f43"
...
Language progress for Zhuang (za) in Fedora f43 is:

* 31.84% when we only look on started packages for this language.
...
* Source words to translate in started packages: 21813
* Translated words: 6946


Download:

* [za compendium (73.6 kB)]({{% resource url="/f43/za.po.gz" %}}) (aggregation of all strings found in po files)


* [za terminology (17.2 kB)]({{% resource url="/f43/za.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [za translation memory (33.1 kB)]({{% resource url="/f43/za.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [za generated stats (1.3 kB)]({{% resource url="/f43/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f43/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
