---
title: "kj-Kuanyama (Kwanyama) - translation progress for f43"
...
Language progress for Kuanyama (kj) in Fedora f43 is:
...
* [kj compendium (38.1 kB)]({{% resource url="/f43/kj.po.gz" %}}) (aggregation of all strings found in po files)


* [kj terminology (9.8 kB)]({{% resource url="/f43/kj.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [kj translation memory (213 Bytes)]({{% resource url="/f43/kj.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [kj generated stats (1.2 kB)]({{% resource url="/f43/kj.csv" %}})
