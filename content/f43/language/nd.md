---
title: "nd-North Ndebele (IsiNdebele) - translation progress for f43"
...
Language progress for North Ndebele (nd) in Fedora f43 is:
...
* [nd compendium (38.1 kB)]({{% resource url="/f43/nd.po.gz" %}}) (aggregation of all strings found in po files)


* [nd terminology (9.8 kB)]({{% resource url="/f43/nd.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [nd translation memory (213 Bytes)]({{% resource url="/f43/nd.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [nd generated stats (1.2 kB)]({{% resource url="/f43/nd.csv" %}})
