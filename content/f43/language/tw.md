---
title: "tw-Twi (Twi) - translation progress for f43"
...
Language progress for Twi (tw) in Fedora f43 is:

* 5.98% when we only look on started packages for this language.
...
* Source words to translate in started packages: 15688
* Translated words: 938


Download:

* [tw compendium (46.2 kB)]({{% resource url="/f43/tw.po.gz" %}}) (aggregation of all strings found in po files)


* [tw terminology (11.7 kB)]({{% resource url="/f43/tw.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [tw translation memory (6.0 kB)]({{% resource url="/f43/tw.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [tw generated stats (1.3 kB)]({{% resource url="/f43/tw.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gjots2]({{< ref "/f43/package/gjots2.md" >}}) | 938 | 953 | 98.4 |  | 
 ...
 | [initial-setup]({{< ref "/f43/package/initial-setup.md" >}}) | 0 | 33 | 0.0 | Twi | 
 | [libvirt-sandbox]({{< ref "/f43/package/libvirt-sandbox.md" >}}) | 0 | 617 | 0.0 | Twi | 
 | [python-meh]({{< ref "/f43/package/python-meh.md" >}}) | 0 | 109 | 0.0 | Twi | 
