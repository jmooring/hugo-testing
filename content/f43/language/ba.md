---
title: "ba-Bashkir (Башҡорт теле) - translation progress for f43"
...
Language progress for Bashkir (ba) in Fedora f43 is:
...
* Source words to translate in started packages: 56166
* Translated words: 0


Download:

* [ba compendium (135.8 kB)]({{% resource url="/f43/ba.po.gz" %}}) (aggregation of all strings found in po files)


* [ba terminology (37.5 kB)]({{% resource url="/f43/ba.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [ba translation memory (213 Bytes)]({{% resource url="/f43/ba.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [ba generated stats (1.4 kB)]({{% resource url="/f43/ba.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 ...
 | [gramps]({{< ref "/f43/package/gramps.md" >}}) | 0 | 41201 | 0.0 | Bashkir <https://hosted.weblate.org/projects/gramps-project/gramps/ba/> | 
 | [granite]({{< ref "/f43/package/granite.md" >}}) | 0 | 498 | 0.0 |  | 
 | [granite-7]({{< ref "/f43/package/granite-7.md" >}}) | 0 | 596 | 0.0 |  | 
 | [iso-codes]({{< ref "/f43/package/iso-codes.md" >}}) | 0 | 989 | 0.0 | Bashkir <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/ba/> | 
