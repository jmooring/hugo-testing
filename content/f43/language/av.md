---
title: "av-Avaric (Авар мацӀ) - translation progress for f43"
...
Language progress for Avaric (av) in Fedora f43 is:
...
* [av compendium (38.1 kB)]({{% resource url="/f43/av.po.gz" %}}) (aggregation of all strings found in po files)


* [av terminology (9.8 kB)]({{% resource url="/f43/av.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [av translation memory (213 Bytes)]({{% resource url="/f43/av.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [av generated stats (1.2 kB)]({{% resource url="/f43/av.csv" %}})
