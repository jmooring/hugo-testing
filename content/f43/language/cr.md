---
title: "cr- () - translation progress for f43"
...
Language progress for  (cr) in Fedora f43 is:
...
* [cr compendium (38.1 kB)]({{% resource url="/f43/cr.po.gz" %}}) (aggregation of all strings found in po files)


* [cr terminology (9.8 kB)]({{% resource url="/f43/cr.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [cr translation memory (213 Bytes)]({{% resource url="/f43/cr.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [cr generated stats (1.2 kB)]({{% resource url="/f43/cr.csv" %}})
