---
title: "vo-Volapük (Volapük) - translation progress for f43"
...
Language progress for Volapük (vo) in Fedora f43 is:
...
* [vo compendium (37.8 kB)]({{% resource url="/f43/vo.po.gz" %}}) (aggregation of all strings found in po files)


* [vo terminology (9.8 kB)]({{% resource url="/f43/vo.terminology.po.gz" %}}) see [poterminology](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/poterminology.html)


* [vo translation memory (213 Bytes)]({{% resource url="/f43/vo.tmx.gz" %}}) see [tmx](https://en.wikipedia.org/wiki/Translation_Memory_eXchange)


* [vo generated stats (1.1 kB)]({{% resource url="/f43/vo.csv" %}})
