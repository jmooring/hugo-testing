---
title: "bh- () - translation progress for f34"
...
Language progress for  (bh) in Fedora f34 is:
...
* [bh generated stats (3.1 kB)]({{% resource url="/f34/bh.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [stellarium]({{< ref "/f34/package/stellarium.md" >}}) | 2 | 26769 | 0.0 | Bihari <bh@li.org> | 
