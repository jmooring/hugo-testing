---
title: "om-Oromo (Oromoo) - translation progress for f34"
...
Language progress for Oromo (om) in Fedora f34 is:

* 3.64% when we only look on started packages for this language.
...
* Source words to translate in started packages: 47798
...
* [om generated stats (4.0 kB)]({{% resource url="/f34/om.csv" %}})
