---
title: "za-Zhuang (Vahcuengh) - translation progress for f34"
...
Language progress for Zhuang (za) in Fedora f34 is:

* 22.80% when we only look on started packages for this language.
...
* Source words to translate in started packages: 30460
...
* [za generated stats (3.1 kB)]({{% resource url="/f34/za.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [gtkpod]({{< ref "/f34/package/gtkpod.md" >}}) | 6946 | 7520 | 92.4 | Zhuang <zh_CN@li.gtkpod.org> | 
