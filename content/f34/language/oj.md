---
title: "oj- () - translation progress for f34"
...
Language progress for  (oj) in Fedora f34 is:
...
* Source words to translate in started packages: 51475
...
* [oj generated stats (3.2 kB)]({{% resource url="/f34/oj.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f34/package/tuxpaint.md" >}}) | 179 | 1748 | 10.2 | Ed <edm@rocketmail.com> | 
 | [stellarium]({{< ref "/f34/package/stellarium.md" >}}) | 32 | 26787 | 0.1 | Ojibwe <oj@li.org> | 
