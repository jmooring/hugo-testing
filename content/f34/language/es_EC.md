---
title: "es_EC-Spanish (Ecuador) (Español (Ecuador)) - translation progress for f34"
...
Language progress for Spanish (Ecuador) (es_EC) in Fedora f34 is:

* 35.87% when we only look on started packages for this language.
* 0.14% when we compare to every single translatable string in Fedora f34.

Possible scripts are: Latn

* Total translatable string in Fedora f34: 16410615
* Source words to translate in started packages: 64065
* Translated words: 22982
...
* [es_EC generated stats (5.1 kB)]({{% resource url="/f34/es_EC.csv" %}})
