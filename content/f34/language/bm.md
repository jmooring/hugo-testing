---
title: "bm-Bambara (Bamanakan) - translation progress for f34"
...
Language progress for Bambara (bm) in Fedora f34 is:

* 4.66% when we only look on started packages for this language.
...
* Source words to translate in started packages: 24901
...
* [bm generated stats (3.2 kB)]({{% resource url="/f34/bm.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [tuxpaint]({{< ref "/f34/package/tuxpaint.md" >}}) | 1137 | 1748 | 65.0 | LANGUAGE <LL@li.org> | 
 | [sugar-toolkit-gtk3]({{< ref "/f34/package/sugar-toolkit-gtk3.md" >}}) | 23 | 213 | 10.8 | LANGUAGE <LL@li.org> | 
