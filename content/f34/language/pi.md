---
title: "pi- () - translation progress for f34"
...
Language progress for  (pi) in Fedora f34 is:

* 0.78% when we only look on started packages for this language.
...
* Source words to translate in started packages: 23922
...
* [pi generated stats (2.9 kB)]({{% resource url="/f34/pi.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f34/package/iso-codes.md" >}}) | 186 | 982 | 18.9 | Pali <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/pi/> | 
