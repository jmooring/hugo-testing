---
title: "kv-Komi (Коми кыв) - translation progress for f34"
...
Language progress for Komi (kv) in Fedora f34 is:

* 0.56% when we only look on started packages for this language.
...
* [kv generated stats (3.2 kB)]({{% resource url="/f34/kv.csv" %}})
...
|------|------------------:|-------------------:|-------------:|----------------|
 | [iso-codes]({{< ref "/f34/package/iso-codes.md" >}}) | 133 | 982 | 13.5 | Komi <https://hosted.weblate.org/projects/iso-codes/iso-3166-1/kv/> | 
