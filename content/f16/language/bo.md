---
title: "bo-Tibetan (བོད་སྐད་) - translation progress for f16"
...
Language progress for Tibetan (bo) in Fedora f16 is:

* 74.27% when we only look on started packages for this language.
* 4.25% when we compare to every single translatable string in Fedora f16.

Possible scripts are: Tibt

* Total translatable string in Fedora f16: 9698971
* Source words to translate in started packages: 554904
* Translated words: 412129
...
* [bo generated stats (748 Bytes)]({{% resource url="/f16/bo.csv" %}})
