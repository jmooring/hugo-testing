---
title: "tg-Tajik (Тоҷикӣ) - translation progress for f16"
...
Language progress for Tajik (tg) in Fedora f16 is:

* 75.93% when we only look on started packages for this language.
* 4.93% when we compare to every single translatable string in Fedora f16.

Possible scripts are: CyrlLatnArab

* Total translatable string in Fedora f16: 9698971
* Source words to translate in started packages: 629392
* Translated words: 477869
...
* [tg generated stats (2.4 kB)]({{% resource url="/f16/tg.csv" %}})
