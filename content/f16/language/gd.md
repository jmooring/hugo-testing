---
title: "gd-Scottish Gaelic (Gàidhlig) - translation progress for f16"
...
Language progress for Scottish Gaelic (gd) in Fedora f16 is:

* 91.51% when we only look on started packages for this language.
* 1.71% when we compare to every single translatable string in Fedora f16.

Possible scripts are: Latn

* Total translatable string in Fedora f16: 9698971
* Source words to translate in started packages: 181635
* Translated words: 166215
...
* [gd generated stats (925 Bytes)]({{% resource url="/f16/gd.csv" %}})
