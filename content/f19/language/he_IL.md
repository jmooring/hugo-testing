---
title: "he_IL-Hebrew (Israel) (עברית (ישראל)) - translation progress for f19"
...
Language progress for Hebrew (Israel) (he_IL) in Fedora f19 is:

* 25.20% when we only look on started packages for this language.
* 0.08% when we compare to every single translatable string in Fedora f19.

Possible scripts are: Hebr

* Total translatable string in Fedora f19: 11433072
* Source words to translate in started packages: 35414
* Translated words: 8926
...
* [he_IL generated stats (745 Bytes)]({{% resource url="/f19/he_IL.csv" %}})
