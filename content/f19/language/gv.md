---
title: "gv-Manx (Gaelg) - translation progress for f19"
...
Language progress for Manx (gv) in Fedora f19 is:

* 63.80% when we only look on started packages for this language.
* 0.22% when we compare to every single translatable string in Fedora f19.

Possible scripts are: Latn

* Total translatable string in Fedora f19: 11433072
* Source words to translate in started packages: 39523
* Translated words: 25216
...
* [gv generated stats (890 Bytes)]({{% resource url="/f19/gv.csv" %}})
