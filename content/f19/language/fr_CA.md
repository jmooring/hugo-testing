---
title: "fr_CA-French (Canada) (Français (Canada)) - translation progress for f19"
...
Language progress for French (Canada) (fr_CA) in Fedora f19 is:

* 10.08% when we only look on started packages for this language.
* 0.09% when we compare to every single translatable string in Fedora f19.

Possible scripts are: Latn

* Total translatable string in Fedora f19: 11433072
* Source words to translate in started packages: 103989
* Translated words: 10483
...
* [fr_CA generated stats (1.1 kB)]({{% resource url="/f19/fr_CA.csv" %}})
